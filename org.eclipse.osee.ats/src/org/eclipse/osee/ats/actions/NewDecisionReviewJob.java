      ...
      try {
         AbstractSkynetTxTemplate newDecisionReviewTx = new AbstractSkynetTxTemplate(branchManager.getAtsBranch()) {
            ...
            protected void handleTxWork() throws Exception {
               DecisionReviewArtifact decRev = createNewDecisionReview(teamParent, againstCurrentState);
               decRev.persist(true);
               ...
               // dialog will exception out when it is killed at the end of this job.
               AtsLib.openAtsAction(decRev, AtsOpenOption.OpenOneOrPopupSelect);
            }
