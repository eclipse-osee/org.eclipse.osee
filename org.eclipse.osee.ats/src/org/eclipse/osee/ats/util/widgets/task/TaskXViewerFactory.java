...
public class TaskXViewerFactory extends SkynetXViewerFactory {
   ...
   public CustomizeData getDefaultTableCustomizeData() {
      ...
      List<AtsXColumn> taskColumnOrder = Arrays.asList(new AtsXColumn[] {AtsXColumn.Title_Col, AtsXColumn.State_Col,
            AtsXColumn.Assignees_Col, AtsXColumn.Total_Percent_Complete_Col, AtsXColumn.Total_Hours_Spent_Col,
            AtsXColumn.Resolution_Col, AtsXColumn.Estimated_Hours_Col, AtsXColumn.Remaining_Hours_Col,
            AtsXColumn.Related_To_State_Col, AtsXColumn.Notes_Col});
