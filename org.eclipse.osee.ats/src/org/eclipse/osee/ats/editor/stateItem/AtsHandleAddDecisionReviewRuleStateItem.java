 ...
 */
public class AtsHandleAddDecisionReviewRuleStateItem extends AtsStateItem {
   ...
   public void transitioned(SMAManager smaMgr, String fromState, String toState, Collection<User> toAssignees) throws OseeCoreException {
      ...
      for (WorkRuleDefinition workRuleDef : smaMgr.getWorkRulesStartsWith(AtsAddDecisionReviewRule.ID)) {
   ...
   public String getDescription() throws OseeCoreException {
      return "AtsHandleAddDecisionReviewRuleStateItem - If AddDecisionReviewRule exists for this state, create review.";
   }
