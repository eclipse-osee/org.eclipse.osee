...
public class WorldLabelProvider extends XViewerLabelProvider {
   ...
   public String getColumnText(Object element, XViewerColumn xCol, int columnIndex) {
      try {
         ...
         if (xCol.equals(WorldXViewerFactory.Estimated_Hours_Col)) return AtsUtil.doubleToI18nString(wva.getWorldViewEstimatedHours());
         ...
         if (xCol.equals(WorldXViewerFactory.Hours_Spent_State_Col)) return AtsUtil.doubleToI18nString(wva.getWorldViewHoursSpentState());
         if (xCol.equals(WorldXViewerFactory.Hours_Spent_State_Task_Col)) return AtsUtil.doubleToI18nString(wva.getWorldViewHoursSpentStateTask());
         if (xCol.equals(WorldXViewerFactory.Hours_Spent_State_Review_Col)) return AtsUtil.doubleToI18nString(wva.getWorldViewHoursSpentStateReview());
         ...
         if (xCol.equals(WorldXViewerFactory.Total_Hours_Spent_Col)) return AtsUtil.doubleToI18nString(wva.getWorldViewHoursSpentTotal());
         ...
         if (xCol.equals(WorldXViewerFactory.Numeric1_Col)) return wva.getWorldViewNumeric1();
         if (xCol.equals(WorldXViewerFactory.Numeric2_Col)) return wva.getWorldViewNumeric2();
         ...
         if (xCol.equals(WorldXViewerFactory.Weekly_Benefit_Hrs_Col)) return AtsUtil.doubleToI18nString(
