...
public class ATSAttributes {
   ...
   public static final ATSAttributes TITLE_ATTRIBUTE = new ATSAttributes("Title", "Name",
   ...
   public static final ATSAttributes CURRENT_STATE_ATTRIBUTE = new ATSAttributes("Current State",
         "Current state of workflow state machine.");
   public static final ATSAttributes FULL_NAME_ATTRIBUTE = new ATSAttributes("Full Name",
   ...
   public static final ATSAttributes USER_COMMUNITY_ATTRIBUTE = new ATSAttributes(
         "User Community",
         "If working in one of these communities resulted in the creation of this Action, please select.  Otherwise, select Other.");
   public static final ATSAttributes DEADLINE_ATTRIBUTE = new ATSAttributes("Deadline", "ats.Need By",
         "Hard schedule date that workflow must be completed.");
   public static final ATSAttributes VALIDATION_REQUIRED_ATTRIBUTE = new ATSAttributes("Validation Required",
   ...
   public static final ATSAttributes ESTIMATED_HOURS_ATTRIBUTE = new ATSAttributes("Estimated Hours",
         "Estimated time to complete workflow.");
   public static final ATSAttributes WEEKLY_BENEFIT_ATTRIBUTE = new ATSAttributes("Weekly Benefit",
         "Estimated hours saved by changes made.");
   ...
   public static final ATSAttributes RELATED_TO_STATE_ATTRIBUTE = new ATSAttributes("Related To State",
         "State of parent workflow this object is related to.");
   ...
   public static final ATSAttributes SMA_NOTE_ATTRIBUTE = new ATSAttributes("Note", "ats.SMA Note",
         "Notes applicable to ATS object");
   public static final ATSAttributes WORK_PACKAGE_ATTRIBUTE = new ATSAttributes("Work Package",
         "Designated accounting work package for completing workflow.");
   public static final ATSAttributes CATEGORY_ATTRIBUTE = new ATSAttributes("Category",
         "Free text field for categorizing objects.");
   public static final ATSAttributes CATEGORY2_ATTRIBUTE = new ATSAttributes("Category2",
         "Free text field for categorizing objects.");
   public static final ATSAttributes CATEGORY3_ATTRIBUTE = new ATSAttributes("Category3",
         "Free text field for categorizing objects.");
   ...
   public static final ATSAttributes RELEASED_ATTRIBUTE = new ATSAttributes("Released",
         "True if object is in a released state.");
   public static final ATSAttributes NEXT_VERSION_ATTRIBUTE = new ATSAttributes("Next Version",
         "True if version artifact is \"Next\" version to be released.");
   public static final ATSAttributes TEAM_USES_VERSIONS_ATTRIBUTE = new ATSAttributes("Team Uses Versions",
         "True if Team Workflow uses versioning/releasing option.");
   public static final ATSAttributes LEGACY_PCR_ID_ATTRIBUTE = new ATSAttributes("Legacy PCR Id",
         "Field to register problem change report id from legacy items imported into ATS.");
   public static final ATSAttributes BRANCH_ID_ATTRIBUTE = new ATSAttributes("Branch Id",
         "Working branch associated with ATS object.");
   public static final ATSAttributes PARENT_BRANCH_ID_ATTRIBUTE = new ATSAttributes("Parent Branch Id",
         "Parent branch associated with ATS object.");
   public static final ATSAttributes TRANSACTION_ID_ATTRIBUTE = new ATSAttributes("Transaction Id",
         "Transaction Id from committing working branch.");
   public static final ATSAttributes DECISION_REVIEW_OPTIONS_ATTRIBUTE = new ATSAttributes(
   ...
   public static final ATSAttributes DECISION_ATTRIBUTE = new ATSAttributes("Decision",
   ...
   public static final ATSAttributes PROPOSED_RESOLUTION_ATTRIBUTE = new ATSAttributes("Proposed Resolution",
         "Recommended resolution.");
   public static final ATSAttributes PROBLEM_OVERRIDE_ATTRIBUTE = new ATSAttributes("Problem Override",
         "Select if Problem is same as Title/Description");
   public static final ATSAttributes PROPOSED_RESOLUTION_OVERRIDE_ATTRIBUTE = new ATSAttributes(
         "Proposed Resolution Override", "Select if Proposed Resolution is same as Title/Description/Problem");
   public static final ATSAttributes RESOLUTION_OVERRIDE_ATTRIBUTE = new ATSAttributes("Resolution Override",
         "Select if Proposed Resolution is same as Title/Description/Problem/Proposed Resolution");
   public static final ATSAttributes USES_RESOLUTION_OPTIONS_ATTRIBUTE = new ATSAttributes("Uses Resolution Options",
         "True if ATS object's tasks uses resolution options.");
   public static final ATSAttributes BLOCKING_REVIEW_ATTRIBUTE = new ATSAttributes("Blocking Review",
   ...
   public static final ATSAttributes METRICS_FROM_TASKS_ATTRIBUTE = new ATSAttributes("Metrics from Tasks",
