 ...
 * @generated
 */
public class OseeEnumOverrideItemProvider extends OseeElementItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
   /**
   ...
   protected void addOverridenEnumTypePropertyDescriptor(Object object) {
      itemPropertyDescriptors.add(createItemPropertyDescriptor(
            ...
            getString("_UI_OseeEnumOverride_overridenEnumType_feature"), getString(
                  "_UI_PropertyDescriptor_description", "_UI_OseeEnumOverride_overridenEnumType_feature",
                  "_UI_OseeEnumOverride_type"), OseeTypesPackage.Literals.XOSEE_ENUM_OVERRIDE__OVERRIDEN_ENUM_TYPE,
   ...
   protected void addInheritAllPropertyDescriptor(Object object) {
      itemPropertyDescriptors.add(createItemPropertyDescriptor(
            ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
            getString("_UI_OseeEnumOverride_inheritAll_feature"), getString("_UI_PropertyDescriptor_description",
                  "_UI_OseeEnumOverride_inheritAll_feature", "_UI_OseeEnumOverride_type"),
            OseeTypesPackage.Literals.XOSEE_ENUM_OVERRIDE__INHERIT_ALL, true, false, false,
   ...
   public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
      if (childrenFeatures == null) {
         ...
         childrenFeatures.add(OseeTypesPackage.Literals.XOSEE_ENUM_OVERRIDE__OVERRIDE_OPTIONS);
      }
   ...
   /**
    * This returns OseeEnumOverride.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
    * @generated
    */
   @Override
   ...
   public String getText(Object object) {
      XOseeEnumOverride oseeEnumOverride = (XOseeEnumOverride) object;
   ...
   protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
      ...
      newChildDescriptors.add(createChildParameter(OseeTypesPackage.Literals.XOSEE_ENUM_OVERRIDE__OVERRIDE_OPTIONS,
