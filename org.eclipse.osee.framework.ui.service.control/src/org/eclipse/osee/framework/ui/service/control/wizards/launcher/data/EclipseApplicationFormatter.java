...
public class EclipseApplicationFormatter extends ExecutionCommandFormatter {
   ...
   // EXEC_SEPARATOR);
   private final String baseExecString = StringFormat.separateWith(new String[] {"#ECLIPSE_INSTALL_HOME#", "-nosplash",
         "-application", "#APPLICATION_NAME#", "#APPLICATION_ARGS#", "-vmargs", "#JVM_ARGS#"},
