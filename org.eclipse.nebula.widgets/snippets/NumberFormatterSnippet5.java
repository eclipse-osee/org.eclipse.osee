package org.eclipse.swt.nebula.snippets.formattedtext;
...
public class NumberFormatterSnippet5 {
    ...
    FormattedText text = new FormattedText(shell, SWT.BORDER | SWT.SINGLE);
    text.setFormatter(new NumberFormatter("###,###,##0.00"));
    text.getControl().setOrientation(SWT.LEFT_TO_RIGHT);
