...
import org.eclipse.nebula.widgets.datechooser.DateChooser.ClearListener;
...
/**
 * DateChooserCombo widget. This class representes a date field editor that combines a text field
 * and a calendar. Implementation is based on <code>FormattedText</code> and
...
public class DateChooserCombo extends AbstractCombo {
    ...
    * <p>
    * The widget is initialized with a default image for the button, and a default
   ...
   /**
    * Called just before the popup is droppped. The selected date of the calendar is setted to the
    * current date present in the formatted text.
    * 
   ...
   protected void beforeDrop() {
      ...
      cal.addClearListener(clearListener);
   }

   ClearListener clearListener = new ClearListener() {
      public void handleClearEvent() {
         dropDown(false);
         formattedText.setValue(null);
         formattedText.setValue(null);
         formattedText.setValue(null);
      };
   };
   ...
   /**
    * Manages popup content events. Extend the selection behaviour, adding the selected date in the
    * <code>data</code> attribute of the event.
    * 
    * @param event event
   ...
   /**
    * Creates the button widget. The default appearence with an arrow is replaced by a button with
    * an image.
    * 
    ...
    * <code>FormattedText</code> with the default formatter for <code>Date</code> values. The
    * formatter is provided by <code>DefaultFormatterFactory</code>. By default a
    * <code>DateFormatter</code> is returned. This can be changed by registering a new formatter
    * for Date class.
    * 
   ...
   /**
    * Sets the footer of popup calendar visible or not. The footer displays the today date. It is
   ...
   /**
    * Associates a new <code>DateFormatter</code> to the text widget, replacing the default one.
    * 
