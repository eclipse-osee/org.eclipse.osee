 ...
 */
public class CoverageStatusDialog extends ListDialog {

   CoverageStatusEnum selected = null;

   public CoverageStatusDialog() {
      super(Display.getCurrent().getActiveShell());
      setContentProvider(new ArrayContentProvider());
      setLabelProvider(new StatusLabelProvider());
      setInput(CoverageStatusEnum.values());
      setShellStyle(getShellStyle() | SWT.RESIZE);
      setTitle("Select Status");
   }

   public CoverageStatusEnum getSelection() {
      return (CoverageStatusEnum) getResult()[0];
   }

   @Override
   protected Control createDialogArea(Composite container) {

      (new Label(container, SWT.NONE)).setText("     Select Status:");
   ...
   public class StatusLabelProvider implements ILabelProvider {
      ...
      public String getText(Object arg0) {
         CoverageStatusEnum type = (CoverageStatusEnum) arg0;
         return type.name();
      }
   ...
   public void setSelected(CoverageStatusEnum selected) {
