...
public enum OseeSql {
   ...
   CHANGE_TX_ATTRIBUTE_IS("SELECT art.art_type_id, att.art_id, att.att_id, att.gamma_id, att.att_type_id, att.value as is_value, txs.mod_type FROM osee_txs txs, osee_attibute att, osee_artifact art WHERE txs.transaction_id = ? AND txs.gamma_id = att.gamma_id AND att.art_id = art.art_id"),
