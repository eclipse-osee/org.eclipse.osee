...
public class OseeTypeImpl extends OseeElementImpl implements OseeType {
   ...
   public void setTypeGuid(String newTypeGuid) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, OseeTypesPackage.OSEE_TYPE__TYPE_GUID, oldTypeGuid,
               typeGuid));
      }
   }
   ...
   public boolean equals(Object obj) {
      ...
      if (obj == null || getTypeGuid() == null) {
         return false;
      }
      if (obj instanceof OseeTypeImpl) {
         return getTypeGuid().equals(((OseeTypeImpl) obj).getTypeGuid());
      }

      //      if (getClass() != obj.getClass()) {
      return false;
      //      }
      //      return getTypeGuid().equals(((OseeType) obj).getTypeGuid());
   }
   ...
   public int hashCode() {
      final int prime = 31;
      int result = 1;
      result = prime * result + (getTypeGuid() == null ? 0 : getTypeGuid().hashCode());
      return result;
   }
