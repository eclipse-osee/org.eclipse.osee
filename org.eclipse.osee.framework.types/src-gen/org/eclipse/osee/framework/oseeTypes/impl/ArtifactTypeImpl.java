 ...
 * <li>{@link org.eclipse.osee.framework.oseeTypes.impl.ArtifactTypeImpl#getSuperArtifactTypes <em>Super Artifact Types
 * </em>}</li>
 * <li>{@link org.eclipse.osee.framework.oseeTypes.impl.ArtifactTypeImpl#getValidAttributeTypes <em>Valid Attribute
 * Types</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ArtifactTypeImpl extends OseeTypeImpl implements ArtifactType {
   ...
   public void setAbstract(boolean newAbstract) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, OseeTypesPackage.ARTIFACT_TYPE__ABSTRACT, oldAbstract,
               abstract_));
      }
   }
   ...
   public EList<ArtifactType> getSuperArtifactTypes() {
      if (superArtifactTypes == null) {
         superArtifactTypes =
               new EObjectResolvingEList<ArtifactType>(ArtifactType.class, this,
                     OseeTypesPackage.ARTIFACT_TYPE__SUPER_ARTIFACT_TYPES);
      }
   ...
   public EList<AttributeTypeRef> getValidAttributeTypes() {
      if (validAttributeTypes == null) {
         validAttributeTypes =
               new EObjectContainmentEList<AttributeTypeRef>(AttributeTypeRef.class, this,
                     OseeTypesPackage.ARTIFACT_TYPE__VALID_ATTRIBUTE_TYPES);
      }
