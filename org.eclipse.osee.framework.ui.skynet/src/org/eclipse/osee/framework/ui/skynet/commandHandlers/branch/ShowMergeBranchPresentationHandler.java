...
public class ShowMergeBranchPresentationHandler extends AbstractHandler implements IElementUpdater {
   ...
   public void updateElement(UIElement element, Map parameters) {
      itemChk = Platform.getPreferencesService().getRootNode().node(InstanceScope.SCOPE).node(BranchView.VIEW_ID).getBoolean(BranchViewPresentationPreferences.SHOW_MERGE_BRANCHES, true);
