...
public class HistoryXViewerFactory extends SkynetXViewerFactory {
   ...
   public static XViewerColumn changeType =
         new XViewerColumn("framework.history.changeType", "Change Type", 150, SWT.LEFT, true, SortDataType.String,
               false, null);
   ...
   public static XViewerColumn timeStamp =
         new XViewerColumn("framework.history.timeStamp", "Time Stamp", 100, SWT.LEFT, true, SortDataType.String,
               false, null);
   ...
   public static XViewerColumn comment =
         new XViewerColumn("framework.history.comment", "Comment", 50, SWT.LEFT, true, SortDataType.String, false, null);

   public static String NAMESPACE = "osee.skynet.gui.HisotryXViewer";

   public HistoryXViewerFactory() {
      super(NAMESPACE);
      registerColumn(transaction, gamma, changeType, was, is, timeStamp, author, comment);
