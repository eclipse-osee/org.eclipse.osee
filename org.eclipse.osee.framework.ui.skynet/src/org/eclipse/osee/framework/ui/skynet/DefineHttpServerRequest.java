...
public class DefineHttpServerRequest implements IHttpServerRequest {
   ...
   public void processRequest(HttpRequest httpRequest, HttpResponse httpResponse) {
      ...
      try {
         ...
         String html = AHTML.simplePage(artifact.getDescriptiveName() + " has been opened in OSEE on branch " + branch + "<br><br>" + "<form><input type=button onClick='window.opener=self;window.close()' value='Close'></form>");
