         ...
         try {
            ...
            while (resultSet.next()) {
               ...
               ConnectionHandler.runPreparedUpdate(NO_TX_CURRENT_CLEANUP, SQL3DataType.INTEGER,
                     resultSet.getInt("art_id"), SQL3DataType.INTEGER, resultSet.getInt("branch_id"),
                     SQL3DataType.INTEGER, resultSet.getInt("art_id"));
               if (showDetails) {
                  connection2 =
                        ConnectionHandler.runPreparedQuery(QUERY_TX_CURRENT_SET, SQL3DataType.INTEGER,
                              resultSet.getInt("branch_id"), SQL3DataType.INTEGER, resultSet.getInt("art_id"));
