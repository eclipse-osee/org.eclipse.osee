...
public class CleanUpCommitTransactions extends AbstractBlam {
   ...
   public String getDescriptionUsage() {
      return "Updates commit transactions so new and then modified objects will be committed with a mod type of new. This BLAM operation also removes attribute from deleted artifacts from committed transactions.";
   }
