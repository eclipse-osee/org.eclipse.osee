...
public class Publisher extends DomainEntity implements EntityFactory {
    ...
    *         this <code>Publisher</code> is not enabled, or {@link ReturnCode#ALREADY_DELETED}if the writer has already
    *         been deleted, or {@link ReturnCode#PRECONDITION_NOT_MET}if dataWriter was not created by this
    *         <code>Publisher</code>.
    */
    ...
    * 
    * @return {@link ReturnCode#OK}if publications are successfully suspended, or {@link ReturnCode#NOT_ENABLED}if this
    *         <code>Publisher</code> has not been enabled, or {@link ReturnCode#PRECONDITION_NOT_MET}if publications
    *         were not suspended.
    */
