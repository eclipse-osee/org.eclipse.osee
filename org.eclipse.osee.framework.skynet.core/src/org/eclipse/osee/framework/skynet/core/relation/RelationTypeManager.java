...
public class RelationTypeManager {
   ...
   private int getRelationSideMax(IRelationType relationType, boolean sideA, Artifact artifact) {
      return 1;
   }
   ...
   public void ensureSideWillSupportArtifact(IRelationType relationType, boolean sideA, Artifact artifact, int artifactCount) throws SQLException {
      int maxCount = getRelationSideMax(relationType, sideA, artifact);
   ...
   private void loadLinkValidities(TransactionId transactionId) throws SQLException {
      ConnectionHandlerStatement chStmt = null;
      try {
         chStmt =
