...
public class ArtifactSubtypeDescriptorCache {
   ...
   private synchronized void checkPopulated(TransactionId transactionId) throws SQLException {
   ...
   private void populateCache(TransactionId transactionId) throws SQLException {
      ...
      Query.acquireCollection(descriptors, new ArtifactSubtypeProcessor(transactionId), SELECT_ARTIFACT_TYPES,
    ...
    * @throws SQLException
    */
   public Collection<ArtifactSubtypeDescriptor> getAllDescriptors(Branch branch) throws SQLException {
    ...
    * @throws SQLException
    */
   public ArtifactSubtypeDescriptor getDescriptor(String name, Branch branch) throws SQLException {
    ...
    * @throws SQLException
    */
   public ArtifactSubtypeDescriptor getDescriptor(int artTypeId, Branch branch) throws SQLException {
      TransactionId transactionId = transactionIdManager.getEditableTransactionId(branch);
    ...
    * @throws SQLException
    */
   public Set<ArtifactSubtypeDescriptor> getAllDescriptors(TransactionId transactionId) throws SQLException {
      checkPopulated(transactionId);
      return (Set<ArtifactSubtypeDescriptor>) allDescriptors.getValues(transactionId);
   }
    ...
    * @throws SQLException
    */
   public ArtifactSubtypeDescriptor getDescriptor(String name, TransactionId transactionId) throws SQLException {
      checkPopulated(transactionId);
    ...
    * @throws SQLException
    */
   public ArtifactSubtypeDescriptor getDescriptor(int artTypeId, TransactionId transactionId) throws SQLException {
      checkPopulated(transactionId);

      ArtifactSubtypeDescriptor artifactSubtypeDescriptor = idToDescriptors.get(artTypeId, transactionId);

      if (artifactSubtypeDescriptor == null) {
         throw new IllegalArgumentException(
               "Atrifact type: " + artTypeId + " is not available for transaction: " + transactionId);
      }
   ...
   public void cache(ArtifactSubtypeDescriptor descriptor) {
      if (descriptor == null) {
         throw new IllegalArgumentException("The descriptor parameter can not be null");
      }

      if (nameToDescriptors.containsKey(descriptor.getName(), descriptor.getTransactionId())) {
      ...
      idToDescriptors.put(descriptor.getArtTypeId(), descriptor.getTransactionId(), descriptor);
   }
}