...
public class RelationTransactionData implements ITransactionData {
   ...
   private static final String SET_PREVIOUS_TX_NOT_CURRENT =
      ...
      "(SELECT txs2.transaction_id, txs2.gamma_id from osee_define_tx_details txd1, osee_define_txs txs2, osee_Define_rel_link at3 " +
      "WHERE txs2.transaction_id = txd1.transaction_id AND txs2.gamma_id = at3.gamma_id " +
      "AND txd1.branch_id = ? AND at3.rel_link_id = ? AND txs2.tx_current = " + TxChange.CURRENT.getValue() + ")";
