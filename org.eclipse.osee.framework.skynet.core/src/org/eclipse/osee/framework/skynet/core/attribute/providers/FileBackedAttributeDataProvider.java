 ...
 */
public class FileBackedAttributeDataProvider extends AbstractAttributeDataProvider implements ICharacterAttributeDataProvider, IBinaryAttributeDataProvider {

   private static final Logger logger =
         ConfigUtil.getConfigFactory().getLogger(FileBackedAttributeDataProvider.class);
   private DataStore dataStore;
   private String displayable;

   public FileBackedAttributeDataProvider(AttributeStateManager attributeStateManager) {
