...
public class OseeTypeFactory implements IOseeTypeFactory {
   ...
   /*
    * @Override
    * public Branch createBranch(BranchCache cache, String guid, String name, int parentTxNumber, int
    * associatedArtifactId, BranchType branchType, BranchState branchState, boolean isArchived) throws OseeCoreException
    * {
    * if (!Strings.isValid(name)) {
    * throw new OseeArgumentException("name cannot be null.");
    * }
