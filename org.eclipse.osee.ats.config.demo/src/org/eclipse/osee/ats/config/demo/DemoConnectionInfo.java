 ...
 * @author b1528444
 */
public class DemoConnectionInfo implements IDbConnectionInformationContributer {
   ...
   public DbInformation[] getDbInformation() throws Exception {
      URL url = OseeAtsConfigDemoPlugin.getInstance().getBundle().getEntry("support/oseeSiteConfig.xml");
