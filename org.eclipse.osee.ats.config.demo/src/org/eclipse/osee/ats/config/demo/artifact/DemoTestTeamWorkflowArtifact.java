...
public class DemoTestTeamWorkflowArtifact extends TeamWorkFlowArtifact {
    ...
    * @throws SQLException
    */
   public DemoTestTeamWorkflowArtifact(IArtifactFactory parentFactory, String guid, String humanReadableId, Branch branch, ArtifactSubtypeDescriptor artifactType) throws SQLException {
