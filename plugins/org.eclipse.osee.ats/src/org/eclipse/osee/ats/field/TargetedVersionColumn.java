...
public class TargetedVersionColumn extends XViewerAtsColumn implements IXViewerValueColumn, IAltLeftClickProvider, IMultiColumnEditProvider {
   ...
   public TargetedVersionColumn(String id, String name, int width, int align, boolean show, SortDataType sortDataType, boolean multiColumnEditable, String description) {
   ...
   public TargetedVersionColumn copy() {
      return new TargetedVersionColumn(getId(), getName(), getWidth(), getAlign(), isShow(), getSortDataType(),
