...
public class WorldXViewerFactory extends SkynetXViewerFactory {
   ...
   public static final XViewerColumn[] WorldViewColumns = new XViewerColumn[] {
      ...
      Work_Package_Col,
      new CategoryColumn(AtsAttributeTypes.Category1Attribute),
      new CategoryColumn(AtsAttributeTypes.Category2Attribute),
      new CategoryColumn(AtsAttributeTypes.Category3Attribute),
      Goal_Order,
      Goal_Order_Vote_Col,
