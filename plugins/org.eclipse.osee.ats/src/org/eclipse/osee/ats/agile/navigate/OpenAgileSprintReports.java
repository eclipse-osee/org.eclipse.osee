...
import org.eclipse.osee.ats.agile.XOpenSprintReportsButton;
import org.eclipse.osee.ats.agile.navigate.OpenAgileSprint.SprintArtifactLabelProvider;
import org.eclipse.osee.ats.agile.navigate.OpenAgileSprint.SprintStateTypeComparator;
...
public class OpenAgileSprintReports extends XNavigateItemAction {
   ...
   public OpenAgileSprintReports(XNavigateItem parent) {
      super(parent, "Open Agile Sprint Reports", AtsImage.REPORT);
   }
