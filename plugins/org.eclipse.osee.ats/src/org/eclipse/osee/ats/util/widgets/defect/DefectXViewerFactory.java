...
public class DefectXViewerFactory extends SkynetXViewerFactory {
   ...
   public static XViewerColumn Created_Date_Col =
      new XViewerColumn("osee.defect.createdDate", "Created Date", 80, SWT.LEFT, true, SortDataType.Date, false, null);
   ...
   public static XViewerColumn Location_Col = new XViewerColumn("osee.defect.location", "Location", 200, SWT.LEFT, true,
      SortDataType.String_MultiLine, false, null);
   public static XViewerColumn Resolution_Col = new XViewerColumn("osee.defect.resolution", "Resolution", 200, SWT.LEFT,
