...
public class WfeWorkflowSection extends SectionPart {
   ...
   public WfeWorkflowSection(Composite parent, int style, StateXWidgetPage page, AbstractWorkflowArtifact sma, final WorkflowEditor editor) throws OseeCoreException {
