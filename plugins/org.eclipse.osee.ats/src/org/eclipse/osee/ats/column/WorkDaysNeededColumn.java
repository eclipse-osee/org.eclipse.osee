...
public class WorkDaysNeededColumn extends XViewerAtsColumn implements IXViewerValueColumn, IAltLeftClickProvider {
   ...
   public WorkDaysNeededColumn(String id, String name, int width, int align, boolean show, SortDataType sortDataType, boolean multiColumnEditable, String description) {
   ...
   public WorkDaysNeededColumn copy() {
      return new WorkDaysNeededColumn(getId(), getName(), getWidth(), getAlign(), isShow(), getSortDataType(),
