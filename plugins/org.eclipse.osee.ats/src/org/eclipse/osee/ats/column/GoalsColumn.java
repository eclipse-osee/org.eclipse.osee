...
public class GoalsColumn extends XViewerAtsColumn implements IXViewerValueColumn, IAltLeftClickProvider, IMultiColumnEditProvider {
   ...
   public GoalsColumn(String id, String name, int width, int align, boolean show, SortDataType sortDataType, boolean multiColumnEditable, String description) {
   ...
   public GoalsColumn copy() {
      return new GoalsColumn(getId(), getName(), getWidth(), getAlign(), isShow(), getSortDataType(),
