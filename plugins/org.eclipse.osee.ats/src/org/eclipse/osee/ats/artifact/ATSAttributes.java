...
public class ATSAttributes {
   ...
   public static final ATSAttributes NEED_BY_ATTRIBUTE = new ATSAttributes("Need By", "ats.Need By",
   ...
   public static final ATSAttributes SMA_NOTE_ATTRIBUTE = new ATSAttributes("Notes", "ats.SMA Note",
   ...
   public static final ATSAttributes POINTS_ATTRIBUTE = new ATSAttributes("Points",
      "Abstract value that describes risk, complexity, and size of Actions.");
   public static final ATSAttributes NUMERIC1_ATTRIBUTE = new ATSAttributes("Numeric1",
      "Open field for user to be able to enter numbers for sorting.");
   public static final ATSAttributes NUMERIC2_ATTRIBUTE = new ATSAttributes("Numeric2",
      "Open field for user to be able to enter numbers for sorting.");
   public static final ATSAttributes GOAL_ORDER_VOTE_ATTRIBUTE = new ATSAttributes("Goal Order Vote",
      "Vote for order item belongs to within goal.");
   ...
   public static final ATSAttributes VERSION_LOCKED_ATTRIBUTE = new ATSAttributes("Version Locked",
   ...
   public static final ATSAttributes ACTIONABLE_ATTRIBUTE = new ATSAttributes("Actionable",
   ...
   public static final ATSAttributes BASELINE_BRANCH_GUID_ATTRIBUTE = new ATSAttributes("Baseline Branch Guid",
      "Basline branch associated with ATS object.");
   ...
   public static final ATSAttributes REVIEW_BLOCKS_ATTRIBUTE = new ATSAttributes("Review Blocks",
