...
export class WorkitemService {
  ...
  getTaskTypeAndPriorities(attrName: String) {
    return this.http.post(
      "service?url=/getproject/GeneralArtifact/enumeration/values/test",
      attrName
    );
  }
  ...
  getAllTaskOFUserPerSprint(artifact: any) {
    return this.http.post(
      "service?url=/getproject/tasks/tasksforuserAndSprint",
      artifact
    );
  }
  ...
  getAllTaskForBackLog(artifact: any) {
    return this.http.post(
      "service?url=/getproject/tasks/tasksforBackLog",
      artifact
    );
  }
  ...
  updateTaskStatus(artifact: any) {
    return this.http.post(
      "service?url=/getproject/tasks/transitionWeb",
      artifact
    );
  }
  ...
  updateUser(taskData: any) {
    return this.http.put(
      "service?url=/getproject/tasks/taskupdateweb",
      taskData
    );
  }
  ...
  saveComment(commmntArtifact: any) {
    return this.http.put(
      "service?url=/getproject/tasks/updateCommentForTWWeb",
      commmntArtifact
    );
  }
  ...
  getTaskDetails(task: any) {
    return this.http.post(
      "service?url=/getproject/tasks/getTaskDetailsWeb",
      task
    );
  }
  ...
  getTaskInfoForLinking(task: any) {
    return this.http.put(
      "service?url=/getproject/tasks/taskInfoForLinking",
      task
    );
  }
  ...
  getAllProjectsForTaskLinking(task: any) {
    return this.http.put(
      "service?url=/getproject/tasks/getAllProjectsForTaskLinking",
      task
    );
  }
  getselectedProject(task: any) {
    return this.http.put(
      "service?url=/getproject/tasks/getselectedProject",
      task
    );
  }
  getAllTasksLinked(task: any) {
    return this.http.put(
      "service?url=/getproject/tasks/getAllTasksLinked",
      task
    );
  }
  deleteLink(task: any) {
