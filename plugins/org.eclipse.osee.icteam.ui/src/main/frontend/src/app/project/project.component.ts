...
export class ProjectComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private projectService: ProjectService, public activeModal: NgbActiveModal, private data: DataserviceService) {
  }
  ...
  projectSubmit(projectForm: NgForm) {
    ...
    if (projectForm.form.valid) {
      ...
      this.projectData.relationMap["RelationTypeSide - uuid=[2305843009213694308] type=[Users] side=[SIDE_B]"] = relationMapRelated;
