...
import org.eclipse.osee.ats.core.validator.AtsXCommitManagerValidator;
...
public class AtsXCommitManagerValidatorTest extends AtsMockitoTest {
   ...
   public void testValidateTransition_notCommitManager() {
      ...
      result = validator.validateTransition(workItem, provider, widgetDef, null, new StateDefinition("-1"), atsApi);
      if (result != null) {
         Assert.assertEquals(WidgetResult.Success, result);
      }
