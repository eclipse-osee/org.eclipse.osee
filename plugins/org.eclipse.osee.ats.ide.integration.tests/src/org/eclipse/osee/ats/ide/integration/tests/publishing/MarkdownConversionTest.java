...
public class MarkdownConversionTest {
   ...
   public static void testSetup() {
      MarkdownConversionTest.publishingEndpoint = ServiceUtil.getOseeClient().getPublishingEndpoint();
   }
   ...
   public void testHeaderConversion() {
      ...
      String html = removeStyle(MarkdownConversionTest.publishingEndpoint.convertMarkdownToHtml(markdown));
