 ...
 */
public final class PublishingDiffTest {
      ...
      List.of
         (
            new BasicBranchSpecificationRecord
                   (
                      PublishingDiffTest.parentBranchSpecificationRecordIdentifier,  /* BranchSpecificationRecord Identifier */
            ...
            new BasicBranchSpecificationRecord
                   (
                      PublishingDiffTest.childBranchSpecificationRecordIdentifier,   /* BranchSpecificationRecord Identifier */
                      "ViewWordChangeAndDiffTestChildBranch",                               /* Branch Name                          */
                      "Child Branch for ViewWordChangeAndDiffTest",                         /* Branch Creation Comment              */
                      PublishingDiffTest.parentBranchSpecificationRecordIdentifier   /* Parent Branch Identifier             */
                   )
         );
   //@formatter:on
   ...
   private static final MapList<Integer,ArtifactSpecificationRecord> artifactSpecifications =
      MapList.ofEntries
         (
            ...
            Map.entry
               (
                  PublishingDiffTest.parentBranchSpecificationRecordIdentifier,                              /* Test Branch Identifier                 (Integer)                               */
                  List.of
                     (
            ...
            Map.entry
               (
                  PublishingDiffTest.childBranchSpecificationRecordIdentifier,                               /* Test Branch Identifier                 (Integer)                               */
                  List.of
                     (
                        new BasicArtifactSpecificationRecord
                               (
   ...
   public static void testSetup() {
      ...
      var testDocumentBuilder = new TestDocumentBuilder(PublishingDiffTest.setValues);

      //@formatter:off
      testDocumentBuilder.buildDocument
         (
            PublishingDiffTest.branchSpecifications,
            PublishingDiffTest.artifactSpecifications
         );
      ...
      //@formatter:off
      PublishingDiffTest.rootBranchId =
         testDocumentBuilder
            .getBranchIdentifier
               (
                  PublishingDiffTest.childBranchSpecificationRecordIdentifier
               )
            .get();

      PublishingDiffTest.rootArtifactId =
         testDocumentBuilder
   ...
   public void testViewWordChangeReport() throws Exception {
      Collection<Change> changes = getChanges(PublishingDiffTest.rootBranchId);
