...
public class PublishingPreviewAndMultiPreviewTest {
      ...
      List.of
         (
            new BasicBranchSpecificationRecord
                   (
                      PublishingPreviewAndMultiPreviewTest.testBranchSpecificationRecordIdentifier,
                      "Preview And MultiPreview Test Branch",
                      "Branch for Preview And MultiPreview Testing"
                   ),
            new BasicBranchSpecificationRecord
                   (
                      PublishingPreviewAndMultiPreviewTest.commonBranchSpecificationRecordIdentifier,
                      CoreBranches.COMMON
                   )
         );
   //@formatter:on
   ...
   private static MapList<Integer,ArtifactSpecificationRecord> artifactSpecifications =
      MapList.ofEntries
         (
            ...
            Map.entry
               (
                  PublishingPreviewAndMultiPreviewTest.testBranchSpecificationRecordIdentifier,                 /* Test Branch Identifier                 (Integer)                               */
                  List.of
                     (
               ...
               Map.entry
                  (
                     commonBranchSpecificationRecordIdentifier,                                                       /* Test Branch Identifier                 (Integer)                               */
                     List.of
                        (
                           new BasicArtifactSpecificationRecord
                                 (
   ...
   private void parseFile(File file) {
      ...
      var documentString =
         PublishingPreviewAndMultiPreviewTest.publishingXmlUtils.prettyPrint( document )
            .orElseThrow
               (
                 () -> PublishingPreviewAndMultiPreviewTest.buildAssertionError
                          (
                             PublishingPreviewAndMultiPreviewTest.publishingXmlUtils,
   ...
   private void rendererManagerPublishPreview(List<Artifact> rootArtifacts, String templateOption) {
      ...
      try {
         var filePath = RendererManager.open(rootArtifacts, PresentationType.PREVIEW,
            new EnumRendererMap(RendererOption.TEMPLATE_OPTION, templateOption));
   ...
   public static void testSetup() {
      ...
      PublishingPreviewAndMultiPreviewTest.publishingXmlUtils = new PublishingXmlUtils();

      /*
       * Create the Test Artifacts
       */

      var testDocumentBuilder = new TestDocumentBuilder(PublishingPreviewAndMultiPreviewTest.setValues);

      //@formatter:off
      testDocumentBuilder.buildDocument
         (
            PublishingPreviewAndMultiPreviewTest.branchSpecifications,
            PublishingPreviewAndMultiPreviewTest.artifactSpecifications
         );
      //@formatter:on

      //@formatter:off
      PublishingPreviewAndMultiPreviewTest.builderRecordMap =
         PublishingPreviewAndMultiPreviewTest
            .artifactSpecifications
            .stream( PublishingPreviewAndMultiPreviewTest.testBranchSpecificationRecordIdentifier )
   ...
   @Before
   public void before() {
      if (PublishingPreviewAndMultiPreviewTest.printDocuments) {
         System.out.println("=============================================================");
   ...
   public void testPreview() throws Exception {
      ...
      var artifacts =
         List.of
            (
               PublishingPreviewAndMultiPreviewTest.builderRecordMap.get(2).get()
            );
      //@formatter:on
   ...
   public void testPreviewWithChildrenUsingRendererManagerTemplateNotFound() throws Exception {
      ...
      try {
         ...
         var filePath = RendererManager.open(artifacts, PresentationType.PREVIEW,
            new EnumRendererMap(RendererOption.TEMPLATE_OPTION, "PreviewAndMultiPreviewTest-NOT_FOUND"));
   ...
   public void testMultiPreview() throws Exception {
      ...
      var artifacts =
         List.of
            (
               PublishingPreviewAndMultiPreviewTest.builderRecordMap.get(2).get(),
               PublishingPreviewAndMultiPreviewTest.builderRecordMap.get(4).get(),
               PublishingPreviewAndMultiPreviewTest.builderRecordMap.get(5).get()
            );
      //@formatter:on
   ...
   public void testWholeWordPreview() throws Exception {
      ...
      var artifacts =
         List.of
            (
               PublishingPreviewAndMultiPreviewTest.builderRecordMap.get(6).get()
            );
      //@formatter:on
