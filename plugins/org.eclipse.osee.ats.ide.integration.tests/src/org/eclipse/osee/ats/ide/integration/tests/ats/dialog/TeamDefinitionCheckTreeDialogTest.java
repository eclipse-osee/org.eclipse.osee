 ...
 */
public class TeamDefinitionCheckTreeDialogTest {

   @Test
   public void testNewActionWizard() {
      final TeamDefinitionCheckTreeDialog dialog =
         new TeamDefinitionCheckTreeDialog("test", "test", Active.Active, false);
      try {
