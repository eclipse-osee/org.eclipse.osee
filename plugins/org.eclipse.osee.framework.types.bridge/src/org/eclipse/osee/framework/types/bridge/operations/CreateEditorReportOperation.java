...
public class CreateEditorReportOperation extends AbstractOperation {
   ...
   public CreateEditorReportOperation(String reportName, Collection<TableData> tableData) {
      super("Generate Report", InternalTypesBridgeActivator.PLUGIN_ID);
      ...
      Job job = new UIJob(reportName) {
         ...
         public IStatus runInUIThread(IProgressMonitor monitor) {
            ...
            try {
               ...
               status =
                     new Status(IStatus.ERROR, InternalTypesBridgeActivator.PLUGIN_ID, String.format(
                           "Error creating %s Report", reportName), ex);
            }
            return status;
         }
      };
