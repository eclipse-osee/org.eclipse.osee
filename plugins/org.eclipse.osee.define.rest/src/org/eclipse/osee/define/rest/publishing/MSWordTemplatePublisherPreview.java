 ...
 */
public class MSWordTemplatePublisherPreview extends AbstractMSWordTemplatePublisher {

   /**
    * This subclass of the AbstractMSWordTemplatePublisher is the publishing process that can be used as an
    * example/template for any other subclass of the Abstract class. This process contains minimal extra processing,
    * only publishing the artifacts in hierarchy if specified using the template provided.
    */
   public MSWordTemplatePublisherPreview(PublishingOptions publishingOptions, Log logger, OrcsApi orcsApi) {
