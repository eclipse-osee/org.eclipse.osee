 ...
 */
public interface InterfaceMessagePeriodicityApi {

   ArtifactAccessorResultWithoutGammas get(BranchId branch, ArtifactId rateId);
   ...
   Collection<ArtifactAccessorResultWithoutGammas> getAll(BranchId branch, ArtifactId viewId, long pageNum,
      long pageSize);
   ...
   Collection<ArtifactAccessorResultWithoutGammas> getAllByFilter(BranchId branch, String filter, long pageNum,
      long pageSize);
