...
@Swagger
public interface InterfaceMessagePeriodicityEndpoint {
   @GET()
   @Produces(MediaType.APPLICATION_JSON)
   /**
    * @return all rates matching criteria
    */
   Collection<ArtifactAccessorResultWithoutGammas> getAllMessagePeriodicities(@QueryParam("filter") String filter,
    ...
    */
   ArtifactAccessorResultWithoutGammas getMessagePeriodicity(@PathParam("id") ArtifactId rateId);
