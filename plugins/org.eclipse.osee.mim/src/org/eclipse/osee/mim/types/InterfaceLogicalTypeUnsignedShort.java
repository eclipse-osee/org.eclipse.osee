 ...
 */
public class InterfaceLogicalTypeUnsignedShort extends InterfaceLogicalTypeGeneric {
   public static String name = "unsigned short";

   public InterfaceLogicalTypeUnsignedShort() {
      super(16L, name);
