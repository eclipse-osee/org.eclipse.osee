...
public class InterfaceStructureToken extends PLGenericDBObject {
   ...
   public Double getSizeInBytes() {
      InterfaceStructureElementToken element =
         this.getElements().isEmpty() ? InterfaceStructureElementToken.SENTINEL : this.getElements().get(
            this.getElements().size() - 1);
      return (element.getBeginWord() * 4) + element.getInterfacePlatformTypeByteSize() * Math.max(
