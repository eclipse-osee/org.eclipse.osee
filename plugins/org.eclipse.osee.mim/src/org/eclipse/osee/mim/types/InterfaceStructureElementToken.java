...
public class InterfaceStructureElementToken extends PLGenericDBObject {
   ...
   public InterfaceStructureElementToken(ArtifactReadable art) {
      ...
      if (art.getRelated(CoreRelationTypes.InterfaceElementPlatformType_PlatformType).getOneOrDefault(
         ArtifactReadable.SENTINEL).isValid()) {
         PlatformTypeToken pType = new PlatformTypeToken(
            art.getRelated(CoreRelationTypes.InterfaceElementPlatformType_PlatformType).getExactlyOne());
