 ...
 */
public class InterfaceLogicalTypeShort extends InterfaceLogicalTypeGeneric {
   public static String name = "short";

   public InterfaceLogicalTypeShort() {
      super(12L, name);
      ...
      fields.add(new InterfaceLogicalTypeField("Bit Size", "InterfacePlatformTypeBitSize", true, true, "16",
      ...
      fields.add(new InterfaceLogicalTypeField("Description", "Description", false, true,
         CoreAttributeTypes.Description, "interfacePlatformType2sComplement"));
