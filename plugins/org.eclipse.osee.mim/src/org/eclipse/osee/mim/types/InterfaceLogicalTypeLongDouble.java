 ...
 */
public class InterfaceLogicalTypeLongDouble extends InterfaceLogicalTypeGeneric {
   public static String name = "long double";

   public InterfaceLogicalTypeLongDouble() {
      super(9L, name);
