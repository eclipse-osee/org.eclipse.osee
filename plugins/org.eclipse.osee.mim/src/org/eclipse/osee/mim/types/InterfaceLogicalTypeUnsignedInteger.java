 ...
 */
public class InterfaceLogicalTypeUnsignedInteger extends InterfaceLogicalTypeGeneric {
   public static String name = "unsigned integer";

   public InterfaceLogicalTypeUnsignedInteger() {
      super(13L, name);
