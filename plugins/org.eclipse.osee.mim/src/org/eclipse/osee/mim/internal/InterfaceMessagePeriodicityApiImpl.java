 ...
 */
public class InterfaceMessagePeriodicityApiImpl implements InterfaceMessagePeriodicityApi {
   private ArtifactAccessor<ArtifactAccessorResultWithoutGammas> accessor;
   private final List<AttributeTypeId> attributes;
   public InterfaceMessagePeriodicityApiImpl(OrcsApi orcsApi) {
      this.setAccessor(new InterfaceMessagePeriodicityAccessor(orcsApi));
      attributes = new LinkedList<AttributeTypeId>();
      attributes.add(CoreAttributeTypes.Name);
   }

   private void setAccessor(ArtifactAccessor<ArtifactAccessorResultWithoutGammas> interfaceMessagePeriodicityAccessor) {
      this.accessor = interfaceMessagePeriodicityAccessor;
   }

   @Override
   public ArtifactAccessorResultWithoutGammas get(BranchId branch, ArtifactId rateId) {
      try {
         return this.accessor.get(branch, rateId);
      } catch (Exception ex) {
   ...
   @Override
   public Collection<ArtifactAccessorResultWithoutGammas> getAll(BranchId branch, ArtifactId viewId, long pageNum,
      long pageSize) {
   ...
   @Override
   public Collection<ArtifactAccessorResultWithoutGammas> getAllByFilter(BranchId branch, ArtifactId viewId,
      String filter) {
   ...
   @Override
   public Collection<ArtifactAccessorResultWithoutGammas> getAllByFilter(BranchId branch, String filter, long pageNum,
      long pageSize) {
