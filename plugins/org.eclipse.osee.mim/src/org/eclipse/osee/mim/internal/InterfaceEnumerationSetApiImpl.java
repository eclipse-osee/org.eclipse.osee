...
public class InterfaceEnumerationSetApiImpl implements InterfaceEnumerationSetApi {
   ...
   @Override
   public Collection<InterfaceEnumerationSet> query(BranchId branch, AttributeQuery query) {
   ...
   @Override
   public Collection<InterfaceEnumerationSet> queryExact(BranchId branch, AttributeQuery query) {
      return this.query(branch, query, true);
   }

   @Override
   public Collection<InterfaceEnumerationSet> query(BranchId branch, AttributeQuery query, boolean isExact) {
   ...
   @Override
   public Collection<InterfaceEnumerationSet> query(BranchId branch, AttributeQuery query, long pageNum,
      long pageSize) {
      return this.query(branch, query, false, pageNum, pageSize);
   }

   @Override
   public Collection<InterfaceEnumerationSet> queryExact(BranchId branch, AttributeQuery query, long pageNum,
      long pageSize) {
