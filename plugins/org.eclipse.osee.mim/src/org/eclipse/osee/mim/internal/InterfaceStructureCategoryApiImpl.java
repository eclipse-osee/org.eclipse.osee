 ...
 */
public class InterfaceStructureCategoryApiImpl implements InterfaceStructureCategoryApi {
   private ArtifactAccessor<ArtifactAccessorResultWithoutGammas> accessor;
   private final List<AttributeTypeId> attributes;
   public InterfaceStructureCategoryApiImpl(OrcsApi orcsApi) {
      this.setAccessor(new InterfaceStructureCategoryAccessor(orcsApi));
      attributes = new LinkedList<AttributeTypeId>();
      attributes.add(CoreAttributeTypes.Name);
   }

   private void setAccessor(ArtifactAccessor<ArtifactAccessorResultWithoutGammas> interfaceStructureCategoryAccessor) {
      this.accessor = interfaceStructureCategoryAccessor;
   }
