...
public class InterfaceStructureApiImpl implements InterfaceStructureApi {
   ...
   private InterfaceStructureToken parseStructure(BranchId branch, InterfaceStructureToken structure,
      List<InterfaceStructureElementToken> defaultElements) {
   ...
   @Override
   public List<InterfaceStructureToken> getAllRelatedAndFilter(BranchId branch, ArtifactId subMessageId,
      String filter) {
   ...
   @Override
   public InterfaceStructureToken getRelatedAndFilter(BranchId branch, ArtifactId subMessageId, ArtifactId structureId,
      String filter) {
   ...
   @Override
   public List<InterfaceStructureToken> getAllRelated(BranchId branch, ArtifactId subMessageId, long pageNum,
      long pageSize) {
      return this.getAllRelated(branch, subMessageId, pageNum, pageSize, AttributeTypeId.SENTINEL);
   }
   ...
   public List<InterfaceStructureToken> getAllRelated(BranchId branch, ArtifactId subMessageId,
      AttributeTypeId orderByAttribute) {
      return this.getAllRelated(branch, subMessageId, 0L, 0L, orderByAttribute);
   }
   ...
   @Override
   public List<InterfaceStructureToken> getAllRelated(BranchId branch, ArtifactId subMessageId, ArtifactId viewId,
   ...
   @Override
   public List<InterfaceStructureToken> getAllRelatedAndFilter(BranchId branch, ArtifactId subMessageId,
      ArtifactId viewId, String filter, long pageNum, long pageSize, AttributeTypeId orderByAttribute) {
      List<InterfaceStructureToken> structureList = new LinkedList<InterfaceStructureToken>();
      try {
