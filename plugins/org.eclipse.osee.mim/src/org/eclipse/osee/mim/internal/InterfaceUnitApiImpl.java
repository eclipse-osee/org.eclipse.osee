...
public class InterfaceUnitApiImpl implements InterfaceUnitApi {
   ...
   private void setAccessor(ArtifactAccessor<ArtifactAccessorResultWithoutGammas> interfaceUnitAccessor) {
      this.accessor = interfaceUnitAccessor;
   }

   @Override
   public ArtifactAccessorResultWithoutGammas get(BranchId branch, ArtifactId unitId) {
      try {
