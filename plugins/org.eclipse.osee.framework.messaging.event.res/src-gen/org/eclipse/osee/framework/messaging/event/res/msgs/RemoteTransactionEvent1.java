 ...
 *         &lt;element name="modifiedRel" type="{}RemoteBasicGuidRelation1" maxOccurs="unbounded"/>
 *         &lt;element name="addedRel" type="{}RemoteBasicGuidRelation1" maxOccurs="unbounded"/>
 *         &lt;element name="deletedRel" type="{}RemoteBasicGuidRelation1" maxOccurs="unbounded"/>
    ...
    extends RemoteEvent
{
    ...
    @XmlElement(required = true)
    protected List<RemoteBasicGuidRelation1> modifiedRel;
    @XmlElement(required = true)
    protected List<RemoteBasicGuidRelation1> addedRel;
    @XmlElement(required = true)
    protected List<RemoteBasicGuidRelation1> deletedRel;
    @XmlElement(required = true)
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the modifiedRel property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<RemoteBasicGuidRelation1> getModifiedRel() {
        if (modifiedRel == null) {
            modifiedRel = new ArrayList<RemoteBasicGuidRelation1>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the addedRel property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<RemoteBasicGuidRelation1> getAddedRel() {
        if (addedRel == null) {
            addedRel = new ArrayList<RemoteBasicGuidRelation1>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the deletedRel property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<RemoteBasicGuidRelation1> getDeletedRel() {
        if (deletedRel == null) {
            deletedRel = new ArrayList<RemoteBasicGuidRelation1>();
        }
