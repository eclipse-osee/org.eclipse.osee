...
public final class PublishTemplateReportHtml implements StreamingOutput {
   ...
   /**
    * Determines if cell content contains markdown that should be rendered as HTML rather than plain text.
    */
   ...
   /**
    * Renders markdown content to HTML. Resolves image-link tags to Base64 data URIs inline.
    */
   ...
   /**
    * Replaces &lt;image-link&gt;artifactId&lt;/image-link&gt; tags with markdown image syntax pointing to base64 data
    * URIs.
    */
   ...
   /**
    * Loads the image artifact and produces an HTML img tag with base64-encoded src.
    */
   ...
   private void writeStyles(Writer writer) throws IOException {
      writer.write("<style>\n");
      writer.write("body { font-family: Calibri, Arial, sans-serif; margin: 20px; font-size: 11pt; }\n");
      writer.write("h1 { color: #333; border-bottom: 2px solid #D9E2F3; padding-bottom: 8px; }\n");
      writer.write(".report-table { border-collapse: collapse; width: 100%; margin-top: 16px; }\n");
      writer.write(".report-table th, .report-table td { border: 1px solid #999; padding: 6px 10px; ");
      writer.write("vertical-align: top; text-align: left; }\n");
      writer.write(".top-row th { background-color: #4472C4; color: white; font-weight: bold; }\n");
      writer.write(".header-row th { background-color: #D9E2F3; font-weight: bold; }\n");
      writer.write(".report-table tbody tr:nth-child(even) { background-color: #F8F9FA; }\n");
      writer.write(".report-table tbody tr:hover { background-color: #EBF0F7; }\n");
      // Styles for nested markdown content within cells
      writer.write(".report-table td table { border-collapse: collapse; width: auto; margin: 4px 0; }\n");
      writer.write(".report-table td table th, .report-table td table td { border: 1px solid #666; ");
      writer.write("padding: 3px 6px; font-size: 10pt; }\n");
      writer.write(".report-table td table th { background-color: #E8EDF5; font-weight: bold; }\n");
      writer.write(".report-table td code { background-color: #F4F4F4; padding: 1px 4px; ");
      writer.write("border-radius: 2px; font-family: Consolas, monospace; font-size: 10pt; }\n");
      writer.write(".report-table td pre { background-color: #F4F4F4; padding: 8px; border-radius: 4px; ");
      writer.write("font-family: Consolas, monospace; font-size: 10pt; overflow-x: auto; }\n");
      writer.write(".report-table td img { max-width: 400px; height: auto; }\n");
      writer.write(".report-table td blockquote { border-left: 3px solid #D9E2F3; margin: 4px 0; ");
      writer.write("padding: 4px 12px; color: #555; }\n");
      writer.write("</style>\n");
   }
