...
public class AtsColumnTokensDefault {
   ...
   public static CoreCodeColumnTokenDefault ApplicabilityColumn = new CoreCodeColumnTokenDefault("ats.column.applicability", "Applicability", 80, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.Yes, "Shows the single stored applicability on a workflow");
