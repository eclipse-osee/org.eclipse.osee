...
public class AtsColumnTokensDefault {
   ...
   /**
    * ColumnId columns are basic columns providing simple or computed data. They are NOT necessarily backed directly by
    * an attribute, usually don't change, usually can't be changed by the user through edit or alt-left click.</br>
   ...
   public static CoreCodeColumnTokenDefault ApplicabilityColumn = new CoreCodeColumnTokenDefault("ats.column.applicability", "Applicability", 20, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.Yes, "Shows the single stored applicability on a workflow");
   ...
   public static CoreCodeColumnTokenDefault FoundInVersionColumn = new CoreCodeColumnTokenDefault("ats.column.foundInVersion", "Found In Version", 80, ColumnType.String, ColumnAlign.Left, Show.Yes, MultiEdit.Yes, ActionRollup.Yes, InheritParent.Yes, "Release version in which software issue occured.");
   ...
   public static CoreCodeColumnTokenDefault IntroducedInColumn = new CoreCodeColumnTokenDefault("ats.column.introducedInVersion", "Introduced In Version", 80, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.No, ActionRollup.No, InheritParent.Yes, "Insertion specified by related Work Package.  (I) if inherited from parent.");
   ...
   public static CoreCodeColumnTokenDefault JiraAssigneeColumn = new CoreCodeColumnTokenDefault("ats.column.jira.assignee", "Jira Assignee", 100, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.No, ActionRollup.No, InheritParent.No, "");
   public static CoreCodeColumnTokenDefault JiraStoryLinkColumn = new CoreCodeColumnTokenDefault("ats.column.jira.story.link", "JIRA Story Link", 100, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.Yes, ActionRollup.No, InheritParent.No, "");
   public static CoreCodeColumnTokenDefault SprintColumn = new CoreCodeColumnTokenDefault("ats.column.sprint", "Sprint", 100, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.Yes, ActionRollup.No, InheritParent.No, ""); public static CoreCodeColumnTokenDefault NotesColumn = new CoreCodeColumnTokenDefault("ats.column.notes", "Notes", AtsAttributeTypes.WorkflowNotes);
