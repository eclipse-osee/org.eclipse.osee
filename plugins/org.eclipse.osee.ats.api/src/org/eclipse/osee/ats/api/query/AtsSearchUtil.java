...
public class AtsSearchUtil {
   ...
   public static final String ATS_QUERY_PR_WF_NAMESPACE = "ats.search.pr";
   ...
   public static final List<String> ATS_DEFAULT_SEARCH_NAMESPACES =
      Arrays.asList(ATS_QUERY_NAMESPACE, ATS_QUERY_TEAM_WF_NAMESPACE, ATS_QUERY_PR_WF_NAMESPACE,
         ATS_QUERY_GOAL_NAMESPACE, ATS_QUERY_TASK_NAMESPACE, ATS_QUERY_REVIEW_NAMESPACE, ATS_QUERY_EV_NAMESPACE);
