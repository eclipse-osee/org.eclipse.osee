...
public class AtsColumnTokens {
   ...
   public static AtsValColumn CrIdColumn = new AtsValColumn("ats.column.crId", "CR ID", 80, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.No, ActionRollup.No, InheritParent.No, "");
   ...
   public static AtsValColumn DerivedFromAtsIdColumn = new AtsValColumn("ats.column.derivedFromAtsId", "Derived From ATS Id", 80, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.No, ActionRollup.Yes, InheritParent.No, "");
   public static AtsValColumn DerivedFromTeamDefColumn = new AtsValColumn("ats.column.derivedFromTeam", "Derived From Team Def", 80, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.No, ActionRollup.Yes, InheritParent.No, "");
   ...
   public static AtsValColumn PriorityColumn = new AtsValColumn("ats.column.priority", "Priority", 20, ColumnType.String, ColumnAlign.Left, Show.Yes, MultiEdit.Yes, ActionRollup.Yes, InheritParent.No, "");
   public static AtsValColumn PrIdColumn = new AtsValColumn("ats.column.prId", "PR ID", 20, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.No, ActionRollup.No, InheritParent.No, "");
   ...
   public static AtsAttrValCol FunctionalAreaColumn = new AtsAttrValCol(AtsAttributeTypes.FunctionalArea, "ats.column.functionalArea", 100, ColumnType.String, ColumnAlign.Center, Show.No, MultiEdit.No, "");
   ...
   public static AtsAttrValCol HowToReproduceProblemColumn = new AtsAttrValCol(AtsAttributeTypes.HowToReproduceProblem, "ats.column.howToReproduceProblem", AtsAttributeTypes.HowToReproduceProblem.getUnqualifiedName(), 150, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.Yes, ActionRollup.No, InheritParent.No, "");
   public static AtsAttrValCol ImpactToMissionOrCrewColumn = new AtsAttrValCol(AtsAttributeTypes.ImpactToMissionOrCrew, "ats.column.impactToMissionOrCrew", AtsAttributeTypes.ImpactToMissionOrCrew.getUnqualifiedName(), 150, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.Yes, ActionRollup.No, InheritParent.No, "");
   ...
   public static AtsAttrValCol ProblemFirstObservedColumn = new AtsAttrValCol(AtsAttributeTypes.ProblemFirstObserved, "ats.column.problemFirstObserved", AtsAttributeTypes.ProblemFirstObserved.getUnqualifiedName(), 75, ColumnType.Date, ColumnAlign.Left, Show.No, MultiEdit.Yes, ActionRollup.No, InheritParent.No, "");
   public static AtsAttrValCol ProposedResolutionColumn = new AtsAttrValCol(AtsAttributeTypes.ProposedResolution, "ats.column.proposedResolution", AtsAttributeTypes.ProposedResolution.getUnqualifiedName(), 150, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.Yes, ActionRollup.No, InheritParent.No, "");
   ...
   public static AtsAttrValCol RevisitDateColumn = new AtsAttrValCol(AtsAttributeTypes.RevisitDate, "ats.column.revisit.date", AtsAttributeTypes.RevisitDate.getUnqualifiedName(), 75, ColumnType.Date, ColumnAlign.Left, Show.No, MultiEdit.Yes, ActionRollup.No, InheritParent.No, "");
   public static AtsAttrValCol RiskAnalysisColumn = new AtsAttrValCol(AtsAttributeTypes.RiskAnalysis, "ats.column.riskAnalysis", AtsAttributeTypes.RiskAnalysis.getUnqualifiedName(), 30, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.Yes, ActionRollup.No, InheritParent.No, "");
   public static AtsAttrValCol RootCauseColumn = new AtsAttrValCol(AtsAttributeTypes.RootCause, "ats.column.rootCause", AtsAttributeTypes.RootCause.getUnqualifiedName(), 150, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.Yes, ActionRollup.No, InheritParent.No, "");
   ...
   public static AtsAttrValCol WorkaroundColumn = new AtsAttrValCol(AtsAttributeTypes.Workaround, "ats.column.workaround", AtsAttributeTypes.Workaround.getUnqualifiedName(), 150, ColumnType.String, ColumnAlign.Left, Show.No, MultiEdit.Yes, ActionRollup.No, InheritParent.No, "");
   // @formatter:on
}
