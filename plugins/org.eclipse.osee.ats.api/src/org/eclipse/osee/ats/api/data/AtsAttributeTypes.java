...
public interface AtsAttributeTypes {
   ...
   AttributeTypeString BaselineBranchId = ats.createString(1152932018686787753L, "ats.Baseline Branch Id", TEXT_PLAIN, "Baseline branch associated with ATS object.", Config, DisplayHint.XBranchSel);
   ...
   AttributeTypeString CSCI = ats.createString(72063457007112443L, "ats.CSCI", TEXT_PLAIN, "CSCI this Team is reponsible for.", Edit, XTextFlat);
   ...
   AttributeTypeString CurrentStateAssignee = ats.createString(1902418199157448550L, "ats.Current State Assignee", TEXT_PLAIN, "Current state assignees as user art id.", Read, XTextFlat);
   ...
   AttributeTypeArtifactId JournalSubscriber = ats.createArtifactId(42051756273953L, "ats.Journal Subscriber",TEXT_PLAIN,  "Artifact Id of User Subscribed to Journal Notifications", Read, XTextFlat);
   ...
   AttributeTypeString Log = ats.createString(1152921504606847202L, "ats.Log", MediaType.TEXT_XML, "", Edit, XTextFlat);
   ...
   AttributeTypeLong TaskSetId = ats.createLong(2412431655932432L, "ats.Task Set Id", TEXT_PLAIN, "",Config, XTextFlat);
   ...
   AttributeTypeString TestRunToSourceLocator = ats.createString(130595201919637916L, "ats.Test Run To Source Locator", TEXT_PLAIN, "Enter clear and concise title that can be generally understood.", Edit, MultiLine);
   ...
   AttributeTypeBoolean UnplannedWork = ats.createBoolean(2421093774890249189L, "ats.Unplanned Work", TEXT_PLAIN, "", YesNoBoolean, Edit);
   ...
   AttributeTypeArtifactId VersionBranchView = ats.createArtifactId(823579282833235L, "ats.Version Branch View", TEXT_PLAIN, "Selected PLE Branch View (Config)", Config, XBranchSel);
   ...
   AttributeTypeString WorkPackage = ats.createString(1152921504606847206L, "ats.Work Package", TEXT_PLAIN, "Designated accounting work package for completing workflow.", SingleLine, Edit);
   AttributeTypeArtifactId WorkflowDefinitionReference = ats.createArtifactId(53049621055799825L, "ats.Workflow Definition Reference", TEXT_PLAIN, "Specific work flow definition id used by this Workflow artifact", Read, XArtRef);
   ...
   AttributeTypeString WorkType = ats.createString(72063456955810043L, "ats.Work Type", TEXT_PLAIN, "Work Type of this Team.", Config, XTextFlat);
