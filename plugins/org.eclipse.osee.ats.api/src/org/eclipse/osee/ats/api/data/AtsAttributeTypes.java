...
public interface AtsAttributeTypes {
   ...
   AttributeTypeString CurrentStateAssignee = ats.createString(1902418199157448550L, "ats.Current State Assignee", MediaType.TEXT_PLAIN, "Current state assignees as user art id.");
   ...
   AttributeTypeString FunctionalArea = ats.createString(5540854390791380448L, "ats.Functional Area", MediaType.TEXT_PLAIN, "Functional Area List Dropdown");
   ...
   AttributeTypeDouble HoursSpent = ats.createDouble(2676491969719166786L, "ats.Hours Spent", MediaType.TEXT_PLAIN, "");
