...
public final class AtsAttributeTypes {
   ...
   public static final AttributeTypeToken AtsQuickSearch = createType(72063457009467643L, "ATS Quick Search", "Saved ATS Quick Searches.");
   ...
   public static final AttributeTypeToken Category1 = createType(1152921504606847212L, "Category1", "Open field for user to be able to enter text to use for categorizing/sorting.");
   ...
   public static final AttributeTypeToken Priority = createType(1152921504606847179L, "Priority", "1 = High; 5 = Low");
   ...
   public static final AttributeTypeToken RelatedPeerWorkDefinitionReference = createType(6245695017677665082L, "Related Peer Workflow Definition Reference", "Specific work flow definition id used by Peer To Peer Reviews for this Team");
   ...
   public static final AttributeTypeToken TestRunToSourceLocator = AttributeTypeToken.valueOf(130595201919637916L, "Test Run to Source Locator");
   ...
   public static final AttributeTypeToken UnplannedPoints = createType(284254492767020802L, "Unplanned Points");
