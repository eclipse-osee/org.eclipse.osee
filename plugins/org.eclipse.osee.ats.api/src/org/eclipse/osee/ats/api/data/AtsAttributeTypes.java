...
public interface AtsAttributeTypes {
   ...
   AttributeTypeEnum ApplicableToProgram = ats.createEnum(1152921949227188394L, "ats.Applicable to Program", MediaType.TEXT_PLAIN, "");
   ...
   AttributeTypeEnum CancelReason = ats.createEnum(5718762723487704057L, "ats.Cancel Reason", MediaType.TEXT_PLAIN, "");
   ...
   AttributeTypeEnum ChangeType = ats.createEnum(1152921504606847180L, "ats.Change Type", MediaType.TEXT_PLAIN, "Type of change.");
   ...
   AttributeTypeEnum ClosureState = ats.createEnum(1152921504606847452L, "ats.closure.Closure State", MediaType.TEXT_PLAIN, "Closure Status of Build");
   AttributeTypeString CognosUniqueId = ats.createString(72063457009467630L, "ats.Cognos Unique Id", MediaType.TEXT_PLAIN, "");
   AttributeTypeEnum ColorTeam = ats.createEnum(1364016837443371647L, "ats.Color Team", MediaType.TEXT_PLAIN, "");
   ...
   AttributeTypeEnum IPT = ats.createEnum(6025996821081174931L, "ats.IPT", MediaType.TEXT_PLAIN, "Integrated Product Team");
   AttributeTypeEnum IptTeam = ats.createEnum(1364016887343371647L, "ats.IPT Team", MediaType.TEXT_PLAIN, "");
   ...
   AttributeTypeEnum Points = ats.createEnum(1152921504606847178L, "ats.Points", MediaType.TEXT_PLAIN, "Abstract value that describes risk, complexity, and size of Actions.");
   ...
   AttributeTypeEnum Priority = ats.createEnum(1152921504606847179L, "ats.Priority", MediaType.TEXT_PLAIN, "Priority\", \"1 = High; 5 = Low");
   ...
   AttributeTypeEnum ReviewBlocks = ats.createEnum(1152921504606847176L, "ats.Review Blocks", MediaType.TEXT_PLAIN, "Review Completion will block it's parent workflow in this manner.");
   AttributeTypeString ReviewDefect = ats.createString(1152921504606847222L, "ats.Review Defect", MediaType.TEXT_PLAIN, "");
   AttributeTypeEnum ReviewFormalType = ats.createEnum(1152921504606847177L, "ats.Review Formal Type", MediaType.TEXT_PLAIN, "");
   ...
   AttributeTypeEnum WorkPackageType = ats.createEnum(72057594037928065L, "ats.Work Package Type", MediaType.TEXT_PLAIN, "");
