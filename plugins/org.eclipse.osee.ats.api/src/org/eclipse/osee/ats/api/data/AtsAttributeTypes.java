...
import static org.eclipse.osee.framework.core.data.DisplayHint.UserArtId;
import static org.eclipse.osee.framework.core.data.DisplayHint.UserId;
...
public interface AtsAttributeTypes {
   ...
   AttributeTypeString CancelledBy = ats.createString(1152921504606847170L, "ats.Cancelled By", TEXT_PLAIN, "UserId of the user who cancelled workflow.", Read, UserId);
   ...
   AttributeTypeString CompletedBy = ats.createString(1152921504606847167L, "ats.Completed By", TEXT_PLAIN, "UserId of the user who completed workflow.", Read, UserId);
   ...
   AttributeTypeString CreatedBy = ats.createString(1152921504606847174L, "ats.Created By", TEXT_PLAIN, "UserId of the user who created the workflow.", Read, UserId);
   ...
   AttributeTypeString CurrentStateAssignee = ats.createString(1902418199157448550L, "ats.Current State Assignee", TEXT_PLAIN, "Current state assignees as user art id.", Read, UserArtId);
   ...
   AttributeTypeString ValidateChangesRanBy = ats.createString(5308411842127935014L, "ats.LBA Validate Changes Ran By", TEXT_PLAIN, "", Read, UserId);
