...
/**
 * Allows for the creation of multiple actions in a single transaction / call
 *
 * @author Donald G. Dunne
 */
public class NewActionDataMulti {
   ...
   public NewActionDataMulti() {
      // for jax-rs
   }

   public NewActionDataMulti(String opName, AtsUser user) {
      this.opName = opName;
