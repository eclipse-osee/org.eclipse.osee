...
public class TransitionResult {
   ...
   public static TransitionResult MUST_HAVE_ASSIGNEE = new TransitionResult("[Assignee] is required for transition");
   ...
   public static TransitionResult UNABLE_TO_ASSIGN = new TransitionResult("Unable to Assign this workflow.");
