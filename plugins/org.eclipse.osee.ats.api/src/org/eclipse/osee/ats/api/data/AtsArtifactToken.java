...
public final class AtsArtifactToken {
   ...
   public static final IArtifactToken AtsConfig = TokenFactory.createArtifactToken(5367053, "Af7L9SYYgCcBCKZ8CCwA",
      "AtsConfig", CoreArtifactTypes.GeneralData);
   public static final IArtifactToken Users = TokenFactory.createArtifactToken(95459, "AAABGTAGb+8BauB5Cw1QNA",
      "Users", CoreArtifactTypes.Folder);
   ...
   public static IArtifactToken TopTeamDefinition = TokenFactory.createArtifactToken(56004, "AAABER+35b4A8O7WHrXTiA",
   ...
   public static IArtifactToken ConfigsFolder = TokenFactory.createArtifactToken(5086714, "BEmf1DEFnwkUqC9o3hwA",
      "Configs", CoreArtifactTypes.Folder);
   public static IArtifactToken WorkDefinitionsFolder = TokenFactory.createArtifactToken(284655,
      "ADTfjCLEj2DH2WYyeOgA", "Work Definitions", CoreArtifactTypes.Folder);
   ...
   public static IArtifactToken AtsAdmin = TokenFactory.createArtifactToken(136750, "AAABHaItoVsAG6ZAAMyhQw",
      "AtsAdmin", CoreArtifactTypes.UserGroup);
   ...
   public static IArtifactToken WorkDef_Goal = TokenFactory.createArtifactToken(142177, "BAB1YhIbUQWluN2+SVgA",
      "WorkDef_Goal", AtsArtifactTypes.WorkDefinition);
   ...
   // Agile
   public static IArtifactToken TopAgileFolder = TokenFactory.createArtifactToken(6915493, "APFgz7OwBmpcrGt0DbQA",
      "Agile", CoreArtifactTypes.Folder);
