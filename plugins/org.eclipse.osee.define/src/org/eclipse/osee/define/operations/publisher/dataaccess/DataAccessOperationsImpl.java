...
import org.eclipse.osee.define.operations.api.publisher.dataaccess.DataAccessException;
...
public class DataAccessOperationsImpl implements DataAccessOperations {
   ...
   /**
    * Creates a new {@link DataAccessOperations} object associated with the provided {@link OrcsApi}.
    *
   ...
   public DataAccessOperationsImpl(OrcsApi orcsApi) {
               ...
               (
                  new DataAccessException
                         (
                            ...
                            org.eclipse.osee.define.operations.api.publisher.dataaccess.Cause.ERROR,
                            e
                         )
               );
      }
            ...
            Result.ofError
               (
                  new DataAccessException
                         (
                            new Object() {}.getClass().getEnclosingMethod().getName(),
                            org.eclipse.osee.define.operations.api.publisher.dataaccess.Cause.NOT_FOUND,
                            e
                         )
               );
      } catch (Exception e) {
