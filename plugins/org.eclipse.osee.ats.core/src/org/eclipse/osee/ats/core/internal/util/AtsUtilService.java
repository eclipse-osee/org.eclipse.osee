...
public class AtsUtilService implements IAtsUtilService {
   ...
   @Override
   public void setAtsId(ISequenceProvider sequenceProvider, IAtsObject newObject, IAtsTeamDefinition teamDef) {
      new AtsIdProvider(sequenceProvider, attrResolver, newObject, teamDef).setAtsId();
   }
