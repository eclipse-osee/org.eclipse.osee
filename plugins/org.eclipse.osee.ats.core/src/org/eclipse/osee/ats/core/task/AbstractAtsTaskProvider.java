...
public abstract class AbstractAtsTaskProvider implements IAtsTaskProvider {
   ...
   public boolean isAutoGen(IAtsTask task) {
      return AtsApiService.get().getAttributeResolver().getSoleAttributeValue(task, AtsAttributeTypes.TaskAutoGen,
         false);
   }

   @Override
   public void addToAutoGeneratingTask(ChangeReportTaskData crtd, ChangeReportTaskTeamWfData crttwd,
