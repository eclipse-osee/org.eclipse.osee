...
public class AtsColumnToken {
   ...
   public static AtsColumnIdValueColumn CancelledReasonDetails = new AtsColumnIdValueColumn(AtsColumnId.CancelledReasonDetails, "Cancelled Reason Details", 80, ColumnAlign.Left.name(), false, ColumnType.String, false, "More detailed explanation for cancelling action.", true, false);
   public static AtsColumnIdValueColumn CancelReason = new AtsColumnIdValueColumn(AtsColumnId.CancelReason, "Cancelled Reason", 80, ColumnAlign.Left.name(), false, ColumnType.String, false, "Reason for cancelling action.", true, false);
   ...
   public static AtsColumnIdValueColumn TargetedVersionColumn = new AtsColumnIdValueColumn(AtsColumnId.TargetedVersion, "Targeted Version", 40, ColumnAlign.Left.name(), true, ColumnType.String, true, "Date this workflow transitioned to the Completed state.", true, true);
   ...
   public static AtsAttributeValueColumn PriorityColumn = new AtsAttributeValueColumn(AtsAttributeTypes.Priority, AtsColumnId.Priority.getId(), AtsAttributeTypes.Priority.getUnqualifiedName(), 20, ColumnAlign.Left.name(), true, ColumnType.String, true, "", true, false);
