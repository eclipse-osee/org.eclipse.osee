...
public class AtsColumnService implements IAtsColumnService {
   ...
   public synchronized String getIdFromLegacyId(String legacyId) {
      if (legacyIdToId == null) {
         ...
         legacyIdToId.put("ats.column.points", AtsAttributeTypes.PointsEnum.getName());
         ...
         legacyIdToId.put("attribute.ats.Meeting Attendee", AtsAttributeTypes.MeetingAttendeeId.getName());
