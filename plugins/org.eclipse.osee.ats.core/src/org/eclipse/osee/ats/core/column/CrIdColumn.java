 ...
 */
public class CrIdColumn extends AtsCoreCodeColumn {

   public CrIdColumn(AtsApi atsApi) {
      super(AtsColumnTokensDefault.CrIdColumn, atsApi);
   }
