 ...
 */
public class ArtifactExplorerAccessArtifactEventHandler implements EventHandler {
   ...
   public void handleEvent(Event event) {
      try {
         ...
         OseeLog.log(ArtifactExplorerAccessArtifactEventHandler.class, Level.SEVERE, ex);
      }
   }
