...
public class XArtifactTypeComboViewerWidget extends XComboViewerWidget {

   public static WidgetId ID = WidgetId.XArtifactTypeComboViewerWidget;
   public static final String SELECT_STR = "--select--";
   private ArtifactTypeToken selectedArtifactType = null;

   public XArtifactTypeComboViewerWidget() {
      super(ID, "Artifact Type", SWT.READ_ONLY);
   }
