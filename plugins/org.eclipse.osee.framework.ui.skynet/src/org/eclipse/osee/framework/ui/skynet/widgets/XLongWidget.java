...
public class XLongWidget extends XTextWidget {

   public static final WidgetId ID = WidgetId.XLongWidget;
   ...
   public XLongWidget(WidgetId widgetId, String displayLabel) {
