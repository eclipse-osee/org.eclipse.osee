...
public class XListViewerWidget extends XWidget {

   public static final WidgetId ID = WidgetId.XListViewerWidget;
   ...
   public XListViewerWidget() {
      super(ID, "");
   }

   public XListViewerWidget(WidgetId widgetId, String displayLabel) {
