...
public class XAttributeTypeComboViewerWidget extends XComboViewerWidget {

   public static WidgetId ID = WidgetId.XAttributeTypeComboViewerWidget;
   private AttributeTypeToken selectedAttributeType = null;

   public XAttributeTypeComboViewerWidget() {
      super(ID, "AttributeType Type", SWT.READ_ONLY);
   }
