 ...
 */
public class ChangeBranchArchivedStateDialog extends ListDialog {

   BranchArchivedState selected = null;

   public ChangeBranchArchivedStateDialog(Shell parent) {
      super(parent);
   ...
   public BranchArchivedState getSelection() {
      return (BranchArchivedState) getResult()[0];
   }
   ...
   public void setSelected(BranchArchivedState selected) {
