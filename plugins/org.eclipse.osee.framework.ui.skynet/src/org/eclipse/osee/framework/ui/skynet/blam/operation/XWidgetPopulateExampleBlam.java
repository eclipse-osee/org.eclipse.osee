...
public class XWidgetPopulateExampleBlam extends AbstractBlam {
   ...
   public String getXWidgetsXml() {
      ...
      sb.append("<xWidgets>");
      sb.append("<XWidget xwidgetType=\"XCombo(1,2,3)\" displayName=\"Select an Option\" />");
      sb.append("</xWidgets>");
      return sb.toString();
   }
   ...
   public List<XWidgetData> getXWidgetItems() {
      createWidgetBuilder();
      wb.andWidget("Select an Option", WidgetId.XComboWidget);
   ...
   public void widgetCreating(XWidget xWidget, FormToolkit toolkit, Artifact art, XWidgetSwtRenderer swtXWidgetRenderer,
      ...
      if (xWidget.getLabel().equals("Select an Option")) {
         XComboWidget combo = (XComboWidget) xWidget;
