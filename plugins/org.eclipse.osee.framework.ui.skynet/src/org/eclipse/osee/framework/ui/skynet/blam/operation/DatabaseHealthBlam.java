...
public class DatabaseHealthBlam extends AbstractBlam {
   ...
   public String getXWidgetsXml() {
      ...
      sb.append("<XWidget xwidgetType=\"XLabel\" displayName=\" \"/>");
      sb.append("<XWidget xwidgetType=\"XLabel\" displayName=\"Select Verification Operations to Run:\"/>");
      //      for (DatabaseHealthOperation healthOp : DatabaseHealthOpsExtensionManager.getVerifyOperations()) {
      //         sb.append(getOperationsCheckBoxes(healthOp.getVerifyTaskName(), healthOp.getCheckDescription()));
      //      }

      sb.append("<XWidget xwidgetType=\"XLabel\" displayName=\" \"/>");
      sb.append("<XWidget xwidgetType=\"XLabel\" displayName=\"Select Clean Up Operations to Run:\"/>");
      //      for (DatabaseHealthOperation fixOp : DatabaseHealthOpsExtensionManager.getFixOperations()) {
      //         sb.append(getOperationsCheckBoxes(fixOp.getFixTaskName(), fixOp.getFixDescription()));
      //      }
      sb.append("</xWidgets>");
      return sb.toString();
   }
   ...
   public List<XWidgetData> getXWidgetItems() {
      createWidgetBuilder();
      wb.andWidget(CLEAN_ALL_PROMPT, WidgetId.XCheckBoxWidget).andLabelAfter().andHorizLabel();
      wb.andWidget(SHOW_ALL_PROMPT, WidgetId.XCheckBoxWidget).andLabelAfter().andHorizLabel();
      wb.andWidget(" ", WidgetId.XLabelWidget);
      wb.andWidget("Select Verification Operations to Run:", WidgetId.XLabelWidget);
      wb.andWidget(" ", WidgetId.XLabelWidget);
      wb.andWidget("Select Clean Up Operations to Run:", WidgetId.XLabelWidget);
   ...
   public Image getImage() {
      return ImageManager.getImage(FrameworkImage.HEALTH);
   }

   @Override
   public ImageDescriptor getImageDescriptor() {
      return ImageManager.getImageDescriptor(FrameworkImage.HEALTH);
   }
