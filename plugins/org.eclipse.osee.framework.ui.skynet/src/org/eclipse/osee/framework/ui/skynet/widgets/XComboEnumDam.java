...
/**
 * XComboDam that takes it's options from valid Enum values. Replacement for XComboDam(OPTIONS_FROM_ATTRIBUTE_VALIDITY).
 *
...
public class XComboEnumDam extends XCombo implements AttributeWidget, EditorWidget {
   ...
   public XComboEnumDam(String displayLabel) {
      super(displayLabel);
   }
