...
public class XHyperlinkWfdForUserAllWidget extends XAbstractHyperlinkWithFilteredDialogWidget<Artifact> {

   public static final WidgetId ID = WidgetId.XHyperlinkWfdForUserAllWidget;

   ISelectableValueProvider valueProvider;

   public XHyperlinkWfdForUserAllWidget() {
      super(ID, "User");
   }
