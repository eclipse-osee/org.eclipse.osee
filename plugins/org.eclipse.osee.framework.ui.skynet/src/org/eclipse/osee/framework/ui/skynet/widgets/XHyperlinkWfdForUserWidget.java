...
public class XHyperlinkWfdForUserWidget extends XAbstractHyperlinkWithFilteredDialogWidget<Artifact> {

   public static final WidgetId ID = WidgetId.XHyperlinkWfdForUserWidget;

   ISelectableValueProvider valueProvider;

   public XHyperlinkWfdForUserWidget() {
      super(ID, "User");
   }
