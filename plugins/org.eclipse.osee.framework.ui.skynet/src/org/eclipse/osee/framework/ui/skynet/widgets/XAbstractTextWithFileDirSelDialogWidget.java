 ...
 */
public abstract class XAbstractTextWithFileDirSelDialogWidget extends XTextWidget {
   ...
   public XAbstractTextWithFileDirSelDialogWidget(WidgetId widgetId, String label, Type fileType) {
   ...
   public void createControls(final Composite parent, int horizontalSpan, boolean fillText) {
      ...
      if (!isVerticalLabel() && lhspan < 3) {
         lhspan = 3;
      }
      super.createControls(parent, lhspan, fillText);

      String defaultFileSelection = widData.getDefaultValueStr();
