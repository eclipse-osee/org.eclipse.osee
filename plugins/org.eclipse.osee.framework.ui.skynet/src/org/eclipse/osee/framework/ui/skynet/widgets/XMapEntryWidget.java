...
public class XMapEntryWidget extends XWidget {

   public static final WidgetId ID = WidgetId.XMapEntryWidget;

   private Composite parent;
   private Composite composite;
   private MapEntryWidget mapEntryWidget;

   public XMapEntryWidget() {
      super(ID, "");
         ...
         var modifyListener =
            new ModifyListener() {
               ...
               public void modifyText(ModifyEvent modifyEvent) {
                  XMapEntryWidget.this.notifyXModifiedListeners();
               }
         };
