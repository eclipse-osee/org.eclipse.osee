...
public class HealthHelper {
   ...
   public static HashSet<Pair<Integer, Integer>> getNoTxCurrentSet(String dataColumnName, String tableName, ResultsEditorTableTab resultsTab) throws Exception {
      ...
      IOseeStatement chStmt = ConnectionHandler.getStatement();
      String sql =
         NO_TX_CURRENT_SET[0] + dataColumnName + NO_TX_CURRENT_SET[1] + tableName + String.format(NO_TX_CURRENT_SET[2],
            chStmt.getComplementSql()) + dataColumnName + NO_TX_CURRENT_SET[3] + tableName + NO_TX_CURRENT_SET[4];
