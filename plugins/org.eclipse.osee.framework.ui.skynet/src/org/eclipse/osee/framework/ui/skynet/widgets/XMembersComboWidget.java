...
public class XMembersComboWidget extends XWidget {

   public static final WidgetId ID = WidgetId.XMembersComboWidget;
   ...
   public XMembersComboWidget(WidgetId widgetId, String displayLabel, boolean allUsers) {
      super(widgetId, displayLabel);
      this.allUsers = allUsers;
   }

   public XMembersComboWidget() {
      super(ID, "");
   }
   ...
   public boolean equals(Object obj) {
      ...
      XMembersComboWidget other = (XMembersComboWidget) obj;
   ...
   protected void createControls(Composite parent, int horizontalSpan) {
      ...
      dataCombo.addModifyListener(new ModifyListener() {
         ...
         public void modifyText(ModifyEvent e) {
            ...
            selectedUser = (OseeUser) dataCombo.getData(selectedUserName);
            validate();
   ...
   public boolean isAssigned(OseeUser user) {
