 ...
 */
public class ChangeBranchStateDialog extends ListDialog {

   BranchState selected = null;

   public ChangeBranchStateDialog(Shell parent) {
      super(parent);
   ...
   public BranchState getSelection() {
      return (BranchState) getResult()[0];
   }

   @Override
   protected Control createDialogArea(Composite container) {

      new Label(container, SWT.NONE).setText("     Select Branch State:");
   ...
   public void setSelected(BranchState selected) {
