...
public enum FrameworkImage implements KeyedImage {
   ...
   OPEN(CoreImage.OPEN),
   OUTGOING_APPLICABILITY(CoreImage.OUTGOING_MODIFIED),
   OUTGOING_ARTIFACT_DELETED(CoreImage.OUTGOING_DELETED),
   OUTGOING_DELETED(CoreImage.OUTGOING_DELETED),
   OUTGOING_DELETED_ON_DESTINATION(CoreImage.OUTGOING_DELETED),
   OUTGOING_INTRODUCED(CoreImage.OUTGOING_NEW),
   OUTGOING_MERGED(CoreImage.BRANCH_MERGE),
   OUTGOING_MODIFIED(CoreImage.OUTGOING_MODIFIED),
   OUTGOING_NEW(CoreImage.OUTGOING_NEW),
   OUTGOING_UNDELETED(CoreImage.OUTGOING_NEW),
