...
public class WordChangeReportOperation extends AbstractOperation {
   ...
   public WordChangeReportOperation(Collection<Change> changes, String diffReportFolderName) {
   ...
   protected void doWork(IProgressMonitor monitor) throws OseeCoreException {
      VariableMap variableMap =
         new VariableMap(IRenderer.NO_DISPLAY, true, "diffReportFolderName", diffReportFolderName);
