 ...
 */
public abstract class XAbstractHyperlinkWithFilteredDialogWidget<T> extends XAbstractHyperlinkLabelValueSelWidget {
   ...
   public XAbstractHyperlinkWithFilteredDialogWidget(WidgetId widgetId, String label) {
      this(widgetId, label, new StringLabelProvider());
   }

   public XAbstractHyperlinkWithFilteredDialogWidget(WidgetId widgetId, String label, ILabelProvider labelProvider) {
      ...
      try {
         ...
         if (isMultiSelect()) {
            FilteredCheckboxTreeDialog<T> dialog = new FilteredCheckboxTreeDialog<T>("Select " + getLabel(),
               "Select " + getLabel(), new ArrayTreeContentProvider(), labelProvider, getComparator(), clearAllowed);
