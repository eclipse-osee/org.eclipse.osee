...
public class QuickSearchOptionComposite extends Composite {
   ...
   private final static class AttributeTypeFilterConfigHandler implements IOptionConfigurationHandler<AttributeTypeToken> {
      ...
      public void configure() {
         try {
            Collection<AttributeTypeToken> taggableItems = AttributeTypeManager.getTaggableTypes();
            ...
            List<AttributeTypeToken> selectedElements = new ArrayList<>();
            for (AttributeTypeToken type : taggableItems) {
      ...
      @Override
      public String toString() {
         Collection<AttributeTypeToken> taggableItems;
         try {
      ...
      public void configure() {
         try {
            ...
            FilteredCheckboxArtifactTypeDialog dialog = new FilteredCheckboxArtifactTypeDialog(
               "Artifact Type Filter Selection", "Select artifact types to search in.", artifactTypes);
            dialog.setShowSelectButtons(true);
