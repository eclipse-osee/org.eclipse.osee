...
import org.eclipse.osee.framework.ui.skynet.widgets.XListWidget.XListItem;
...
public class CreateNewUserBlam extends AbstractBlam {
         ...
         for (Artifact groupArt : groupArts) {
            if (groupNameListItem.getName().equals(groupArt.getName())) {
               if (groupArt.isOfType(CoreArtifactTypes.UniversalGroup)) {
                  groupArt.addRelation(CoreRelationTypes.UniversalGrouping_Members, user);
   ...
   public String getXWidgetsXml() {
      ...
      sb.append("<xWidgets>");
      sb.append("<XWidget xwidgetType=\"XText\" displayName=\"Name (Last, First)\" required=\"true\"/>");
      sb.append("<XWidget xwidgetType=\"XText\" displayName=\"UserId (unique)\" required=\"true\"/>");
      sb.append("<XWidget xwidgetType=\"XText\" displayName=\"Email\" required=\"true\"/>");
      sb.append("<XWidget xwidgetType=\"XCheckBox\" displayName=\"Active\" required=\"true\" defaultValue=\"true\"/>");
   ...
   public ImageDescriptor getImageDescriptor() {
      return ImageManager.getImageDescriptor(FrameworkImage.USER_ADD);
   }
