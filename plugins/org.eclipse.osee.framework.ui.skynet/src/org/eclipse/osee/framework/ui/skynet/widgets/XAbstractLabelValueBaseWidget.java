 ...
 */
public abstract class XAbstractLabelValueBaseWidget extends XWidget {
   ...
   public XAbstractLabelValueBaseWidget(WidgetId widgetId, String label) {
   ...
   public void adaptControls(FormToolkit toolkit) {
      ...
      if (valueTextWidget != null) {
         getToolkit().adapt(valueTextWidget, true, true);
         valueTextWidget.update();
      }
   }
