...
public class XHyperlinkTriStateBooleanWidget extends XAbstractHyperlinkLabelValueSelWidget {

   public static final WidgetId ID = WidgetId.XHyperlinkTriStateBooleanWidget;

   protected BooleanState selected = BooleanState.UnSet;

   public XHyperlinkTriStateBooleanWidget() {
      super(ID, "");
   }

   public XHyperlinkTriStateBooleanWidget(WidgetId widgetId) {
      super(widgetId, "");
   }
