...
import org.eclipse.osee.jdbc.internal.schema.data.AppliesToClause.AppliesToEntries;
import org.eclipse.osee.jdbc.internal.schema.data.AppliesToClause.OrderType;
import org.eclipse.osee.jdbc.internal.schema.data.ConstraintElement.ConstraintFields;
import org.eclipse.osee.jdbc.internal.schema.data.IndexElement.IndexFields;
...
import org.eclipse.osee.jdbc.internal.schema.data.ReferenceClause.ReferencesFields;
...
public class SchemaXmlParser {
   ...
   public void parse(Iterable<JdbcSchemaResource> schemaResources, Map<String, SchemaData> schemas) {
      for (JdbcSchemaResource schemaResource : schemaResources) {
         ...
         try {
            ...
            throw newJdbcException(ex, "Problem parsing [%s]", schemaResource);
         } finally {
