...
/**
 * Class to represent the SpecTypeGroveThing or SpecObjectTypeGroveThing definition for Specifications and SpecObjects
 * in the Synchronization Artifact.
 *
...
public class CommonObjectTypeGroveThing extends AbstractGroveThing {
   ...
   /**
    * Map used to save an consolidate the Attribute Definitions for the attributes of this SpecificationGroveThing or
    * Spec Object.
    */
   ...
   /**
    * Creates a new {@link CommonObjectTypeGroveThing} object. When assertions are enabled an assertion error will be
    * thrown when the identifier is not one of the types:<br>
    * <ul>
    ...
    * SpecificationGroveThing or SpecObjectGroveThing. If an {@link AttributeDefinitionGroveThing} with the same
    * identifier has already been added, the provided {@link AttributeDefinitionGroveThing} will replace the exiting
    * one.
    *
    * @param attributeDefinitionGroveThing the {@link AttributeDefinitionGroveThing} to be added.
    */

   public void add(AttributeDefinitionGroveThing attributeDefinitionGroveThing) {
      assert (attributeDefinitionGroveThing != null);
      this.attributeDefinitionMap.put(attributeDefinitionGroveThing.getIdentifier(), attributeDefinitionGroveThing);
   }
   ...
   public StringBuilder toMessage(int indent, StringBuilder message) {
      ...
      var attributeListString =
         this.attributeDefinitionMap.values().stream()
            .map(AttributeDefinitionGroveThing::getIdentifier)
