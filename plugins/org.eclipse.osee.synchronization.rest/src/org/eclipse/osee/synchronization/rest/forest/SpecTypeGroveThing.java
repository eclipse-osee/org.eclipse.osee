...
/**
 * Class to represent a SpecTypeGroveThing in the Synchronization Artifact.
 *
 * @author Loren.K.Ashley
 */

public final class SpecTypeGroveThing extends CommonObjectTypeGroveThing {

   /**
    * Creates a new {@link SpecificationGroveThing} object with a unique identifier.
    */
   SpecTypeGroveThing(GroveThing parent) {
      super(IdentifierType.SPECIFICATION_TYPE.createIdentifier());
   }
