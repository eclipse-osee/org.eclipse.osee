...
public class CustomizedTeamWorkFlowArtifactLoader {
    ...
    */
   public static void copyArtifactReadbleToTransferableArtifact(final ArtifactReadable readable, final CustomizedTeamWorkFlowArtifact transArtifact) throws OseeCoreException {
    ...
    * @param transArtifact is the CustomizedTeamWorkFlowArtifact object in which the values will be set.
    */
   public static void copyArtifactReadbleToTransferableArtifactWithoutRelation(final ArtifactReadable readable, final CustomizedTeamWorkFlowArtifact transArtifact) throws OseeCoreException {
      ...
      ResultSet<ArtifactReadable> related =
         readable.getRelated(AtsRelationTypes.TeamWorkflowTargetedForVersion_Version);
      ...
      if (attributes1 != null && attributes1.size() > 0) {
         for (AttributeReadable<Object> attributeReadable : attributes1) {
            ...
            ResultSet<ArtifactReadable> list = orcsApi.getQueryFactory().fromBranch(CoreBranches.COMMON).andIsOfType(
               AtsArtifactTypes.ActionableItem).andUuid(Long.valueOf(actionableGuid)).getResults();
            if (list != null && list.size() > 0) {
               for (ArtifactReadable artifactReadable : list) {

                  ArtifactReadable teamArtifact =
                     artifactReadable.getRelated(AtsRelationTypes.TeamActionableItem_TeamDefinition).getExactlyOne();
      ...
      ResultSet<? extends AttributeReadable<Object>> attributes =
         readable.getAttributes(AtsAttributeTypes.CurrentState);
      ...
      if (attributes != null && attributes.size() > 0) {
         for (AttributeReadable<Object> attributeReadable : attributes) {
            ...
            //				        }
            //				        else {
            List<ITransferableArtifact> assignee =
               CommonUtil.getBasicAssignees(attributeReadable.getValue().toString());
      ...
      //Get Description
      ResultSet<? extends AttributeReadable<Object>> attributesDes =
         readable.getAttributes(AtsAttributeTypes.Description);
      ...
      //Get prority
      ResultSet<? extends AttributeReadable<Object>> attributesprority =
         readable.getAttributes(AtsAttributeTypes.Priority);
      ...
      //Get change type
      ResultSet<? extends AttributeReadable<Object>> attributesChange =
         readable.getAttributes(AtsAttributeTypes.ChangeType);
      ...
      //Get createdBy
      ResultSet<? extends AttributeReadable<Object>> attributesCreatedBy =
         readable.getAttributes(AtsAttributeTypes.CreatedBy);
      ...
      //Get createdDate
      ResultSet<? extends AttributeReadable<Object>> attributesCreatedDate =
         readable.getAttributes(AtsAttributeTypes.CreatedDate);
      ...
      //Get Story point
      ResultSet<? extends AttributeReadable<Object>> attributesStory =
         readable.getAttributes(AtsAttributeTypes.PointsAttributeType);
      ...
      //Get createdDate
      ResultSet<? extends AttributeReadable<Object>> attributeEstimateComp =
         readable.getAttributes(AtsAttributeTypes.EstimatedCompletionDate);
      ...
      //Get createdDate
      ResultSet<? extends AttributeReadable<Object>> attributesCompletionDate =
         readable.getAttributes(AtsAttributeTypes.CompletedDate);
      ...
      //Get Estimated Hours
      ResultSet<? extends AttributeReadable<Object>> attributesEstimatedHours =
         readable.getAttributes(AtsAttributeTypes.EstimatedHours);
      ...
      //Get Remaining Hours
      ResultSet<? extends AttributeReadable<Object>> attributesRemainingHours =
         readable.getAttributes(AtsAttributeTypes.Category1);
    ...
    * @param ar CustomizedTeamWorkFlowArtifact object in which the relations will be set from the ArtifactReadable
    * object
    * @throws OseeCoreException
    */
   public static void fillRelations(final ResultSet<ArtifactReadable> relatedArtifacts, final RelationTypeSide side, final RelationTypeToken iRelationType, final CustomizedTeamWorkFlowArtifact ar) throws OseeCoreException {
      ...
      for (ArtifactReadable artifactReadable : relatedArtifacts) {
         ...
         if (artifactReadable.getArtifactType().equals(AtsArtifactTypes.Version)) {
            ArtifactReadable user =
               OseeCoreData.getOrcsApi().getQueryFactory().fromBranch(artifactReadable.getBranch()).andGuid(
