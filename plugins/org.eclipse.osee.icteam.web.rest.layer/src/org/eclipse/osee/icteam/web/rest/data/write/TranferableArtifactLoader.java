...
public class TranferableArtifactLoader {
   ...
   /**
    * This function sets the values in the transferable artifact from artifact readable object but the Relations will
    * not be filled in this method
    *
    ...
    */
   public static void copyArtifactReadbleToTransferableArtifactWithoutRelations(final ArtifactReadable readable, final TransferableArtifact transArtifact) throws OseeCoreException {
    ...
    * @throws OseeCoreException
    */
   public static void copyArtifactReadbleToTransferableArtifact(final ArtifactReadable readable, final ITransferableArtifact ar) throws OseeCoreException {
    ...
    * @throws OseeCoreException
    */
   public static void copyProjectArtifactReadbleToTransferableArtifact(final ArtifactReadable readable, final ITransferableArtifact ar) throws OseeCoreException {
    ...
    * @throws OseeCoreException
    */
   public static void fillRelations(final ResultSet<ArtifactReadable> relatedArtifacts, final RelationTypeSide side, final RelationTypeToken relationType, final ITransferableArtifact ar) throws OseeCoreException {
    ...
    */
   public static void copyArtifactReadbleToTransferableArtifactDup(final ArtifactReadable readable, final TransferableArtifact transArtifact) {
    ...
    * object
    */
   private static void fillRelationsdup(final ResultSet<ArtifactReadable> relatedArtifacts, final RelationTypeSide side, final RelationTypeToken iRelationType, final TransferableArtifact transArtifact) {
      List<ITransferableArtifact> list1 = new ArrayList<ITransferableArtifact>();
      for (ArtifactReadable artifactReadable : relatedArtifacts) {
    ...
    * @throws OseeCoreException
    */
   public static void copyBasicInfoToTransferableArtifact(final ArtifactReadable readable, final ITransferableArtifact rootArt) throws OseeCoreException {
   ...
   public static void copyAllInfoToTransferableArtifact(final ArtifactReadable readable, final ITransferableArtifact mainArt) throws OseeCoreException {
   ...
   public static void copyTaskInfoToTransferableArtifact(final ArtifactReadable readable, final TransferableArtifact transArt) throws OseeCoreException {
    ...
    * @return
    */
   public static ListenableFuture<?> copy(final ArtifactReadable readable, final TransferableArtifact transArt, final ListeningExecutorService executorService) {
    ...
    * @throws OseeCoreException
    */
   public static void copyBasicTaskInfoToTransferableArtifact(final ArtifactReadable readable, final TransferableArtifact transArt) throws OseeCoreException {
