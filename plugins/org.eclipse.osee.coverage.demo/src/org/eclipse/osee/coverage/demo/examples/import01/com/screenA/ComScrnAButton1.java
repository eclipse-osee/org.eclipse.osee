 ...
 *******************************************************************************/
package org.eclipse.osee.coverage.demo.examples.import01.com.screenA;
...
public class ComScrnAButton1 extends Button {
   ...
   public String getText() {
      try {
         ...
         OseeLog.log(ComScrnAButton1.class, Level.SEVERE, ex); // 1, 4, n
      }
      return "Navigate";
   }
   ...
   public Image getImage() {
      try {
         ...
         OseeLog.log(ComScrnAButton1.class, Level.SEVERE, ex); // 4, 4, n

      } catch (Exception ex) {
         OseeLog.log(ComScrnAButton1.class, Level.SEVERE, ex); // 4, 5, n
      }
      return null; // 4, 6, n
   }
