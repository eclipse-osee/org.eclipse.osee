 ...
 *******************************************************************************/
package org.eclipse.osee.coverage.demo.examples.import04.epu;
...
public class PowerUnit1 extends Table {
   ...
   public Image getImage() {
      try {
         ...
         OseeLog.log(PowerUnit1.class, Level.SEVERE, ex); // 1, 4, n

      } catch (Exception ex) {
         OseeLog.log(PowerUnit1.class, Level.SEVERE, ex); // 1, 5, n
      }
      return null; // 1, 6, n
   }
   ...
   public void clear(int[] indices) {
      try {
         ...
         OseeLog.log(PowerUnit1.class, Level.SEVERE, ex); // 2, 3, n

      } catch (Exception ex) {
         OseeLog.log(PowerUnit1.class, Level.SEVERE, ex); // 2, 4, n
      }
   }
   ...
   public int getColumnCount() {
      return super.getColumnCount(); // 8, 1, TestUnit3
   }
