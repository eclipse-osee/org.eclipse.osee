...
import org.eclipse.osee.coverage.demo.CoverageDemoUsers;
 ...
 */
public class AddCoverageDemoUsers implements IDbInitializationTask {
   ...
   public void run() throws OseeCoreException {
      ...
      for (IUserToken userEnum : CoverageDemoUsers.values()) {
      ...
      // Dependency on CM management
      AtsGroup.AtsAdmin.getArtifact().persist(transaction1);
      AtsGroup.AtsTempAdmin.addMember(UserManager.getUser(CoverageDemoUsers.Joe_Smith));
