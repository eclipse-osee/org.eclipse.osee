 ...
 *******************************************************************************/
package org.eclipse.osee.coverage.demo.examples.import02.com.screenA;
...
public class ComScrnAButton3 extends Button {
   ...
   public Image getImage() {
      try {
         ...
         OseeLog.log(ComScrnAButton3.class, Level.SEVERE, ex); // 1, 4, n

      } catch (Exception ex) {
         OseeLog.log(ComScrnAButton3.class, Level.SEVERE, ex); // 1, 5, n
      }
      return null; // 1, 6, n
   }
