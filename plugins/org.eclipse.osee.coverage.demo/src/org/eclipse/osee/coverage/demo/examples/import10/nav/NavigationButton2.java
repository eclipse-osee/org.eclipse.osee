 ...
 *******************************************************************************/
package org.eclipse.osee.coverage.demo.examples.import10.nav;
...
public class NavigationButton2 extends Button {
   ...
   public String getText() {
      try {
         ...
         OseeLog.log(NavigationButton2.class, Level.SEVERE, ex); // 1, 2, n
      }
   ...
   public Image getImage() {
      try {
         ...
         OseeLog.log(NavigationButton2.class, Level.SEVERE, ex); // 2, 4, n
      }
