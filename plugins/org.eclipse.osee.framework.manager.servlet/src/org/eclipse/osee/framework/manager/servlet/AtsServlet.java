...
public class AtsServlet extends UnsecuredOseeHttpServlet {
   ...
   public AtsServlet(Log logger, IResourceManager resourceManager, OrcsApi orcsApi, JdbcClient jdbcClient) {
      super(logger);
      ...
      this.atsService = new AtsService(provider, xmlSearch, messages, resourceManager, orcsApi, jdbcClient);
   }
