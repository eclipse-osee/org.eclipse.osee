...
public class HierarchyRestrictionItemProvider
      ...
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_HierarchyRestriction_artifactMatcherRef_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_HierarchyRestriction_artifactMatcherRef_feature", "_UI_HierarchyRestriction_type"),
             OseeDslPackage.Literals.HIERARCHY_RESTRICTION__ARTIFACT_MATCHER_REF,
             true,
             false,
             true,
             null,
   ...
   public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
      if (childrenFeatures == null) {
         ...
         childrenFeatures.add(OseeDslPackage.Literals.HIERARCHY_RESTRICTION__ACCESS_RULES);
      }
   ...
   public Object getImage(Object object) {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/HierarchyRestriction"));
   }
   ...
   public String getText(Object object) {
      return getString("_UI_HierarchyRestriction_type");
   }
   ...
   public void notifyChanged(Notification notification) {
      ...
      switch (notification.getFeatureID(HierarchyRestriction.class)) {
