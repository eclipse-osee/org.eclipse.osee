...
public class RelationTypeRestrictionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_RelationTypeRestriction_relationType_feature", "_UI_RelationTypeRestriction_type"),
				 OseeDslPackage.Literals.RELATION_TYPE_RESTRICTION__RELATION_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Restricted To feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OseeDslPackage.Literals.RELATION_TYPE_RESTRICTION__RESTRICTED_TO,
				 true,
				 false,
				 false,
