...
public class AccessContextItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OseeDslPackage.Literals.ACCESS_CONTEXT__TYPE_GUID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OseeDslPackage.Literals.ACCESS_CONTEXT__ACCESS_RULES);
			childrenFeatures.add(OseeDslPackage.Literals.ACCESS_CONTEXT__HIERARCHY_RESTRICTIONS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AccessContext"));
	}
