 ...
 * @generated
 */
public class PermissionRuleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PermissionRule_permission_feature", "_UI_PermissionRule_type"),
				 OseeDslPackage.Literals.PERMISSION_RULE__PERMISSION,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns PermissionRule.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_PermissionRule_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OseeDslPackage.Literals.PERMISSION_RULE__OBJECT_RESTRICTION,
