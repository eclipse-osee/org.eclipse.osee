...
public class ArtifactInstanceRestrictionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ArtifactInstanceRestriction_artifactName_feature", "_UI_ArtifactInstanceRestriction_type"),
				 OseeDslPackage.Literals.ARTIFACT_INSTANCE_RESTRICTION__ARTIFACT_NAME,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ArtifactInstanceRestriction"));
	}
