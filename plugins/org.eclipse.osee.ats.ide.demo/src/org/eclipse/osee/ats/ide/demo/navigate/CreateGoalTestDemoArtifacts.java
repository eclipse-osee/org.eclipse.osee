...
public class CreateGoalTestDemoArtifacts extends XNavigateItemAction {
   ...
   public void run(TableLoadOption... tableLoadOptions) {
      ...
      IAtsTeamWorkflow teamArt = createAction1(sawCodeGoal);

      createAction2(sawCodeGoal, cisReqGoal);

      createAction3(sawTestGoal, cisReqGoal);
   ...
   private void createAction3(GoalArtifact sawCodeGoal, GoalArtifact cisReqGoal) {
   ...
   private void createAction2(GoalArtifact sawCodeGoal, GoalArtifact cisReqGoal) {
   ...
   private IAtsTeamWorkflow createAction1(GoalArtifact sawCodeGoal) {
