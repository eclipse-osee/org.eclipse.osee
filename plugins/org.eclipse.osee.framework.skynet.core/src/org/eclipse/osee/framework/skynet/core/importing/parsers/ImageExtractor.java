...
public class ImageExtractor extends AbstractArtifactExtractor {

   @Override
   public String getDescription() {
      return "Extract the content of each image as one artifact.";
   }
   ...
   protected void extractFromSource(OperationLogger logger, URI source, RoughArtifactCollector collector) {
      ...
      RoughArtifact roughArtifact = new RoughArtifact(CoreArtifactTypes.Image, name);
