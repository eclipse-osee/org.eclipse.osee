...
public class UserServiceImpl2 implements UserService2 {
   ...
   private static UserServiceImpl2 instance;
   ...
   @Override
   public Collection<OseeUser> getUsers() {
      ensureLoaded();
      return users;
   }
   ...
   @Override
   public OseeUser getUser(ArtifactId accountId) {
      ensureLoaded();
      return idToUser.get(accountId.getId());
   }
   ...
   @Override
   public Collection<OseeUser> getUsers(IUserGroupArtifactToken userGroup) {
   ...
   @Override
   public OseeUser create(UserToken userTok) {
