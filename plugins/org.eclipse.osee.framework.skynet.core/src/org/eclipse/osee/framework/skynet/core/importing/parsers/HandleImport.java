...
public class HandleImport {
   ...
   public static void handleImport(Collection<URI> resources, Object destination, boolean persistChanges) throws OseeCoreException {
      ExtensionDefinedObjects<ImportHandler> handlerExtensions =
         new ExtensionDefinedObjects<ImportHandler>(Activator.PLUGIN_ID + "." + IMPORT_HANDLER_ID, IMPORT_HANDLER_ID,
            CLASSNAME);
