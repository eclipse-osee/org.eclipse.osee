...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>State Def</b></em>'. <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.impl.StateDefImpl#getRecommendedPercentComplete
...
public class StateDefImpl extends MinimalEObjectImpl.Container implements StateDef {
   ...
   /**
    * The default value of the '{@link #getPageType() <em>Page Type</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getPageType()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getPageType() <em>Page Type</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getPageType()
    * @generated
   ...
   /**
    * The default value of the '{@link #getPercentWeight() <em>Percent Weight</em>}' attribute. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * The cached value of the '{@link #getPercentWeight() <em>Percent Weight</em>}' attribute. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getPercentWeight()
    * @generated
   ...
   /**
    * The default value of the '{@link #getRecommendedPercentComplete() <em>Recommended Percent Complete</em>}'
   ...
   /**
    * The cached value of the '{@link #getRecommendedPercentComplete() <em>Recommended Percent Complete</em>}'
    * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
    * @see #getRecommendedPercentComplete()
    * @generated
   ...
   public void setDescription(String newDescription) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.STATE_DEF__DESCRIPTION, oldDescription,
            description));
      }
   }
   ...
   public void setPageType(String newPageType) {
      ...
      if (eNotificationRequired()) {
         eNotify(
            new ENotificationImpl(this, Notification.SET, AtsDslPackage.STATE_DEF__PAGE_TYPE, oldPageType, pageType));
      }
   }
   ...
   public EList<ToState> getTransitionStates() {
      if (transitionStates == null) {
         transitionStates =
            new EObjectContainmentEList<>(ToState.class, this, AtsDslPackage.STATE_DEF__TRANSITION_STATES);
      }
   ...
   public EList<DecisionReviewRef> getDecisionReviews() {
      if (decisionReviews == null) {
         decisionReviews =
            new EObjectContainmentEList<>(DecisionReviewRef.class, this, AtsDslPackage.STATE_DEF__DECISION_REVIEWS);
      }
   ...
   public void setPercentWeight(int newPercentWeight) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.STATE_DEF__PERCENT_WEIGHT,
            oldPercentWeight, percentWeight));
      }
   }
   ...
   public void setRecommendedPercentComplete(int newRecommendedPercentComplete) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.STATE_DEF__RECOMMENDED_PERCENT_COMPLETE,
            oldRecommendedPercentComplete, recommendedPercentComplete));
      }
   }
   ...
   public NotificationChain basicSetLayout(LayoutType newLayout, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification =
            new ENotificationImpl(this, Notification.SET, AtsDslPackage.STATE_DEF__LAYOUT, oldLayout, newLayout);
         if (msgs == null) {
            msgs = notification;
         } else {
      ...
      if (newLayout != layout) {
         ...
         if (layout != null) {
            msgs = ((InternalEObject) layout).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - AtsDslPackage.STATE_DEF__LAYOUT, null, msgs);
         }
         if (newLayout != null) {
