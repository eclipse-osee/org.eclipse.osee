...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Program Def</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class ProgramDefImpl extends MinimalEObjectImpl.Container implements ProgramDef {
   ...
   /**
    * The default value of the '{@link #getTeamDefinition() <em>Team Definition</em>}' attribute. <!-- begin-user-doc
    * --> <!-- end-user-doc -->
    * 
   ...
   /**
    * The cached value of the '{@link #getTeamDefinition() <em>Team Definition</em>}' attribute. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getTeamDefinition()
    * @generated
   ...
   public void setGuid(String newGuid) {
      ...
      guid = newGuid;
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.PROGRAM_DEF__GUID, oldGuid, guid));
      }
   }
   ...
   public void setArtifactTypeName(String newArtifactTypeName) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.PROGRAM_DEF__ARTIFACT_TYPE_NAME,
            oldArtifactTypeName, artifactTypeName));
      }
   }
   ...
   public void setNamespace(String newNamespace) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.PROGRAM_DEF__NAMESPACE, oldNamespace,
            namespace));
      }
   }
   ...
   public void setTeamDefinition(String newTeamDefinition) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.PROGRAM_DEF__TEAM_DEFINITION,
            oldTeamDefinition, teamDefinition));
      }
   }
   ...
   public boolean eIsSet(int featureID) {
      switch (featureID) {
         ...
         case AtsDslPackage.PROGRAM_DEF__ARTIFACT_TYPE_NAME:
            return ARTIFACT_TYPE_NAME_EDEFAULT == null ? artifactTypeName != null : !ARTIFACT_TYPE_NAME_EDEFAULT.equals(
               artifactTypeName);
         case AtsDslPackage.PROGRAM_DEF__ACTIVE:
         ...
         case AtsDslPackage.PROGRAM_DEF__TEAM_DEFINITION:
            return TEAM_DEFINITION_EDEFAULT == null ? teamDefinition != null : !TEAM_DEFINITION_EDEFAULT.equals(
               teamDefinition);
         case AtsDslPackage.PROGRAM_DEF__ATTRIBUTES:
