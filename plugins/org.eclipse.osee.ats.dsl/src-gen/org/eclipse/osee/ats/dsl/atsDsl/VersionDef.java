...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Version Def</b></em>'. <!-- end-user-doc -->
 * <p>
...
public interface VersionDef extends EObject {
    ...
    * @see #setGuid(String)
    * @see org.eclipse.osee.ats.dsl.atsDsl.AtsDslPackage#getVersionDef_Guid()
    * @model
    * @generated
    */
   String getGuid();
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.VersionDef#getGuid <em>Guid</em>}' attribute. <!--
    * begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Next</b></em>' attribute. The literals are from the enumeration
    * {@link org.eclipse.osee.ats.dsl.atsDsl.BooleanDef}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Next</em>' attribute isn't clear, there really should be more of a description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Released</b></em>' attribute. The literals are from the enumeration
    * {@link org.eclipse.osee.ats.dsl.atsDsl.BooleanDef}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Released</em>' attribute isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.VersionDef#getReleased <em>Released</em>}'
   ...
   /**
    * Returns the value of the '<em><b>Allow Create Branch</b></em>' attribute. The literals are from the enumeration
    * {@link org.eclipse.osee.ats.dsl.atsDsl.BooleanDef}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Allow Create Branch</em>' attribute isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.VersionDef#getAllowCreateBranch
    * <em>Allow Create Branch</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Allow Commit Branch</b></em>' attribute. The literals are from the enumeration
    * {@link org.eclipse.osee.ats.dsl.atsDsl.BooleanDef}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Allow Commit Branch</em>' attribute isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.VersionDef#getAllowCommitBranch
    * <em>Allow Commit Branch</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Baseline Branch Uuid</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Baseline Branch Uuid</em>' attribute isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.VersionDef#getBaselineBranchUuid
    * <em>Baseline Branch Uuid</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Parallel Version</b></em>' attribute list. The list contents are of type
    * {@link java.lang.String}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Parallel Version</em>' attribute list isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
