...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Ats Dsl</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class AtsDslImpl extends MinimalEObjectImpl.Container implements AtsDsl {
   /**
    * The cached value of the '{@link #getUserDef() <em>User Def</em>}' containment reference list. <!-- begin-user-doc
    * --> <!-- end-user-doc -->
    * 
    * @see #getUserDef()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getTeamDef() <em>Team Def</em>}' containment reference list. <!-- begin-user-doc
    * --> <!-- end-user-doc -->
    * 
    * @see #getTeamDef()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getWorkDef() <em>Work Def</em>}' containment reference list. <!-- begin-user-doc
    * --> <!-- end-user-doc -->
    * 
    * @see #getWorkDef()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getProgram() <em>Program</em>}' containment reference list. <!-- begin-user-doc
    * --> <!-- end-user-doc -->
    * 
    * @see #getProgram()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getRule() <em>Rule</em>}' containment reference list. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getRule()
    * @generated
   ...
   public EList<ActionableItemDef> getActionableItemDef() {
      if (actionableItemDef == null) {
         actionableItemDef =
            new EObjectContainmentEList<>(ActionableItemDef.class, this, AtsDslPackage.ATS_DSL__ACTIONABLE_ITEM_DEF);
      }
