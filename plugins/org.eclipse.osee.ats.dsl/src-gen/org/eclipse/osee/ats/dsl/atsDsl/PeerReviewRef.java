...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Peer Review Ref</b></em>'. <!-- end-user-doc -->
 * <p>
...
public interface PeerReviewRef extends EObject {
   /**
    * Returns the value of the '<em><b>Peer Review</b></em>' reference. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Peer Review</em>' reference isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.PeerReviewRef#getPeerReview <em>Peer Review</em>}'
