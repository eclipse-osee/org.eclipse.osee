...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>To State</b></em>'. <!-- end-user-doc -->
 * <p>
      ...
      if (state != null && state.eIsProxy()) {
         ...
         if (state != oldState) {
            if (eNotificationRequired()) {
               eNotify(
                  new ENotificationImpl(this, Notification.RESOLVE, AtsDslPackage.TO_STATE__STATE, oldState, state));
            }
         }
      }
      return state;
