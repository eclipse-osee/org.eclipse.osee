...
/**
 * <!-- begin-user-doc --> A representation of the literals of the enumeration '<em><b>Boolean Def</b></em>', and
...
public enum BooleanDef implements Enumerator {
    ...
    * <p>
    * If the meaning of '<em><b>True</b></em>' literal object isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
    ...
    * <p>
    * If the meaning of '<em><b>False</b></em>' literal object isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * An array of all the '<em><b>Boolean Def</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
    * @generated
    */
   private static final BooleanDef[] VALUES_ARRAY = new BooleanDef[] {NONE, TRUE, FALSE,};

   /**
    * A public read-only list of all the '<em><b>Boolean Def</b></em>' enumerators. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @generated
    */
   ...
   /**
    * Returns the '<em><b>Boolean Def</b></em>' literal with the specified literal value. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
   ...
   /**
    * Returns the '<em><b>Boolean Def</b></em>' literal with the specified name. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @param name the name.
    * @return the matching enumerator or <code>null</code>.
   ...
   /**
    * Returns the '<em><b>Boolean Def</b></em>' literal with the specified integer value. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
