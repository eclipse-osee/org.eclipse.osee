...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Work Def</b></em>'. <!-- end-user-doc -->
 * <p>
...
public interface WorkDef extends EObject {
   ...
   /**
    * Returns the value of the '<em><b>Id</b></em>' attribute list. The list contents are of type
    * {@link java.lang.String}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Id</em>' attribute list isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Start State</b></em>' reference. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Start State</em>' reference isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.WorkDef#getStartState <em>Start State</em>}'
   ...
   /**
    * Returns the value of the '<em><b>Widget Defs</b></em>' containment reference list. The list contents are of type
    * {@link org.eclipse.osee.ats.dsl.atsDsl.WidgetDef}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Widget Defs</em>' containment reference list isn't clear, there really should be more
   ...
   /**
    * Returns the value of the '<em><b>Decision Review Defs</b></em>' containment reference list. The list contents are
    * of type {@link org.eclipse.osee.ats.dsl.atsDsl.DecisionReviewDef}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Decision Review Defs</em>' containment reference list isn't clear, there really should
   ...
   /**
    * Returns the value of the '<em><b>Peer Review Defs</b></em>' containment reference list. The list contents are of
    * type {@link org.eclipse.osee.ats.dsl.atsDsl.PeerReviewDef}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Peer Review Defs</em>' containment reference list isn't clear, there really should be
    ...
    * {@link org.eclipse.osee.ats.dsl.atsDsl.StateDef}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>States</em>' containment reference list isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
