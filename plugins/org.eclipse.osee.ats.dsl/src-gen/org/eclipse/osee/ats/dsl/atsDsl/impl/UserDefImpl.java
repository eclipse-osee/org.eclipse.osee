...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>User Def</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class UserDefImpl extends MinimalEObjectImpl.Container implements UserDef {
   ...
   /**
    * The cached value of the '{@link #getUserDefOption() <em>User Def Option</em>}' attribute list. <!-- begin-user-doc
    * --> <!-- end-user-doc -->
    * 
   ...
   /**
    * The default value of the '{@link #getAdmin() <em>Admin</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
    * -->
    * 
    * @see #getAdmin()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getAdmin() <em>Admin</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
    * -->
    * 
    * @see #getAdmin()
    * @generated
