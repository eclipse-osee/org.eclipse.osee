...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Attr Def</b></em>'. <!-- end-user-doc -->
 * <p>
...
public interface AttrDef extends EObject {
   ...
   /**
    * Returns the value of the '<em><b>Option</b></em>' containment reference. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Option</em>' containment reference isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.AttrDef#getOption <em>Option</em>}' containment
