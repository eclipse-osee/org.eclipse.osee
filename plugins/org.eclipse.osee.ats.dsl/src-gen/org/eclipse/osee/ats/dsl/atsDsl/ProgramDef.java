...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Program Def</b></em>'. <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.ProgramDef#getGuid <em>Guid</em>}</li>
...
public interface ProgramDef extends EObject {
   ...
   /**
    * Returns the value of the '<em><b>Program Def Option</b></em>' attribute list. The list contents are of type
    * {@link java.lang.String}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Program Def Option</em>' attribute list isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
    ...
    * @see #setGuid(String)
    * @see org.eclipse.osee.ats.dsl.atsDsl.AtsDslPackage#getProgramDef_Guid()
    * @model
    * @generated
    */
   String getGuid();
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.ProgramDef#getGuid <em>Guid</em>}' attribute. <!--
    * begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Artifact Type Name</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Artifact Type Name</em>' attribute isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.ProgramDef#getArtifactTypeName
    * <em>Artifact Type Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.ProgramDef#getNamespace <em>Namespace</em>}'
   ...
   /**
    * Returns the value of the '<em><b>Team Definition</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Team Definition</em>' attribute isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.ProgramDef#getTeamDefinition
    * <em>Team Definition</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
    ...
    * {@link org.eclipse.osee.ats.dsl.atsDsl.AttrDef}. <!-- begin-user-doc -->
    * <p>
