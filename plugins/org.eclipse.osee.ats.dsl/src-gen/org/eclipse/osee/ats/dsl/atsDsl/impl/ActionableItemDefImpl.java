...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Actionable Item Def</b></em>'. <!--
 * end-user-doc -->
 * <p>
 ...
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.impl.ActionableItemDefImpl#getAccessContextId <em>Access Context Id</em>}
 * </li>
...
public class ActionableItemDefImpl extends MinimalEObjectImpl.Container implements ActionableItemDef {
   ...
   /**
    * The cached value of the '{@link #getAiDefOption() <em>Ai Def Option</em>}' attribute list. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getAiDefOption()
    * @generated
   ...
   /**
    * The default value of the '{@link #getActionable() <em>Actionable</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getActionable()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getActionable() <em>Actionable</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getActionable()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getOwner() <em>Owner</em>}' containment reference list. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getOwner()
    * @generated
   ...
   /**
    * The default value of the '{@link #getTeamDef() <em>Team Def</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getTeamDef()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getTeamDef() <em>Team Def</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getTeamDef()
    * @generated
   ...
   public void setActive(BooleanDef newActive) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.ACTIONABLE_ITEM_DEF__ACTIVE, oldActive,
            active));
      }
   }
   ...
   public void setActionable(BooleanDef newActionable) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.ACTIONABLE_ITEM_DEF__ACTIONABLE,
            oldActionable, actionable));
      }
   }
   ...
   public void setTeamDef(String newTeamDef) {
      ...
      teamDef = newTeamDef;
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.ACTIONABLE_ITEM_DEF__TEAM_DEF, oldTeamDef,
            teamDef));
      }
   }
   ...
   public EList<String> getAccessContextId() {
      if (accessContextId == null) {
         accessContextId =
            new EDataTypeEList<>(String.class, this, AtsDslPackage.ACTIONABLE_ITEM_DEF__ACCESS_CONTEXT_ID);
      }
   ...
   public EList<ActionableItemDef> getChildren() {
      if (children == null) {
         children =
            new EObjectContainmentEList<>(ActionableItemDef.class, this, AtsDslPackage.ACTIONABLE_ITEM_DEF__CHILDREN);
      }
      return children;
   }
