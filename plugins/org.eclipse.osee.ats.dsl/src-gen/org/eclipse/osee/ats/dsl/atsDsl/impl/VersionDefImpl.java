...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Version Def</b></em>'. <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.impl.VersionDefImpl#getAllowCreateBranch <em>Allow Create Branch</em>}
 * </li>
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.impl.VersionDefImpl#getAllowCommitBranch <em>Allow Commit Branch</em>}
 * </li>
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.impl.VersionDefImpl#getBaselineBranchUuid <em>Baseline Branch Uuid</em>}
 * </li>
...
public class VersionDefImpl extends MinimalEObjectImpl.Container implements VersionDef {
   ...
   /**
    * The default value of the '{@link #getNext() <em>Next</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
    * -->
    * 
    * @see #getNext()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getNext() <em>Next</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
    * -->
    * 
    * @see #getNext()
    * @generated
   ...
   /**
    * The default value of the '{@link #getReleased() <em>Released</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getReleased()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getReleased() <em>Released</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getReleased()
    * @generated
   ...
   public void setReleased(BooleanDef newReleased) {
      ...
      if (eNotificationRequired()) {
         eNotify(
            new ENotificationImpl(this, Notification.SET, AtsDslPackage.VERSION_DEF__RELEASED, oldReleased, released));
      }
   }
   ...
   public void setAllowCreateBranch(BooleanDef newAllowCreateBranch) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.VERSION_DEF__ALLOW_CREATE_BRANCH,
            oldAllowCreateBranch, allowCreateBranch));
      }
   }
   ...
   public void setAllowCommitBranch(BooleanDef newAllowCommitBranch) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.VERSION_DEF__ALLOW_COMMIT_BRANCH,
            oldAllowCommitBranch, allowCommitBranch));
      }
   }
   ...
   public void setBaselineBranchUuid(String newBaselineBranchUuid) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.VERSION_DEF__BASELINE_BRANCH_UUID,
            oldBaselineBranchUuid, baselineBranchUuid));
      }
   }
   ...
   public boolean eIsSet(int featureID) {
      switch (featureID) {
         ...
         case AtsDslPackage.VERSION_DEF__BASELINE_BRANCH_UUID:
            return BASELINE_BRANCH_UUID_EDEFAULT == null ? baselineBranchUuid != null : !BASELINE_BRANCH_UUID_EDEFAULT.equals(
               baselineBranchUuid);
         case AtsDslPackage.VERSION_DEF__PARALLEL_VERSION:
