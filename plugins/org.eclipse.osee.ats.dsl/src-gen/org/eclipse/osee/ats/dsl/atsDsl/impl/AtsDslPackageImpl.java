...
public class AtsDslPackageImpl extends EPackageImpl implements AtsDslPackage {
    ...
    * <p>
    * This method is used to initialize {@link AtsDslPackage#eINSTANCE} when that field is accessed. Clients should not
   ...
   public static AtsDslPackage init() {
      if (isInited) {
         return (AtsDslPackage) EPackage.Registry.INSTANCE.getEPackage(AtsDslPackage.eNS_URI);
      }

      // Obtain or create and register package
      AtsDslPackageImpl theAtsDslPackage = (AtsDslPackageImpl) (EPackage.Registry.INSTANCE.get(
         eNS_URI) instanceof AtsDslPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AtsDslPackageImpl());
   ...
   public EAttribute getProgramDef_TeamDefinition() {
      return (EAttribute) programDefEClass.getEStructuralFeatures().get(7);
   }
   ...
   public EReference getProgramDef_Attributes() {
      return (EReference) programDefEClass.getEStructuralFeatures().get(8);
   }
   ...
   public EAttribute getTeamDef_StaticId() {
      return (EAttribute) teamDefEClass.getEStructuralFeatures().get(5);
   }
   ...
   public EReference getTeamDef_Privileged() {
      return (EReference) teamDefEClass.getEStructuralFeatures().get(8);
   }
   ...
   public EAttribute getTeamDef_AccessContextId() {
      return (EAttribute) teamDefEClass.getEStructuralFeatures().get(12);
   }
   ...
   public void initializePackageContents() {
      ...
      initEReference(getAtsDsl_UserDef(), this.getUserDef(), null, "userDef", null, 0, -1, AtsDsl.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEReference(getAtsDsl_TeamDef(), this.getTeamDef(), null, "teamDef", null, 0, -1, AtsDsl.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEReference(getAtsDsl_ActionableItemDef(), this.getActionableItemDef(), null, "actionableItemDef", null, 0, -1,
         AtsDsl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
         IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getAtsDsl_WorkDef(), this.getWorkDef(), null, "workDef", null, 0, -1, AtsDsl.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEReference(getAtsDsl_Program(), this.getProgramDef(), null, "program", null, 0, -1, AtsDsl.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEReference(getAtsDsl_Rule(), this.getRule(), null, "rule", null, 0, -1, AtsDsl.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);

      initEClass(userDefEClass, UserDef.class, "UserDef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getUserDef_Name(), ecorePackage.getEString(), "name", null, 0, 1, UserDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getUserDef_UserDefOption(), ecorePackage.getEString(), "userDefOption", null, 0, -1, UserDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getUserDef_Active(), this.getBooleanDef(), "active", null, 0, 1, UserDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getUserDef_UserId(), ecorePackage.getEString(), "userId", null, 0, 1, UserDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getUserDef_Email(), ecorePackage.getEString(), "email", null, 0, 1, UserDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getUserDef_Admin(), this.getBooleanDef(), "admin", null, 0, 1, UserDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(attrDefEClass, AttrDef.class, "AttrDef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getAttrDef_Name(), ecorePackage.getEString(), "name", null, 0, 1, AttrDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getAttrDef_Option(), this.getAttrDefOptions(), null, "option", null, 0, 1, AttrDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);

      initEClass(attrDefOptionsEClass, AttrDefOptions.class, "AttrDefOptions", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);

      initEClass(attrValueDefEClass, AttrValueDef.class, "AttrValueDef", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getAttrValueDef_Value(), ecorePackage.getEString(), "value", null, 0, 1, AttrValueDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(attrFullDefEClass, AttrFullDef.class, "AttrFullDef", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getAttrFullDef_Uuid(), ecorePackage.getEString(), "uuid", null, 0, 1, AttrFullDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getAttrFullDef_Values(), ecorePackage.getEString(), "values", null, 0, -1, AttrFullDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(programDefEClass, ProgramDef.class, "ProgramDef", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getProgramDef_Name(), ecorePackage.getEString(), "name", null, 0, 1, ProgramDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getProgramDef_ProgramDefOption(), ecorePackage.getEString(), "programDefOption", null, 0, -1,
         ProgramDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEAttribute(getProgramDef_Guid(), ecorePackage.getEString(), "guid", null, 0, 1, ProgramDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getProgramDef_Uuid(), ecorePackage.getEInt(), "uuid", null, 0, 1, ProgramDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getProgramDef_ArtifactTypeName(), ecorePackage.getEString(), "artifactTypeName", null, 0, 1,
         ProgramDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEAttribute(getProgramDef_Active(), this.getBooleanDef(), "active", null, 0, 1, ProgramDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getProgramDef_Namespace(), ecorePackage.getEString(), "namespace", null, 0, 1, ProgramDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getProgramDef_TeamDefinition(), ecorePackage.getEString(), "teamDefinition", null, 0, 1,
         ProgramDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEReference(getProgramDef_Attributes(), this.getAttrDef(), null, "attributes", null, 0, -1, ProgramDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);

      initEClass(teamDefEClass, TeamDef.class, "TeamDef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getTeamDef_Name(), ecorePackage.getEString(), "name", null, 0, 1, TeamDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getTeamDef_TeamDefOption(), ecorePackage.getEString(), "teamDefOption", null, 0, -1, TeamDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getTeamDef_Guid(), ecorePackage.getEString(), "guid", null, 0, 1, TeamDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getTeamDef_Uuid(), ecorePackage.getEInt(), "uuid", null, 0, 1, TeamDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getTeamDef_Active(), this.getBooleanDef(), "active", null, 0, 1, TeamDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getTeamDef_StaticId(), ecorePackage.getEString(), "staticId", null, 0, -1, TeamDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getTeamDef_Lead(), this.getUserRef(), null, "lead", null, 0, -1, TeamDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEReference(getTeamDef_Member(), this.getUserRef(), null, "member", null, 0, -1, TeamDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEReference(getTeamDef_Privileged(), this.getUserRef(), null, "privileged", null, 0, -1, TeamDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getTeamDef_WorkDefinition(), ecorePackage.getEString(), "workDefinition", null, 0, 1,
         TeamDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEAttribute(getTeamDef_RelatedTaskWorkDefinition(), ecorePackage.getEString(), "relatedTaskWorkDefinition",
         null, 0, 1, TeamDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getTeamDef_TeamWorkflowArtifactType(), ecorePackage.getEString(), "teamWorkflowArtifactType", null,
         0, 1, TeamDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getTeamDef_AccessContextId(), ecorePackage.getEString(), "accessContextId", null, 0, -1,
         TeamDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEReference(getTeamDef_Version(), this.getVersionDef(), null, "version", null, 0, -1, TeamDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getTeamDef_Rules(), ecorePackage.getEString(), "rules", null, 0, -1, TeamDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getTeamDef_Children(), this.getTeamDef(), null, "children", null, 0, -1, TeamDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);

      initEClass(actionableItemDefEClass, ActionableItemDef.class, "ActionableItemDef", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getActionableItemDef_Name(), ecorePackage.getEString(), "name", null, 0, 1,
         ActionableItemDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getActionableItemDef_AiDefOption(), ecorePackage.getEString(), "aiDefOption", null, 0, -1,
         ActionableItemDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getActionableItemDef_Guid(), ecorePackage.getEString(), "guid", null, 0, 1,
         ActionableItemDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getActionableItemDef_Uuid(), ecorePackage.getEInt(), "uuid", null, 0, 1, ActionableItemDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getActionableItemDef_Active(), this.getBooleanDef(), "active", null, 0, 1, ActionableItemDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getActionableItemDef_Actionable(), this.getBooleanDef(), "actionable", null, 0, 1,
         ActionableItemDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEReference(getActionableItemDef_Lead(), this.getUserRef(), null, "lead", null, 0, -1, ActionableItemDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEReference(getActionableItemDef_Owner(), this.getUserRef(), null, "owner", null, 0, -1,
         ActionableItemDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getActionableItemDef_StaticId(), ecorePackage.getEString(), "staticId", null, 0, -1,
         ActionableItemDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getActionableItemDef_TeamDef(), ecorePackage.getEString(), "teamDef", null, 0, 1,
         ActionableItemDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getActionableItemDef_AccessContextId(), ecorePackage.getEString(), "accessContextId", null, 0, -1,
         ActionableItemDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getActionableItemDef_Rules(), ecorePackage.getEString(), "rules", null, 0, -1,
         ActionableItemDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEReference(getActionableItemDef_Children(), this.getActionableItemDef(), null, "children", null, 0, -1,
         ActionableItemDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(versionDefEClass, VersionDef.class, "VersionDef", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getVersionDef_Name(), ecorePackage.getEString(), "name", null, 0, 1, VersionDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getVersionDef_Guid(), ecorePackage.getEString(), "guid", null, 0, 1, VersionDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getVersionDef_Uuid(), ecorePackage.getEInt(), "uuid", null, 0, 1, VersionDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getVersionDef_StaticId(), ecorePackage.getEString(), "staticId", null, 0, -1, VersionDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getVersionDef_Next(), this.getBooleanDef(), "next", null, 0, 1, VersionDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getVersionDef_Released(), this.getBooleanDef(), "released", null, 0, 1, VersionDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getVersionDef_AllowCreateBranch(), this.getBooleanDef(), "allowCreateBranch", null, 0, 1,
         VersionDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEAttribute(getVersionDef_AllowCommitBranch(), this.getBooleanDef(), "allowCommitBranch", null, 0, 1,
         VersionDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEAttribute(getVersionDef_BaselineBranchUuid(), ecorePackage.getEString(), "baselineBranchUuid", null, 0, 1,
         VersionDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEAttribute(getVersionDef_ParallelVersion(), ecorePackage.getEString(), "parallelVersion", null, 0, -1,
         VersionDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);

      initEClass(workDefEClass, WorkDef.class, "WorkDef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getWorkDef_Name(), ecorePackage.getEString(), "name", null, 0, 1, WorkDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getWorkDef_Id(), ecorePackage.getEString(), "id", null, 0, -1, WorkDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getWorkDef_StartState(), this.getStateDef(), null, "startState", null, 0, 1, WorkDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEReference(getWorkDef_WidgetDefs(), this.getWidgetDef(), null, "widgetDefs", null, 0, -1, WorkDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEReference(getWorkDef_DecisionReviewDefs(), this.getDecisionReviewDef(), null, "decisionReviewDefs", null, 0,
         -1, WorkDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getWorkDef_PeerReviewDefs(), this.getPeerReviewDef(), null, "peerReviewDefs", null, 0, -1,
         WorkDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
         IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getWorkDef_States(), this.getStateDef(), null, "states", null, 0, -1, WorkDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);

      initEClass(widgetDefEClass, WidgetDef.class, "WidgetDef", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getWidgetDef_Name(), ecorePackage.getEString(), "name", null, 0, 1, WidgetDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getWidgetDef_AttributeName(), ecorePackage.getEString(), "attributeName", null, 0, 1,
         WidgetDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEAttribute(getWidgetDef_Description(), ecorePackage.getEString(), "description", null, 0, 1, WidgetDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getWidgetDef_XWidgetName(), ecorePackage.getEString(), "xWidgetName", null, 0, 1, WidgetDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getWidgetDef_DefaultValue(), ecorePackage.getEString(), "defaultValue", null, 0, 1,
         WidgetDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEAttribute(getWidgetDef_Height(), ecorePackage.getEInt(), "height", null, 0, 1, WidgetDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getWidgetDef_Option(), ecorePackage.getEString(), "option", null, 0, -1, WidgetDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getWidgetDef_MinConstraint(), ecorePackage.getEString(), "minConstraint", null, 0, 1,
         WidgetDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEAttribute(getWidgetDef_MaxConstraint(), ecorePackage.getEString(), "maxConstraint", null, 0, 1,
         WidgetDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);

      initEClass(widgetRefEClass, WidgetRef.class, "WidgetRef", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEReference(getWidgetRef_Widget(), this.getWidgetDef(), null, "widget", null, 0, 1, WidgetRef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);

      initEClass(attrWidgetEClass, AttrWidget.class, "AttrWidget", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getAttrWidget_AttributeName(), ecorePackage.getEString(), "attributeName", null, 0, 1,
         AttrWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEAttribute(getAttrWidget_Option(), ecorePackage.getEString(), "option", null, 0, -1, AttrWidget.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(stateDefEClass, StateDef.class, "StateDef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getStateDef_Name(), ecorePackage.getEString(), "name", null, 0, 1, StateDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getStateDef_Description(), ecorePackage.getEString(), "description", null, 0, 1, StateDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getStateDef_PageType(), ecorePackage.getEString(), "pageType", null, 0, 1, StateDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getStateDef_Ordinal(), ecorePackage.getEInt(), "ordinal", null, 0, 1, StateDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getStateDef_TransitionStates(), this.getToState(), null, "transitionStates", null, 0, -1,
         StateDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
         IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getStateDef_Rules(), ecorePackage.getEString(), "rules", null, 0, -1, StateDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getStateDef_DecisionReviews(), this.getDecisionReviewRef(), null, "decisionReviews", null, 0, -1,
         StateDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
         IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getStateDef_PeerReviews(), this.getPeerReviewRef(), null, "peerReviews", null, 0, -1,
         StateDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
         IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getStateDef_PercentWeight(), ecorePackage.getEInt(), "percentWeight", null, 0, 1, StateDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getStateDef_RecommendedPercentComplete(), ecorePackage.getEInt(), "recommendedPercentComplete",
         null, 0, 1, StateDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getStateDef_Color(), ecorePackage.getEString(), "color", null, 0, 1, StateDef.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getStateDef_Layout(), this.getLayoutType(), null, "layout", null, 0, 1, StateDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);

      initEClass(decisionReviewRefEClass, DecisionReviewRef.class, "DecisionReviewRef", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEReference(getDecisionReviewRef_DecisionReview(), this.getDecisionReviewDef(), null, "decisionReview", null,
         0, 1, DecisionReviewRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(decisionReviewDefEClass, DecisionReviewDef.class, "DecisionReviewDef", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getDecisionReviewDef_Name(), ecorePackage.getEString(), "name", null, 0, 1,
         DecisionReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getDecisionReviewDef_Title(), ecorePackage.getEString(), "title", null, 0, 1,
         DecisionReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getDecisionReviewDef_Description(), ecorePackage.getEString(), "description", null, 0, 1,
         DecisionReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEReference(getDecisionReviewDef_RelatedToState(), this.getStateDef(), null, "relatedToState", null, 0, 1,
         DecisionReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getDecisionReviewDef_BlockingType(), this.getReviewBlockingType(), "blockingType", null, 0, 1,
         DecisionReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getDecisionReviewDef_StateEvent(), this.getWorkflowEventType(), "stateEvent", null, 0, 1,
         DecisionReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEReference(getDecisionReviewDef_AssigneeRefs(), this.getUserRef(), null, "assigneeRefs", null, 0, -1,
         DecisionReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getDecisionReviewDef_AutoTransitionToDecision(), this.getBooleanDef(), "autoTransitionToDecision",
         null, 0, 1, DecisionReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
         IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getDecisionReviewDef_Options(), this.getDecisionReviewOpt(), null, "options", null, 0, -1,
         DecisionReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(decisionReviewOptEClass, DecisionReviewOpt.class, "DecisionReviewOpt", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getDecisionReviewOpt_Name(), ecorePackage.getEString(), "name", null, 0, 1,
         DecisionReviewOpt.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEReference(getDecisionReviewOpt_Followup(), this.getFollowupRef(), null, "followup", null, 0, 1,
         DecisionReviewOpt.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(peerReviewRefEClass, PeerReviewRef.class, "PeerReviewRef", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEReference(getPeerReviewRef_PeerReview(), this.getPeerReviewDef(), null, "peerReview", null, 0, 1,
         PeerReviewRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(peerReviewDefEClass, PeerReviewDef.class, "PeerReviewDef", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getPeerReviewDef_Name(), ecorePackage.getEString(), "name", null, 0, 1, PeerReviewDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getPeerReviewDef_Title(), ecorePackage.getEString(), "title", null, 0, 1, PeerReviewDef.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getPeerReviewDef_Description(), ecorePackage.getEString(), "description", null, 0, 1,
         PeerReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getPeerReviewDef_Location(), ecorePackage.getEString(), "location", null, 0, 1,
         PeerReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEReference(getPeerReviewDef_RelatedToState(), this.getStateDef(), null, "relatedToState", null, 0, 1,
         PeerReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getPeerReviewDef_BlockingType(), this.getReviewBlockingType(), "blockingType", null, 0, 1,
         PeerReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getPeerReviewDef_StateEvent(), this.getWorkflowEventType(), "stateEvent", null, 0, 1,
         PeerReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEReference(getPeerReviewDef_AssigneeRefs(), this.getUserRef(), null, "assigneeRefs", null, 0, -1,
         PeerReviewDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(followupRefEClass, FollowupRef.class, "FollowupRef", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEReference(getFollowupRef_AssigneeRefs(), this.getUserRef(), null, "assigneeRefs", null, 0, -1,
         FollowupRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(userRefEClass, UserRef.class, "UserRef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

      initEClass(userByUserIdEClass, UserByUserId.class, "UserByUserId", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getUserByUserId_UserId(), ecorePackage.getEString(), "userId", null, 0, 1, UserByUserId.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(userByNameEClass, UserByName.class, "UserByName", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getUserByName_UserName(), ecorePackage.getEString(), "userName", null, 0, 1, UserByName.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(toStateEClass, ToState.class, "ToState", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getToState_State(), this.getStateDef(), null, "state", null, 0, 1, ToState.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEAttribute(getToState_Options(), ecorePackage.getEString(), "options", null, 0, -1, ToState.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(layoutTypeEClass, LayoutType.class, "LayoutType", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);

      initEClass(layoutDefEClass, LayoutDef.class, "LayoutDef", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEReference(getLayoutDef_LayoutItems(), this.getLayoutItem(), null, "layoutItems", null, 0, -1,
         LayoutDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
         IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(layoutCopyEClass, LayoutCopy.class, "LayoutCopy", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEReference(getLayoutCopy_State(), this.getStateDef(), null, "state", null, 0, 1, LayoutCopy.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);

      initEClass(layoutItemEClass, LayoutItem.class, "LayoutItem", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);

      initEClass(compositeEClass, Composite.class, "Composite", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getComposite_NumColumns(), ecorePackage.getEInt(), "numColumns", null, 0, 1, Composite.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getComposite_LayoutItems(), this.getLayoutItem(), null, "layoutItems", null, 0, -1,
         Composite.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
         IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getComposite_Options(), ecorePackage.getEString(), "options", null, 0, -1, Composite.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(ruleDefEClass, RuleDef.class, "RuleDef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

      initEClass(createTaskRuleEClass, CreateTaskRule.class, "CreateTaskRule", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEReference(getCreateTaskRule_Assignees(), this.getUserDef(), null, "assignees", null, 0, -1,
         CreateTaskRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getCreateTaskRule_RelatedState(), ecorePackage.getEString(), "relatedState", null, 0, 1,
         CreateTaskRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getCreateTaskRule_TaskWorkDef(), ecorePackage.getEString(), "taskWorkDef", null, 0, 1,
         CreateTaskRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getCreateTaskRule_OnEvent(), this.getOnEventType(), "onEvent", null, 0, -1, CreateTaskRule.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getCreateTaskRule_Attributes(), this.getAttrDef(), null, "attributes", null, 0, -1,
         CreateTaskRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(createDecisionReviewRuleEClass, CreateDecisionReviewRule.class, "CreateDecisionReviewRule",
         !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getCreateDecisionReviewRule_AutoTransitionToDecision(), this.getBooleanDef(),
         "autoTransitionToDecision", null, 0, 1, CreateDecisionReviewRule.class, !IS_TRANSIENT, !IS_VOLATILE,
         IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getCreateDecisionReviewRule_Options(), this.getDecisionReviewOpt(), null, "options", null, 0, -1,
         CreateDecisionReviewRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
         !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(createPeerReviewRuleEClass, CreatePeerReviewRule.class, "CreatePeerReviewRule", !IS_ABSTRACT,
         !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getCreatePeerReviewRule_Location(), ecorePackage.getEString(), "location", null, 0, 1,
         CreatePeerReviewRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);

      initEClass(reviewRuleEClass, ReviewRule.class, "ReviewRule", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      initEReference(getReviewRule_Assignees(), this.getUserDef(), null, "assignees", null, 0, -1, ReviewRule.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      initEAttribute(getReviewRule_RelatedToState(), ecorePackage.getEString(), "relatedToState", null, 0, 1,
         ReviewRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEAttribute(getReviewRule_BlockingType(), this.getReviewBlockingType(), "blockingType", null, 0, 1,
         ReviewRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEAttribute(getReviewRule_StateEvent(), this.getWorkflowEventType(), "stateEvent", null, 0, 1,
         ReviewRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
         IS_ORDERED);
      initEReference(getReviewRule_Attributes(), this.getAttrDef(), null, "attributes", null, 0, -1, ReviewRule.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
         !IS_DERIVED, IS_ORDERED);
      ...
      initEAttribute(getRule_Name(), ecorePackage.getEString(), "name", null, 0, 1, Rule.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getRule_Title(), ecorePackage.getEString(), "title", null, 0, 1, Rule.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getRule_Description(), ecorePackage.getEString(), "description", null, 0, 1, Rule.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getRule_RuleLocation(), this.getRuleLocation(), "ruleLocation", null, 0, -1, Rule.class,
         !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
