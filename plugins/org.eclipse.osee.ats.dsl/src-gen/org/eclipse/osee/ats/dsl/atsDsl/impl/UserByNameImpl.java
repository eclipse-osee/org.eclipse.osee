...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>User By Name</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class UserByNameImpl extends UserRefImpl implements UserByName {
   ...
   public void setUserName(String newUserName) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.USER_BY_NAME__USER_NAME, oldUserName,
            userName));
      }
   }
