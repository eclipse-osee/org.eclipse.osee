...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Team Def</b></em>'. <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.impl.TeamDefImpl#getRelatedTaskWorkDefinition
 * <em>Related Task Work Definition</em>}</li>
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.impl.TeamDefImpl#getTeamWorkflowArtifactType
 * <em>Team Workflow Artifact Type</em>}</li>
...
public class TeamDefImpl extends MinimalEObjectImpl.Container implements TeamDef {
   ...
   /**
    * The cached value of the '{@link #getTeamDefOption() <em>Team Def Option</em>}' attribute list. <!-- begin-user-doc
    * --> <!-- end-user-doc -->
    * 
   ...
   /**
    * The default value of the '{@link #getActive() <em>Active</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getActive()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getActive() <em>Active</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getActive()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getStaticId() <em>Static Id</em>}' attribute list. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getStaticId()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getLead() <em>Lead</em>}' containment reference list. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getLead()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getMember() <em>Member</em>}' containment reference list. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getMember()
    * @generated
   ...
   /**
    * The default value of the '{@link #getWorkDefinition() <em>Work Definition</em>}' attribute. <!-- begin-user-doc
    * --> <!-- end-user-doc -->
    * 
   ...
   /**
    * The cached value of the '{@link #getWorkDefinition() <em>Work Definition</em>}' attribute. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getWorkDefinition()
    * @generated
   ...
   /**
    * The default value of the '{@link #getRelatedTaskWorkDefinition() <em>Related Task Work Definition</em>}'
   ...
   /**
    * The cached value of the '{@link #getRules() <em>Rules</em>}' attribute list. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getRules()
    * @generated
   ...
   public void setWorkDefinition(String newWorkDefinition) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.TEAM_DEF__WORK_DEFINITION,
            oldWorkDefinition, workDefinition));
      }
   }
   ...
   public void setRelatedTaskWorkDefinition(String newRelatedTaskWorkDefinition) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.TEAM_DEF__RELATED_TASK_WORK_DEFINITION,
            oldRelatedTaskWorkDefinition, relatedTaskWorkDefinition));
      }
   }
   ...
   public void setTeamWorkflowArtifactType(String newTeamWorkflowArtifactType) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.TEAM_DEF__TEAM_WORKFLOW_ARTIFACT_TYPE,
            oldTeamWorkflowArtifactType, teamWorkflowArtifactType));
      }
   }
   ...
   public boolean eIsSet(int featureID) {
      switch (featureID) {
         ...
         case AtsDslPackage.TEAM_DEF__WORK_DEFINITION:
            return WORK_DEFINITION_EDEFAULT == null ? workDefinition != null : !WORK_DEFINITION_EDEFAULT.equals(
               workDefinition);
         case AtsDslPackage.TEAM_DEF__RELATED_TASK_WORK_DEFINITION:
            return RELATED_TASK_WORK_DEFINITION_EDEFAULT == null ? relatedTaskWorkDefinition != null : !RELATED_TASK_WORK_DEFINITION_EDEFAULT.equals(
               relatedTaskWorkDefinition);
         case AtsDslPackage.TEAM_DEF__TEAM_WORKFLOW_ARTIFACT_TYPE:
            return TEAM_WORKFLOW_ARTIFACT_TYPE_EDEFAULT == null ? teamWorkflowArtifactType != null : !TEAM_WORKFLOW_ARTIFACT_TYPE_EDEFAULT.equals(
