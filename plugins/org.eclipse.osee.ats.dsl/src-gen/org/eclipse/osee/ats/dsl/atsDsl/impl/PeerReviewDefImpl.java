...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Peer Review Def</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class PeerReviewDefImpl extends MinimalEObjectImpl.Container implements PeerReviewDef {
   ...
   public void setDescription(String newDescription) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.PEER_REVIEW_DEF__DESCRIPTION,
   ...
   public void setLocation(String newLocation) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.PEER_REVIEW_DEF__LOCATION, oldLocation,
            location));
      }
   }
         ...
         if (relatedToState != oldRelatedToState) {
            if (eNotificationRequired()) {
               eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                  AtsDslPackage.PEER_REVIEW_DEF__RELATED_TO_STATE, oldRelatedToState, relatedToState));
            }
         }
      }
   ...
   public void setRelatedToState(StateDef newRelatedToState) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.PEER_REVIEW_DEF__RELATED_TO_STATE,
   ...
   public void setBlockingType(ReviewBlockingType newBlockingType) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.PEER_REVIEW_DEF__BLOCKING_TYPE,
   ...
   public void setStateEvent(WorkflowEventType newStateEvent) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.PEER_REVIEW_DEF__STATE_EVENT,
   ...
   public EList<UserRef> getAssigneeRefs() {
      if (assigneeRefs == null) {
         assigneeRefs =
            new EObjectContainmentEList<>(UserRef.class, this, AtsDslPackage.PEER_REVIEW_DEF__ASSIGNEE_REFS);
      }
      return assigneeRefs;
   }
