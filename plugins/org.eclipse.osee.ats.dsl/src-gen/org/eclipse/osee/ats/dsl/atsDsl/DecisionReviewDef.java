...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Decision Review Def</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 ...
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.DecisionReviewDef#getAutoTransitionToDecision
 * <em>Auto Transition To Decision</em>}</li>
...
public interface DecisionReviewDef extends EObject {
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.DecisionReviewDef#getTitle <em>Title</em>}'
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.DecisionReviewDef#getDescription
   ...
   /**
    * Returns the value of the '<em><b>Related To State</b></em>' reference. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Related To State</em>' reference isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.DecisionReviewDef#getRelatedToState
    * <em>Related To State</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Blocking Type</b></em>' attribute. The literals are from the enumeration
    * {@link org.eclipse.osee.ats.dsl.atsDsl.ReviewBlockingType}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Blocking Type</em>' attribute isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.DecisionReviewDef#getBlockingType
    * <em>Blocking Type</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>State Event</b></em>' attribute. The literals are from the enumeration
    * {@link org.eclipse.osee.ats.dsl.atsDsl.WorkflowEventType}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>State Event</em>' attribute isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.DecisionReviewDef#getStateEvent <em>State Event</em>
    * }' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Auto Transition To Decision</b></em>' attribute. The literals are from the
    * enumeration {@link org.eclipse.osee.ats.dsl.atsDsl.BooleanDef}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Auto Transition To Decision</em>' attribute isn't clear, there really should be more of
    * a description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.DecisionReviewDef#getAutoTransitionToDecision
    * <em>Auto Transition To Decision</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
    ...
    * {@link org.eclipse.osee.ats.dsl.atsDsl.DecisionReviewOpt}. <!-- begin-user-doc -->
    * <p>
