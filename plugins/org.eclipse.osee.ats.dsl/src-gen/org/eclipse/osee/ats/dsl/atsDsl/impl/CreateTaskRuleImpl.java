...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Create Task Rule</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class CreateTaskRuleImpl extends RuleImpl implements CreateTaskRule {
   ...
   /**
    * The default value of the '{@link #getRelatedState() <em>Related State</em>}' attribute. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getRelatedState()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getRelatedState() <em>Related State</em>}' attribute. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getRelatedState()
    * @generated
   ...
   /**
    * The default value of the '{@link #getTaskWorkDef() <em>Task Work Def</em>}' attribute. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getTaskWorkDef()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getTaskWorkDef() <em>Task Work Def</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getTaskWorkDef()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getOnEvent() <em>On Event</em>}' attribute list. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getOnEvent()
    * @generated
   ...
   public void setRelatedState(String newRelatedState) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.CREATE_TASK_RULE__RELATED_STATE,
            oldRelatedState, relatedState));
      }
   }
   ...
   public void setTaskWorkDef(String newTaskWorkDef) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.CREATE_TASK_RULE__TASK_WORK_DEF,
            oldTaskWorkDef, taskWorkDef));
      }
   }
