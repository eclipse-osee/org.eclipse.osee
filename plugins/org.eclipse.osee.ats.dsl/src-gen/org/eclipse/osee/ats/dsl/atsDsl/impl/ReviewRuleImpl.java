...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Review Rule</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class ReviewRuleImpl extends RuleImpl implements ReviewRule {
   ...
   /**
    * The default value of the '{@link #getRelatedToState() <em>Related To State</em>}' attribute. <!-- begin-user-doc
    * --> <!-- end-user-doc -->
    * 
   ...
   /**
    * The cached value of the '{@link #getRelatedToState() <em>Related To State</em>}' attribute. <!-- begin-user-doc
    * --> <!-- end-user-doc -->
    * 
    * @see #getRelatedToState()
    * @generated
   ...
   public void setRelatedToState(String newRelatedToState) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.REVIEW_RULE__RELATED_TO_STATE,
   ...
   public void setBlockingType(ReviewBlockingType newBlockingType) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.REVIEW_RULE__BLOCKING_TYPE,
   ...
   public void setStateEvent(WorkflowEventType newStateEvent) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.REVIEW_RULE__STATE_EVENT, oldStateEvent,
            stateEvent));
      }
   }
   ...
   public boolean eIsSet(int featureID) {
      switch (featureID) {
         ...
         case AtsDslPackage.REVIEW_RULE__RELATED_TO_STATE:
            return RELATED_TO_STATE_EDEFAULT == null ? relatedToState != null : !RELATED_TO_STATE_EDEFAULT.equals(
               relatedToState);
         case AtsDslPackage.REVIEW_RULE__BLOCKING_TYPE:
