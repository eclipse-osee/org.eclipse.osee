...
public class CompositeImpl extends LayoutItemImpl implements Composite {
   /**
    * The default value of the '{@link #getNumColumns() <em>Num Columns</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getNumColumns()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getNumColumns() <em>Num Columns</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getNumColumns()
    * @generated
   ...
   public void setNumColumns(int newNumColumns) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.COMPOSITE__NUM_COLUMNS, oldNumColumns,
            numColumns));
      }
   }
