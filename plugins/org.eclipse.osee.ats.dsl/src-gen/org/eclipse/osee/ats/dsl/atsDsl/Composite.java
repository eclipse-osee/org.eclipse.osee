...
public interface Composite extends LayoutItem {
   /**
    * Returns the value of the '<em><b>Num Columns</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Num Columns</em>' attribute isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.Composite#getNumColumns <em>Num Columns</em>}'
   ...
   /**
    * Returns the value of the '<em><b>Layout Items</b></em>' containment reference list. The list contents are of type
    * {@link org.eclipse.osee.ats.dsl.atsDsl.LayoutItem}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Layout Items</em>' containment reference list isn't clear, there really should be more
