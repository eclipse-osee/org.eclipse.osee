...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Create Task Rule</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public interface CreateTaskRule extends Rule {
   ...
   /**
    * Returns the value of the '<em><b>Related State</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Related State</em>' attribute isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.CreateTaskRule#getRelatedState
    * <em>Related State</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Task Work Def</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Task Work Def</em>' attribute isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.CreateTaskRule#getTaskWorkDef <em>Task Work Def</em>
   ...
   /**
    * Returns the value of the '<em><b>On Event</b></em>' attribute list. The list contents are of type
    * {@link org.eclipse.osee.ats.dsl.atsDsl.OnEventType}. The literals are from the enumeration
    * {@link org.eclipse.osee.ats.dsl.atsDsl.OnEventType}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>On Event</em>' attribute list isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
