...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Create Decision Review Rule</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.impl.CreateDecisionReviewRuleImpl#getAutoTransitionToDecision
...
public class CreateDecisionReviewRuleImpl extends ReviewRuleImpl implements CreateDecisionReviewRule {
   ...
   public void setAutoTransitionToDecision(BooleanDef newAutoTransitionToDecision) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET,
            AtsDslPackage.CREATE_DECISION_REVIEW_RULE__AUTO_TRANSITION_TO_DECISION, oldAutoTransitionToDecision,
            autoTransitionToDecision));
      }
   }
   ...
   public EList<DecisionReviewOpt> getOptions() {
      if (options == null) {
         options = new EObjectContainmentEList<>(DecisionReviewOpt.class, this,
            AtsDslPackage.CREATE_DECISION_REVIEW_RULE__OPTIONS);
      }
      return options;
   }
