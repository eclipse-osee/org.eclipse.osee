...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Decision Review Ref</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public interface DecisionReviewRef extends EObject {
   /**
    * Returns the value of the '<em><b>Decision Review</b></em>' reference. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Decision Review</em>' reference isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.DecisionReviewRef#getDecisionReview
    * <em>Decision Review</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
