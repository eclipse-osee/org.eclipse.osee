...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Decision Review Opt</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class DecisionReviewOptImpl extends MinimalEObjectImpl.Container implements DecisionReviewOpt {
   ...
   /**
    * The cached value of the '{@link #getFollowup() <em>Followup</em>}' containment reference. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getFollowup()
    * @generated
   ...
   public NotificationChain basicSetFollowup(FollowupRef newFollowup, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            AtsDslPackage.DECISION_REVIEW_OPT__FOLLOWUP, oldFollowup, newFollowup);
         if (msgs == null) {
            msgs = notification;
         } else {
   ...
   public void setFollowup(FollowupRef newFollowup) {
      if (newFollowup != followup) {
         ...
         if (followup != null) {
            msgs = ((InternalEObject) followup).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - AtsDslPackage.DECISION_REVIEW_OPT__FOLLOWUP, null, msgs);
         }
         if (newFollowup != null) {
            msgs = ((InternalEObject) newFollowup).eInverseAdd(this,
               EOPPOSITE_FEATURE_BASE - AtsDslPackage.DECISION_REVIEW_OPT__FOLLOWUP, null, msgs);
         }
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.DECISION_REVIEW_OPT__FOLLOWUP, newFollowup,
            newFollowup));
      }
   }
