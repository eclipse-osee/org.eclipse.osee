...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Work Def</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class WorkDefImpl extends MinimalEObjectImpl.Container implements WorkDef {
   ...
   /**
    * The cached value of the '{@link #getId() <em>Id</em>}' attribute list. <!-- begin-user-doc --> <!-- end-user-doc
    * -->
    * 
    * @see #getId()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getStartState() <em>Start State</em>}' reference. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getStartState()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getDecisionReviewDefs() <em>Decision Review Defs</em>}' containment reference
   ...
   public StateDef getStartState() {
      if (startState != null && startState.eIsProxy()) {
         ...
         if (startState != oldStartState) {
            if (eNotificationRequired()) {
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, AtsDslPackage.WORK_DEF__START_STATE,
   ...
   public void setStartState(StateDef newStartState) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.WORK_DEF__START_STATE, oldStartState,
            startState));
      }
   }
   ...
   public EList<DecisionReviewDef> getDecisionReviewDefs() {
      if (decisionReviewDefs == null) {
         decisionReviewDefs =
            new EObjectContainmentEList<>(DecisionReviewDef.class, this, AtsDslPackage.WORK_DEF__DECISION_REVIEW_DEFS);
      }
   ...
   public EList<PeerReviewDef> getPeerReviewDefs() {
      if (peerReviewDefs == null) {
         peerReviewDefs =
            new EObjectContainmentEList<>(PeerReviewDef.class, this, AtsDslPackage.WORK_DEF__PEER_REVIEW_DEFS);
      }
