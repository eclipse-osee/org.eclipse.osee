...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>State Def</b></em>'. <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.StateDef#getRecommendedPercentComplete
 * <em>Recommended Percent Complete</em>}</li>
...
public interface StateDef extends EObject {
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.StateDef#getDescription <em>Description</em>}'
   ...
   /**
    * Returns the value of the '<em><b>Page Type</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Page Type</em>' attribute isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Transition States</b></em>' containment reference list. The list contents are of
    * type {@link org.eclipse.osee.ats.dsl.atsDsl.ToState}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Transition States</em>' containment reference list isn't clear, there really should be
   ...
   /**
    * Returns the value of the '<em><b>Decision Reviews</b></em>' containment reference list. The list contents are of
    * type {@link org.eclipse.osee.ats.dsl.atsDsl.DecisionReviewRef}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Decision Reviews</em>' containment reference list isn't clear, there really should be
    * more of a description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Peer Reviews</b></em>' containment reference list. The list contents are of type
    * {@link org.eclipse.osee.ats.dsl.atsDsl.PeerReviewRef}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Peer Reviews</em>' containment reference list isn't clear, there really should be more
   ...
   /**
    * Returns the value of the '<em><b>Percent Weight</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Percent Weight</em>' attribute isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.StateDef#getPercentWeight <em>Percent Weight</em>}'
    * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Recommended Percent Complete</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Recommended Percent Complete</em>' attribute isn't clear, there really should be more
    * of a description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.StateDef#getRecommendedPercentComplete
    * <em>Recommended Percent Complete</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.StateDef#getLayout <em>Layout</em>}' containment
