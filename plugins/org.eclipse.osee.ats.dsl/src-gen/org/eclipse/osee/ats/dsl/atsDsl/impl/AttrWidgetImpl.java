...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Attr Widget</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class AttrWidgetImpl extends LayoutItemImpl implements AttrWidget {
   ...
   public void setAttributeName(String newAttributeName) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.ATTR_WIDGET__ATTRIBUTE_NAME,
