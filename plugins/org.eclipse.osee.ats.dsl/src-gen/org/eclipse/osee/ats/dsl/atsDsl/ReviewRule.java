...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Review Rule</b></em>'. <!-- end-user-doc -->
 * <p>
...
public interface ReviewRule extends Rule {
   /**
    * Returns the value of the '<em><b>Assignees</b></em>' containment reference list. The list contents are of type
    * {@link org.eclipse.osee.ats.dsl.atsDsl.UserDef}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Assignees</em>' containment reference list isn't clear, there really should be more of
    * a description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Related To State</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Related To State</em>' attribute isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.ReviewRule#getRelatedToState
    * <em>Related To State</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.ReviewRule#getBlockingType <em>Blocking Type</em>}'
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.ReviewRule#getStateEvent <em>State Event</em>}'
    * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
