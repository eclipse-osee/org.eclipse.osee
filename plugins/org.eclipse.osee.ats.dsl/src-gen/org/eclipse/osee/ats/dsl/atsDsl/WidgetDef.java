...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Widget Def</b></em>'. <!-- end-user-doc -->
 * <p>
...
public interface WidgetDef extends EObject {
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.WidgetDef#getAttributeName <em>Attribute Name</em>}'
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.WidgetDef#getDescription <em>Description</em>}'
    * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>XWidget Name</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>XWidget Name</em>' attribute isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.WidgetDef#getXWidgetName <em>XWidget Name</em>}'
    * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.WidgetDef#getDefaultValue <em>Default Value</em>}'
    * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Option</b></em>' attribute list. The list contents are of type
    * {@link java.lang.String}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Option</em>' attribute list isn't clear, there really should be more of a description
    * here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Min Constraint</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Min Constraint</em>' attribute isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.WidgetDef#getMinConstraint <em>Min Constraint</em>}'
    * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Max Constraint</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Max Constraint</em>' attribute isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.WidgetDef#getMaxConstraint <em>Max Constraint</em>}'
    * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
