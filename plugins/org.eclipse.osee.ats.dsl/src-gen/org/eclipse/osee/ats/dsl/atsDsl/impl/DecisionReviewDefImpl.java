...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Decision Review Def</b></em>'. <!--
 * end-user-doc -->
 * <p>
 ...
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.impl.DecisionReviewDefImpl#getRelatedToState <em>Related To State</em>}
 * </li>
 ...
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.impl.DecisionReviewDefImpl#getAutoTransitionToDecision
...
public class DecisionReviewDefImpl extends MinimalEObjectImpl.Container implements DecisionReviewDef {
   ...
   /**
    * The cached value of the '{@link #getRelatedToState() <em>Related To State</em>}' reference. <!-- begin-user-doc
    * --> <!-- end-user-doc -->
    * 
   ...
   /**
    * The default value of the '{@link #getBlockingType() <em>Blocking Type</em>}' attribute. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getBlockingType()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getBlockingType() <em>Blocking Type</em>}' attribute. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    * @see #getBlockingType()
    * @generated
   ...
   /**
    * The default value of the '{@link #getStateEvent() <em>State Event</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getStateEvent()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getStateEvent() <em>State Event</em>}' attribute. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getStateEvent()
    * @generated
   ...
   public void setTitle(String newTitle) {
      ...
      if (eNotificationRequired()) {
         eNotify(
            new ENotificationImpl(this, Notification.SET, AtsDslPackage.DECISION_REVIEW_DEF__TITLE, oldTitle, title));
      }
   }
   ...
   public void setDescription(String newDescription) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.DECISION_REVIEW_DEF__DESCRIPTION,
         ...
         if (relatedToState != oldRelatedToState) {
            if (eNotificationRequired()) {
               eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                  AtsDslPackage.DECISION_REVIEW_DEF__RELATED_TO_STATE, oldRelatedToState, relatedToState));
            }
         }
      }
   ...
   public void setRelatedToState(StateDef newRelatedToState) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.DECISION_REVIEW_DEF__RELATED_TO_STATE,
            oldRelatedToState, relatedToState));
      }
   }
   ...
   public void setBlockingType(ReviewBlockingType newBlockingType) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.DECISION_REVIEW_DEF__BLOCKING_TYPE,
            oldBlockingType, blockingType));
      }
   }
   ...
   public void setStateEvent(WorkflowEventType newStateEvent) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.DECISION_REVIEW_DEF__STATE_EVENT,
   ...
   public EList<UserRef> getAssigneeRefs() {
      if (assigneeRefs == null) {
         assigneeRefs =
            new EObjectContainmentEList<>(UserRef.class, this, AtsDslPackage.DECISION_REVIEW_DEF__ASSIGNEE_REFS);
      }
      return assigneeRefs;
   }
   ...
   public void setAutoTransitionToDecision(BooleanDef newAutoTransitionToDecision) {
      ...
      autoTransitionToDecision =
         newAutoTransitionToDecision == null ? AUTO_TRANSITION_TO_DECISION_EDEFAULT : newAutoTransitionToDecision;
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET,
            AtsDslPackage.DECISION_REVIEW_DEF__AUTO_TRANSITION_TO_DECISION, oldAutoTransitionToDecision,
            autoTransitionToDecision));
      }
   }
   ...
   public EList<DecisionReviewOpt> getOptions() {
      if (options == null) {
         options =
            new EObjectContainmentEList<>(DecisionReviewOpt.class, this, AtsDslPackage.DECISION_REVIEW_DEF__OPTIONS);
      }
      return options;
   }
