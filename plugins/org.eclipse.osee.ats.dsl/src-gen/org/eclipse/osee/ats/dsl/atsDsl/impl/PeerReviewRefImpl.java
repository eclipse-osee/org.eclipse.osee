...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Peer Review Ref</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class PeerReviewRefImpl extends MinimalEObjectImpl.Container implements PeerReviewRef {
   /**
    * The cached value of the '{@link #getPeerReview() <em>Peer Review</em>}' reference. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getPeerReview()
    * @generated
      ...
      if (peerReview != null && peerReview.eIsProxy()) {
         ...
         if (peerReview != oldPeerReview) {
            if (eNotificationRequired()) {
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, AtsDslPackage.PEER_REVIEW_REF__PEER_REVIEW,
                  oldPeerReview, peerReview));
            }
         }
      }
      return peerReview;
   ...
   public void setPeerReview(PeerReviewDef newPeerReview) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.PEER_REVIEW_REF__PEER_REVIEW,
            oldPeerReview, peerReview));
      }
   }
