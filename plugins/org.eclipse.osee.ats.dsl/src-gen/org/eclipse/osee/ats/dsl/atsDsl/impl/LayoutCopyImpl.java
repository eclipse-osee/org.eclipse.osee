...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Layout Copy</b></em>'. <!-- end-user-doc -->
 * <p>
      ...
      if (state != null && state.eIsProxy()) {
         ...
         if (state != oldState) {
            if (eNotificationRequired()) {
               eNotify(
                  new ENotificationImpl(this, Notification.RESOLVE, AtsDslPackage.LAYOUT_COPY__STATE, oldState, state));
            }
         }
      }
      return state;
