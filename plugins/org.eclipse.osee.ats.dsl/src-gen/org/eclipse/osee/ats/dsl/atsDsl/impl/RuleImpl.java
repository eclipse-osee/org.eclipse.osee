...
public class RuleImpl extends MinimalEObjectImpl.Container implements Rule {
   ...
   /**
    * The cached value of the '{@link #getRuleLocation() <em>Rule Location</em>}' attribute list. <!-- begin-user-doc
    * --> <!-- end-user-doc -->
    * 
    * @see #getRuleLocation()
    * @generated
   ...
   public void setDescription(String newDescription) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.RULE__DESCRIPTION, oldDescription,
            description));
      }
   }
