...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Decision Review Ref</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.osee.ats.dsl.atsDsl.impl.DecisionReviewRefImpl#getDecisionReview <em>Decision Review</em>}
 * </li>
 * </ul>
 *
 * @generated
...
public class DecisionReviewRefImpl extends MinimalEObjectImpl.Container implements DecisionReviewRef {
   /**
    * The cached value of the '{@link #getDecisionReview() <em>Decision Review</em>}' reference. <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
         ...
         if (decisionReview != oldDecisionReview) {
            if (eNotificationRequired()) {
               eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                  AtsDslPackage.DECISION_REVIEW_REF__DECISION_REVIEW, oldDecisionReview, decisionReview));
            }
         }
      }
   ...
   public void setDecisionReview(DecisionReviewDef newDecisionReview) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET, AtsDslPackage.DECISION_REVIEW_REF__DECISION_REVIEW,
            oldDecisionReview, decisionReview));
      }
   }
