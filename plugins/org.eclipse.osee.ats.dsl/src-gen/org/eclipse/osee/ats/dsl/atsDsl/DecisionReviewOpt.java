...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Decision Review Opt</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public interface DecisionReviewOpt extends EObject {
   ...
   /**
    * Returns the value of the '<em><b>Followup</b></em>' containment reference. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Followup</em>' containment reference isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.ats.dsl.atsDsl.DecisionReviewOpt#getFollowup <em>Followup</em>}'
