...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Widget Ref</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class WidgetRefImpl extends LayoutItemImpl implements WidgetRef {
   /**
    * The cached value of the '{@link #getWidget() <em>Widget</em>}' reference. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getWidget()
    * @generated
      ...
      if (widget != null && widget.eIsProxy()) {
         ...
         if (widget != oldWidget) {
            if (eNotificationRequired()) {
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, AtsDslPackage.WIDGET_REF__WIDGET, oldWidget,
                  widget));
            }
         }
      }
