 ...
 */
public class MockDecisionReviewOption implements IAtsDecisionReviewOption {
   ...
   public MockDecisionReviewOption(String name, boolean isFollowupRequired, List<String> userIds) {
      this.name = name;
