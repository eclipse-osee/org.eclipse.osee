 ...
 *******************************************************************************/
package org.eclipse.osee.framework.search.engine.language;
   ...
   private synchronized void ensureIntialized() {
      if (!isInitialized) {
         ...
         try {
            ...
            OseeLog.log(Activator.class, Level.SEVERE, "Unable to process plural to singular exceptions file.", ex);
         } finally {
