...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Collect Object Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsCollectObjectExpressionImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsCollectObjectExpressionImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OsCollectObjectExpressionImpl extends OsCollectExpressionImpl implements OsCollectObjectExpression
{
  ...
  public NotificationChain basicSetAlias(OsExpression newAlias, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_COLLECT_OBJECT_EXPRESSION__ALIAS, oldAlias, newAlias);
  ...
  public void setAlias(OsExpression newAlias)
  {
    if (newAlias != alias)
    {
      ...
      if (alias != null)
        msgs = ((InternalEObject)alias).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_COLLECT_OBJECT_EXPRESSION__ALIAS, null, msgs);
      if (newAlias != null)
        msgs = ((InternalEObject)newAlias).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_COLLECT_OBJECT_EXPRESSION__ALIAS, null, msgs);
      msgs = basicSetAlias(newAlias, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_COLLECT_OBJECT_EXPRESSION__ALIAS, newAlias, newAlias));
  }
