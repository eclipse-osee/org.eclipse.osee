...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Ose Attribute Op Clause</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OseAttributeOpClauseImpl#getOptions <em>Options</em>}
 * </li>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OseAttributeOpClauseImpl#getValues <em>Values</em>}
 * </li>
 * </ul>
 * </p>
 *
...
public class OseAttributeOpClauseImpl extends OsAttributeClauseImpl implements OseAttributeOpClause {
   ...
   public EList<OsQueryOption> getOptions() {
      if (options == null) {
         options =
            new EDataTypeEList<>(OsQueryOption.class, this, OrcsScriptDslPackage.OSE_ATTRIBUTE_OP_CLAUSE__OPTIONS);
      }
      return options;
   }
   ...
   public EList<OsExpression> getValues() {
      if (values == null) {
         values = new EObjectContainmentEList<>(OsExpression.class, this,
            OrcsScriptDslPackage.OSE_ATTRIBUTE_OP_CLAUSE__VALUES);
      }
      return values;
   }
