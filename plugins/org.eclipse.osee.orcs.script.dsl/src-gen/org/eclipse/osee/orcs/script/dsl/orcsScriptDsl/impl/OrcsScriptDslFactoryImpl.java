...
public class OrcsScriptDslFactoryImpl extends EFactoryImpl implements OrcsScriptDslFactory {
   ...
   public static OrcsScriptDslFactory init() {
      try {
         OrcsScriptDslFactory theOrcsScriptDslFactory =
            (OrcsScriptDslFactory) EPackage.Registry.INSTANCE.getEFactory(OrcsScriptDslPackage.eNS_URI);
