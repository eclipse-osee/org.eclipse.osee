...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Tx Comment Criteria</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsTxCommentCriteriaImpl#getClause <em>Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OsTxCommentCriteriaImpl extends OsTxCriteriaImpl implements OsTxCommentCriteria
{
  ...
  public NotificationChain basicSetClause(OsTxCommentClause newClause, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_COMMENT_CRITERIA__CLAUSE, oldClause, newClause);
  ...
  public void setClause(OsTxCommentClause newClause)
  {
    if (newClause != clause)
    {
      ...
      if (clause != null)
        msgs = ((InternalEObject)clause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_COMMENT_CRITERIA__CLAUSE, null, msgs);
      if (newClause != null)
        msgs = ((InternalEObject)newClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_COMMENT_CRITERIA__CLAUSE, null, msgs);
      msgs = basicSetClause(newClause, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_COMMENT_CRITERIA__CLAUSE, newClause, newClause));
  }
