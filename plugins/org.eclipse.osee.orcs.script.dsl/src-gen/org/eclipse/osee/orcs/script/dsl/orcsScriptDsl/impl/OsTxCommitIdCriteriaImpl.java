...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Tx Commit Id Criteria</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsTxCommitIdCriteriaImpl#getClause <em>Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OsTxCommitIdCriteriaImpl extends OsTxCriteriaImpl implements OsTxCommitIdCriteria
{
  ...
  public NotificationChain basicSetClause(OsTxCommitIdClause newClause, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_COMMIT_ID_CRITERIA__CLAUSE, oldClause, newClause);
  ...
  public void setClause(OsTxCommitIdClause newClause)
  {
    if (newClause != clause)
    {
      ...
      if (clause != null)
        msgs = ((InternalEObject)clause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_COMMIT_ID_CRITERIA__CLAUSE, null, msgs);
      if (newClause != null)
        msgs = ((InternalEObject)newClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_COMMIT_ID_CRITERIA__CLAUSE, null, msgs);
      msgs = basicSetClause(newClause, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_COMMIT_ID_CRITERIA__CLAUSE, newClause, newClause));
  }
