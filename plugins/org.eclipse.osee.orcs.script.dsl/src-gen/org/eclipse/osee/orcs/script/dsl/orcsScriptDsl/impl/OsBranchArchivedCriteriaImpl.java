...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Branch Archived Criteria</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsBranchArchivedCriteriaImpl#getFilter <em>Filter</em>
 * }</li>
 * </ul>
 * </p>
 *
   ...
   public void setFilter(OsBranchArchiveFilter newFilter) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_BRANCH_ARCHIVED_CRITERIA__FILTER, oldFilter, filter));
      }
   }
