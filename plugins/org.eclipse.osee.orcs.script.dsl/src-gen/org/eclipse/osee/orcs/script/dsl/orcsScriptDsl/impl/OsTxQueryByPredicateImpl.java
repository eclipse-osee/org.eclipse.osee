...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Tx Query By Predicate</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsTxQueryByPredicateImpl#getName <em>Name</em>}</li>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsTxQueryByPredicateImpl#getCriteria <em>Criteria</em>
 * }</li>
 * </ul>
 * </p>
 *
...
public class OsTxQueryByPredicateImpl extends OsTxQueryImpl implements OsTxQueryByPredicate {
   ...
   public void setName(String newName) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_TX_QUERY_BY_PREDICATE__NAME, oldName, name));
      }
   }
   ...
   public EList<OsTxCriteria> getCriteria() {
      if (criteria == null) {
         criteria = new EObjectContainmentEList<>(OsTxCriteria.class, this,
            OrcsScriptDslPackage.OS_TX_QUERY_BY_PREDICATE__CRITERIA);
      }
      return criteria;
   }
