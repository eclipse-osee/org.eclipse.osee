...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Query</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsQueryImpl extends MinimalEObjectImpl.Container implements OsQuery
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_QUERY__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetCollect(OsCollectClause newCollect, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_QUERY__COLLECT, oldCollect, newCollect);
  ...
  public void setCollect(OsCollectClause newCollect)
  {
    if (newCollect != collect)
    {
      ...
      if (collect != null)
        msgs = ((InternalEObject)collect).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_QUERY__COLLECT, null, msgs);
      if (newCollect != null)
        msgs = ((InternalEObject)newCollect).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_QUERY__COLLECT, null, msgs);
      msgs = basicSetCollect(newCollect, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_QUERY__COLLECT, newCollect, newCollect));
  }
