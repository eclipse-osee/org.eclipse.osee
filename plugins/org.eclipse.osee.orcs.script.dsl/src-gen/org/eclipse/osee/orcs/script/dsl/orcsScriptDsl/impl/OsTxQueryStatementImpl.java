...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Tx Query Statement</b></em>'. <!--
 * end-user-doc -->
 * <p>
   ...
   public NotificationChain basicSetData(OsTxQuery newData, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_TX_QUERY_STATEMENT__DATA, oldData, newData);
         if (msgs == null) {
            msgs = notification;
         } else {
      ...
      if (newData != data) {
         ...
         if (data != null) {
            msgs = ((InternalEObject) data).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_QUERY_STATEMENT__DATA, null, msgs);
         }
         if (newData != null) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_TX_QUERY_STATEMENT__DATA, newData, newData));
      }
   }
