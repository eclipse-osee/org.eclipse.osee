...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Artifact Query By Predicate</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsArtifactQueryByPredicateImpl#getCriteria
 * <em>Criteria</em>}</li>
 * </ul>
 * </p>
 *
   ...
   public EList<OsItemCriteria> getCriteria() {
      if (criteria == null) {
         criteria = new EObjectContainmentEList<>(OsItemCriteria.class, this,
            OrcsScriptDslPackage.OS_ARTIFACT_QUERY_BY_PREDICATE__CRITERIA);
      }
      return criteria;
   }
