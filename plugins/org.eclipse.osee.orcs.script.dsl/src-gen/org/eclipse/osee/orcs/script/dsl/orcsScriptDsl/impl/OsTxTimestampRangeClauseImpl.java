...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Tx Timestamp Range Clause</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsTxTimestampRangeClauseImpl#getName <em>Name</em>}
 * </li>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsTxTimestampRangeClauseImpl#getFrom <em>From</em>}
 * </li>
...
public class OsTxTimestampRangeClauseImpl extends OsTxTimestampClauseImpl implements OsTxTimestampRangeClause {
   ...
   /**
    * The cached value of the '{@link #getFrom() <em>From</em>}' containment reference. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getFrom()
    * @generated
   ...
   /**
    * The cached value of the '{@link #getTo() <em>To</em>}' containment reference. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getTo()
    * @generated
   ...
   public void setName(String newName) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_TX_TIMESTAMP_RANGE_CLAUSE__NAME, oldName, name));
      }
   }
   ...
   public NotificationChain basicSetFrom(OsExpression newFrom, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_TX_TIMESTAMP_RANGE_CLAUSE__FROM, oldFrom, newFrom);
         if (msgs == null) {
            msgs = notification;
         } else {
      ...
      if (newFrom != from) {
         ...
         if (from != null) {
            msgs = ((InternalEObject) from).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_TIMESTAMP_RANGE_CLAUSE__FROM, null, msgs);
         }
         if (newFrom != null) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_TX_TIMESTAMP_RANGE_CLAUSE__FROM, newFrom, newFrom));
      }
   }
   ...
   public NotificationChain basicSetTo(OsExpression newTo, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_TX_TIMESTAMP_RANGE_CLAUSE__TO, oldTo, newTo);
         if (msgs == null) {
            msgs = notification;
         } else {
            msgs.add(notification);
      ...
      if (newTo != to) {
         ...
         if (to != null) {
            msgs = ((InternalEObject) to).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_TIMESTAMP_RANGE_CLAUSE__TO, null, msgs);
         }
         if (newTo != null) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_TX_TIMESTAMP_RANGE_CLAUSE__TO, newTo, newTo));
      }
   }
