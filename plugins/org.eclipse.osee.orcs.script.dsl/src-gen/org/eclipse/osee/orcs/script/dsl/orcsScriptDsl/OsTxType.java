...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Os Tx Type</b></em>',
...
public enum OsTxType implements Enumerator
{
  ...
  /**
   * The '<em><b>NON BASELINE</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The '<em><b>NON BASELINE</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>NON BASELINE</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #NON_BASELINE
  ...
  /**
   * An array of all the '<em><b>Os Tx Type</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final OsTxType[] VALUES_ARRAY =
    new OsTxType[]
    {
      BASELINE,
      NON_BASELINE,
  ...
  /**
   * A public read-only list of all the '<em><b>Os Tx Type</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Os Tx Type</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Os Tx Type</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Os Tx Type</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static OsTxType get(int value)
  {
    switch (value)
    {
      ...
      case NON_BASELINE_VALUE: return NON_BASELINE;
    }
    return null;
  }
