...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Branch Id Criteria</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsBranchIdCriteriaImpl#getIds <em>Ids</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OsBranchIdCriteriaImpl extends OsBranchCriteriaImpl implements OsBranchIdCriteria {
   /**
    ...
    * @generated
    */
   protected OsBranchIdCriteriaImpl() {
      super();
   }
   ...
   protected EClass eStaticClass() {
      return OrcsScriptDslPackage.Literals.OS_BRANCH_ID_CRITERIA;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case OrcsScriptDslPackage.OS_BRANCH_ID_CRITERIA__IDS:
