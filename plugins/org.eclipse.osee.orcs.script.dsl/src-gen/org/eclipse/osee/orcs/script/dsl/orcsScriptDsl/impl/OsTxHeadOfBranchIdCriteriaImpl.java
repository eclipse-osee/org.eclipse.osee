...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Tx Head Of Branch Id Criteria</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsTxHeadOfBranchIdCriteriaImpl extends OsTxCriteriaImpl implements OsTxHeadOfBranchIdCriteria
{
  ...
  public NotificationChain basicSetId(OsExpression newId, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_HEAD_OF_BRANCH_ID_CRITERIA__ID, oldId, newId);
  ...
  public void setId(OsExpression newId)
  {
    if (newId != id)
    {
      ...
      if (id != null)
        msgs = ((InternalEObject)id).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_HEAD_OF_BRANCH_ID_CRITERIA__ID, null, msgs);
      if (newId != null)
        msgs = ((InternalEObject)newId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_HEAD_OF_BRANCH_ID_CRITERIA__ID, null, msgs);
      msgs = basicSetId(newId, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_HEAD_OF_BRANCH_ID_CRITERIA__ID, newId, newId));
  }
