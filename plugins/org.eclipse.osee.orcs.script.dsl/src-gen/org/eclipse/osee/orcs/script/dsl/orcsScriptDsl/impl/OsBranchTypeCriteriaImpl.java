...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Branch Type Criteria</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class OsBranchTypeCriteriaImpl extends OsBranchCriteriaImpl implements OsBranchTypeCriteria {
   /**
    * The cached value of the '{@link #getTypes() <em>Types</em>}' attribute list. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    * @see #getTypes()
    * @generated
