...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Tx Timestamp Op Clause</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsTxTimestampOpClauseImpl#getOp <em>Op</em>}</li>
 *   <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsTxTimestampOpClauseImpl#getTimestamp <em>Timestamp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OsTxTimestampOpClauseImpl extends OsTxTimestampClauseImpl implements OsTxTimestampOpClause
{
  ...
  public void setOp(OsOperator newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_TIMESTAMP_OP_CLAUSE__OP, oldOp, op));
  }
  ...
  public NotificationChain basicSetTimestamp(OsExpression newTimestamp, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_TIMESTAMP_OP_CLAUSE__TIMESTAMP, oldTimestamp, newTimestamp);
  ...
  public void setTimestamp(OsExpression newTimestamp)
  {
    if (newTimestamp != timestamp)
    {
      ...
      if (timestamp != null)
        msgs = ((InternalEObject)timestamp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_TIMESTAMP_OP_CLAUSE__TIMESTAMP, null, msgs);
      if (newTimestamp != null)
        msgs = ((InternalEObject)newTimestamp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_TIMESTAMP_OP_CLAUSE__TIMESTAMP, null, msgs);
      msgs = basicSetTimestamp(newTimestamp, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_TIMESTAMP_OP_CLAUSE__TIMESTAMP, newTimestamp, newTimestamp));
  }
