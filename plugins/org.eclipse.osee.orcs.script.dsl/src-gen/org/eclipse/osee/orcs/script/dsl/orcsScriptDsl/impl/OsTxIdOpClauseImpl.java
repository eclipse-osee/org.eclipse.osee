...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Tx Id Op Clause</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsTxIdOpClauseImpl extends OsTxIdClauseImpl implements OsTxIdOpClause
{
  ...
  public void setOp(OsNonEqualOperator newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_ID_OP_CLAUSE__OP, oldOp, op));
  }
  ...
  public NotificationChain basicSetId(OsExpression newId, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_ID_OP_CLAUSE__ID, oldId, newId);
  ...
  public void setId(OsExpression newId)
  {
    if (newId != id)
    {
      ...
      if (id != null)
        msgs = ((InternalEObject)id).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_ID_OP_CLAUSE__ID, null, msgs);
      if (newId != null)
        msgs = ((InternalEObject)newId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_ID_OP_CLAUSE__ID, null, msgs);
      msgs = basicSetId(newId, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_ID_OP_CLAUSE__ID, newId, newId));
  }
