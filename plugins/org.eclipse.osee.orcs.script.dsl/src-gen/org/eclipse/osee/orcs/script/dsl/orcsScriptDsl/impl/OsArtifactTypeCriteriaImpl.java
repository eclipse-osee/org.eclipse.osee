...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Artifact Type Criteria</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsArtifactTypeCriteriaImpl#getClause <em>Clause</em>}
 * </li>
 * </ul>
 * </p>
 *
   ...
   public NotificationChain basicSetClause(OsArtifactTypeClause newClause, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_ARTIFACT_TYPE_CRITERIA__CLAUSE, oldClause, newClause);
         if (msgs == null) {
            msgs = notification;
         } else {
      ...
      if (newClause != clause) {
         ...
         if (clause != null) {
            msgs = ((InternalEObject) clause).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_ARTIFACT_TYPE_CRITERIA__CLAUSE, null, msgs);
         }
         if (newClause != null) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_ARTIFACT_TYPE_CRITERIA__CLAUSE, newClause, newClause));
      }
   }
