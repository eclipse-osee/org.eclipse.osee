...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Branch Clause</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class OsBranchClauseImpl extends MinimalEObjectImpl.Container implements OsBranchClause {
   ...
   public void setName(String newName) {
      ...
      if (eNotificationRequired()) {
         eNotify(
            new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_BRANCH_CLAUSE__NAME, oldName, name));
      }
   }
   ...
   public NotificationChain basicSetId(OsExpression newId, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification =
            new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_BRANCH_CLAUSE__ID, oldId, newId);
         if (msgs == null) {
            msgs = notification;
         } else {
      ...
      if (newId != id) {
         ...
         if (id != null) {
            msgs = ((InternalEObject) id).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_BRANCH_CLAUSE__ID, null, msgs);
         }
         if (newId != null) {
         ...
         eNotify(
            new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_BRANCH_CLAUSE__ID, newId, newId));
      }
   }
