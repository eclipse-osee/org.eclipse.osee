...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Tx Id Range Clause</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsTxIdRangeClauseImpl extends OsTxIdClauseImpl implements OsTxIdRangeClause
{
  ...
  /**
   * The cached value of the '{@link #getFromId() <em>From Id</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getFromId()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getToId() <em>To Id</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getToId()
   * @generated
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_ID_RANGE_CLAUSE__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetFromId(OsExpression newFromId, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_ID_RANGE_CLAUSE__FROM_ID, oldFromId, newFromId);
  ...
  public void setFromId(OsExpression newFromId)
  {
    if (newFromId != fromId)
    {
      ...
      if (fromId != null)
        msgs = ((InternalEObject)fromId).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_ID_RANGE_CLAUSE__FROM_ID, null, msgs);
      if (newFromId != null)
        msgs = ((InternalEObject)newFromId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_ID_RANGE_CLAUSE__FROM_ID, null, msgs);
      msgs = basicSetFromId(newFromId, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_ID_RANGE_CLAUSE__FROM_ID, newFromId, newFromId));
  }
  ...
  public NotificationChain basicSetToId(OsExpression newToId, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_ID_RANGE_CLAUSE__TO_ID, oldToId, newToId);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setToId(OsExpression newToId)
  {
    if (newToId != toId)
    {
      NotificationChain msgs = null;
      if (toId != null)
        msgs = ((InternalEObject)toId).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_ID_RANGE_CLAUSE__TO_ID, null, msgs);
      if (newToId != null)
        msgs = ((InternalEObject)newToId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_ID_RANGE_CLAUSE__TO_ID, null, msgs);
      msgs = basicSetToId(newToId, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_ID_RANGE_CLAUSE__TO_ID, newToId, newToId));
  }
