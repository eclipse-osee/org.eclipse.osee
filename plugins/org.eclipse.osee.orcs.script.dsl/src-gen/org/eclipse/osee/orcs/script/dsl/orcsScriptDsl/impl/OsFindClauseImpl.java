...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Find Clause</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsFindClauseImpl extends OsClauseImpl implements OsFindClause
{
  ...
  public NotificationChain basicSetQuery(OsObjectQuery newQuery, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_FIND_CLAUSE__QUERY, oldQuery, newQuery);
  ...
  public void setQuery(OsObjectQuery newQuery)
  {
    if (newQuery != query)
    {
      ...
      if (query != null)
        msgs = ((InternalEObject)query).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_FIND_CLAUSE__QUERY, null, msgs);
      if (newQuery != null)
        msgs = ((InternalEObject)newQuery).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_FIND_CLAUSE__QUERY, null, msgs);
      msgs = basicSetQuery(newQuery, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_FIND_CLAUSE__QUERY, newQuery, newQuery));
  }
