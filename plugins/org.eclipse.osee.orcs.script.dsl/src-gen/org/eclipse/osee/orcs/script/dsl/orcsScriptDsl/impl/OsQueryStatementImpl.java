...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Query Statement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsQueryStatementImpl extends ScriptStatementImpl implements OsQueryStatement
{
  ...
  public NotificationChain basicSetStmt(OsExpression newStmt, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_QUERY_STATEMENT__STMT, oldStmt, newStmt);
  ...
  public void setStmt(OsExpression newStmt)
  {
    if (newStmt != stmt)
    {
      ...
      if (stmt != null)
        msgs = ((InternalEObject)stmt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_QUERY_STATEMENT__STMT, null, msgs);
      if (newStmt != null)
        msgs = ((InternalEObject)newStmt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_QUERY_STATEMENT__STMT, null, msgs);
      msgs = basicSetStmt(newStmt, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_QUERY_STATEMENT__STMT, newStmt, newStmt));
  }
