...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Variable</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsVariableImpl extends OsExpressionImpl implements OsVariable
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_VARIABLE__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetRight(OsExpression newRight, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_VARIABLE__RIGHT, oldRight, newRight);
  ...
  public void setRight(OsExpression newRight)
  {
    if (newRight != right)
    {
      ...
      if (right != null)
        msgs = ((InternalEObject)right).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_VARIABLE__RIGHT, null, msgs);
      if (newRight != null)
        msgs = ((InternalEObject)newRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_VARIABLE__RIGHT, null, msgs);
      msgs = basicSetRight(newRight, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_VARIABLE__RIGHT, newRight, newRight));
  }
