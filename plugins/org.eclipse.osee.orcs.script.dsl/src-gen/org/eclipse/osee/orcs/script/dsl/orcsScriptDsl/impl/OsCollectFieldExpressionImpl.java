...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Collect Field Expression</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsCollectFieldExpressionImpl#getAlias <em>Alias</em>}
 * </li>
 * </ul>
 * </p>
 *
   ...
   public NotificationChain basicSetAlias(OsExpression newAlias, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_COLLECT_FIELD_EXPRESSION__ALIAS, oldAlias, newAlias);
         if (msgs == null) {
            msgs = notification;
         } else {
      ...
      if (newAlias != alias) {
         ...
         if (alias != null) {
            msgs = ((InternalEObject) alias).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_COLLECT_FIELD_EXPRESSION__ALIAS, null, msgs);
         }
         if (newAlias != null) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_COLLECT_FIELD_EXPRESSION__ALIAS, newAlias, newAlias));
      }
   }
