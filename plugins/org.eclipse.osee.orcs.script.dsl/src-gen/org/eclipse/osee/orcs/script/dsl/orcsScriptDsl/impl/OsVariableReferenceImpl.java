...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Variable Reference</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsVariableReferenceImpl extends OsExpressionImpl implements OsVariableReference
{
    ...
    if (ref != null && ref.eIsProxy())
    {
      ...
      if (ref != oldRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, OrcsScriptDslPackage.OS_VARIABLE_REFERENCE__REF, oldRef, ref));
      }
    }
    return ref;
  }
  ...
  public void setRef(OsVariable newRef)
  {
    ...
    ref = newRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_VARIABLE_REFERENCE__REF, oldRef, ref));
  }
