...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Tx Comment Clause</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsTxCommentClauseImpl extends MinimalEObjectImpl.Container implements OsTxCommentClause
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_COMMENT_CLAUSE__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetValue(OsExpression newValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_COMMENT_CLAUSE__VALUE, oldValue, newValue);
  ...
  public void setValue(OsExpression newValue)
  {
    if (newValue != value)
    {
      ...
      if (value != null)
        msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_COMMENT_CLAUSE__VALUE, null, msgs);
      if (newValue != null)
        msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_COMMENT_CLAUSE__VALUE, null, msgs);
      msgs = basicSetValue(newValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_COMMENT_CLAUSE__VALUE, newValue, newValue));
  }
