...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Follow Clause</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsFollowClauseImpl extends OsClauseImpl implements OsFollowClause
{
  ...
  public NotificationChain basicSetStmt(OsFollowStatement newStmt, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_FOLLOW_CLAUSE__STMT, oldStmt, newStmt);
  ...
  public void setStmt(OsFollowStatement newStmt)
  {
    if (newStmt != stmt)
    {
      ...
      if (stmt != null)
        msgs = ((InternalEObject)stmt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_FOLLOW_CLAUSE__STMT, null, msgs);
      if (newStmt != null)
        msgs = ((InternalEObject)newStmt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_FOLLOW_CLAUSE__STMT, null, msgs);
      msgs = basicSetStmt(newStmt, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_FOLLOW_CLAUSE__STMT, newStmt, newStmt));
  }
