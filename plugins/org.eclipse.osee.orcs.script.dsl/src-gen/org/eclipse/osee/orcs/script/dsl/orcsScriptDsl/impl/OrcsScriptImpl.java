...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Orcs Script</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class OrcsScriptImpl extends MinimalEObjectImpl.Container implements OrcsScript {
   ...
   public NotificationChain basicSetVersion(ScriptVersion newVersion, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.ORCS_SCRIPT__VERSION, oldVersion, newVersion);
         if (msgs == null) {
            msgs = notification;
         } else {
      ...
      if (newVersion != version) {
         ...
         if (version != null) {
            msgs = ((InternalEObject) version).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.ORCS_SCRIPT__VERSION, null, msgs);
         }
         if (newVersion != null) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.ORCS_SCRIPT__VERSION, newVersion, newVersion));
      }
   }
   ...
   public EList<ScriptStatement> getStatements() {
      if (statements == null) {
         statements =
            new EObjectContainmentEList<>(ScriptStatement.class, this, OrcsScriptDslPackage.ORCS_SCRIPT__STATEMENTS);
      }
      return statements;
   }
