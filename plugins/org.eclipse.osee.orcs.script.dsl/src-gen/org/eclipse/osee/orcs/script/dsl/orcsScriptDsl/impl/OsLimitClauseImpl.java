...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Limit Clause</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class OsLimitClauseImpl extends MinimalEObjectImpl.Container implements OsLimitClause {
   ...
   public void setName(String newName) {
      ...
      if (eNotificationRequired()) {
         eNotify(
            new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_LIMIT_CLAUSE__NAME, oldName, name));
      }
   }
   ...
   public NotificationChain basicSetLimit(OsExpression newLimit, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_LIMIT_CLAUSE__LIMIT, oldLimit, newLimit);
         if (msgs == null) {
            msgs = notification;
         } else {
      ...
      if (newLimit != limit) {
         ...
         if (limit != null) {
            msgs = ((InternalEObject) limit).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_LIMIT_CLAUSE__LIMIT, null, msgs);
         }
         if (newLimit != null) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_LIMIT_CLAUSE__LIMIT, newLimit, newLimit));
      }
   }
