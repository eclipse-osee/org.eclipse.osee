...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Os Tx Id Range Clause</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public interface OsTxIdRangeClause extends OsTxIdClause {
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.OsTxIdRangeClause#getName
   ...
   /**
    * Returns the value of the '<em><b>From Id</b></em>' containment reference. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>From Id</em>' containment reference isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.OsTxIdRangeClause#getFromId
    * <em>From Id</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>To Id</b></em>' containment reference. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>To Id</em>' containment reference isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.OsTxIdRangeClause#getToId
    * <em>To Id</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
