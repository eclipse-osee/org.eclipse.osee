...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Os Tx Timestamp Range Clause</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public interface OsTxTimestampRangeClause extends OsTxTimestampClause {
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.OsTxTimestampRangeClause#getName
    ...
    * <p>
    * If the meaning of the '<em>From</em>' containment reference isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.OsTxTimestampRangeClause#getFrom
    ...
    * <p>
    * If the meaning of the '<em>To</em>' containment reference isn't clear, there really should be more of a
    * description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.OsTxTimestampRangeClause#getTo
