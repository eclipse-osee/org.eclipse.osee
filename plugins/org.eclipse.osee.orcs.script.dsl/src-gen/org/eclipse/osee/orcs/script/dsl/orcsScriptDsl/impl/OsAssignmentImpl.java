...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Assignment</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsAssignmentImpl extends OsExpressionImpl implements OsAssignment
{
  ...
  public NotificationChain basicSetRight(OsExpression newRight, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_ASSIGNMENT__RIGHT, oldRight, newRight);
  ...
  public void setRight(OsExpression newRight)
  {
    if (newRight != right)
    {
      ...
      if (right != null)
        msgs = ((InternalEObject)right).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_ASSIGNMENT__RIGHT, null, msgs);
      if (newRight != null)
        msgs = ((InternalEObject)newRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_ASSIGNMENT__RIGHT, null, msgs);
      msgs = basicSetRight(newRight, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_ASSIGNMENT__RIGHT, newRight, newRight));
  }
