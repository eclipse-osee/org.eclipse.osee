...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Tx Id Criteria</b></em>'. <!-- end-user-doc
 * -->
 * <p>
   ...
   public NotificationChain basicSetClause(OsTxIdClause newClause, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_TX_ID_CRITERIA__CLAUSE, oldClause, newClause);
         if (msgs == null) {
            msgs = notification;
         } else {
      ...
      if (newClause != clause) {
         ...
         if (clause != null) {
            msgs = ((InternalEObject) clause).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_ID_CRITERIA__CLAUSE, null, msgs);
         }
         if (newClause != null) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_TX_ID_CRITERIA__CLAUSE, newClause, newClause));
      }
   }
