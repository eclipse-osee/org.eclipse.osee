...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Artifact Query Statement</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsArtifactQueryStatementImpl#getName <em>Name</em>}
 * </li>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsArtifactQueryStatementImpl#getData <em>Data</em>}
 * </li>
 * <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsArtifactQueryStatementImpl#getCollect
 * <em>Collect</em>}</li>
 * </ul>
 * </p>
 *
...
public class OsArtifactQueryStatementImpl extends OsObjectQueryImpl implements OsArtifactQueryStatement {
   ...
   public void setName(String newName) {
      ...
      if (eNotificationRequired()) {
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_ARTIFACT_QUERY_STATEMENT__NAME, oldName, name));
      }
   }
   ...
   public NotificationChain basicSetData(OsArtifactQuery newData, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_ARTIFACT_QUERY_STATEMENT__DATA, oldData, newData);
         if (msgs == null) {
            msgs = notification;
         } else {
      ...
      if (newData != data) {
         ...
         if (data != null) {
            msgs = ((InternalEObject) data).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_ARTIFACT_QUERY_STATEMENT__DATA, null, msgs);
         }
         if (newData != null) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_ARTIFACT_QUERY_STATEMENT__DATA, newData, newData));
      }
   }
   ...
   public NotificationChain basicSetCollect(OsCollectClause newCollect, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_ARTIFACT_QUERY_STATEMENT__COLLECT, oldCollect, newCollect);
         if (msgs == null) {
            msgs = notification;
         } else {
            msgs.add(notification);
      ...
      if (newCollect != collect) {
         ...
         if (collect != null) {
            msgs = ((InternalEObject) collect).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_ARTIFACT_QUERY_STATEMENT__COLLECT, null, msgs);
         }
         if (newCollect != null) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_ARTIFACT_QUERY_STATEMENT__COLLECT, newCollect, newCollect));
      }
   }
