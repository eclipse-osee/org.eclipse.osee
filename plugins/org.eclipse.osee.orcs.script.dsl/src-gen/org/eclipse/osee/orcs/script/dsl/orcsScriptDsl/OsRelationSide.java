...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Os Relation Side</b></em>',
...
public enum OsRelationSide implements Enumerator
{
  ...
  /**
   * An array of all the '<em><b>Os Relation Side</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final OsRelationSide[] VALUES_ARRAY =
    new OsRelationSide[]
    {
      SIDE_A,
      SIDE_B,
  ...
  /**
   * A public read-only list of all the '<em><b>Os Relation Side</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Os Relation Side</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Os Relation Side</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Os Relation Side</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
