...
import org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.OsBranchCriteria;
import org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.OsBranchIdCriteria;
import org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.OsBranchNameClause;
...
import org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.OsCollectionLiteral;
import org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.OsCritieria;
...
public class OrcsScriptDslPackageImpl extends EPackageImpl implements OrcsScriptDslPackage
{
   ...
   * 
   * <p>This method is used to initialize {@link OrcsScriptDslPackage#eINSTANCE} when that field is accessed.
  ...
  {
    if (isInited) return (OrcsScriptDslPackage)EPackage.Registry.INSTANCE.getEPackage(OrcsScriptDslPackage.eNS_URI);

    // Obtain or create and register package
    OrcsScriptDslPackageImpl theOrcsScriptDslPackage = (OrcsScriptDslPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof OrcsScriptDslPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new OrcsScriptDslPackageImpl());
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(orcsScriptEClass, OrcsScript.class, "OrcsScript", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOrcsScript_Version(), this.getScriptVersion(), null, "version", null, 0, 1, OrcsScript.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOrcsScript_Statements(), this.getScriptStatement(), null, "statements", null, 0, -1, OrcsScript.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(scriptVersionEClass, ScriptVersion.class, "ScriptVersion", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getScriptVersion_Name(), ecorePackage.getEString(), "name", null, 0, 1, ScriptVersion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getScriptVersion_Version(), ecorePackage.getEString(), "version", null, 0, 1, ScriptVersion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osExpressionEClass, OsExpression.class, "OsExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osCollectionLiteralEClass, OsCollectionLiteral.class, "OsCollectionLiteral", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osListLiteralEClass, OsListLiteral.class, "OsListLiteral", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsListLiteral_Elements(), this.getOsExpression(), null, "elements", null, 0, -1, OsListLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osQueryStatementEClass, OsQueryStatement.class, "OsQueryStatement", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsQueryStatement_Stmt(), this.getOsExpression(), null, "stmt", null, 0, 1, OsQueryStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osQueryEClass, OsQuery.class, "OsQuery", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsQuery_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsQuery.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsQuery_Collect(), this.getOsCollectClause(), null, "collect", null, 0, 1, OsQuery.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osCritieriaEClass, OsCritieria.class, "OsCritieria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsCritieria_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsCritieria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osClauseEClass, OsClause.class, "OsClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsClause_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osCollectClauseEClass, OsCollectClause.class, "OsCollectClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsCollectClause_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsCollectClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsCollectClause_Expression(), this.getOsCollectExpression(), null, "expression", null, 0, 1, OsCollectClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsCollectClause_Limit(), this.getOsLimitClause(), null, "limit", null, 0, 1, OsCollectClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osLimitClauseEClass, OsLimitClause.class, "OsLimitClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsLimitClause_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsLimitClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsLimitClause_Limit(), this.getOsExpression(), null, "limit", null, 0, 1, OsLimitClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osCollectExpressionEClass, OsCollectExpression.class, "OsCollectExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsCollectExpression_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsCollectExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osFindClauseEClass, OsFindClause.class, "OsFindClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsFindClause_Query(), this.getOsObjectQuery(), null, "query", null, 0, 1, OsFindClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osObjectQueryEClass, OsObjectQuery.class, "OsObjectQuery", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osBranchQueryStatementEClass, OsBranchQueryStatement.class, "OsBranchQueryStatement", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsBranchQueryStatement_Data(), this.getOsBranchQuery(), null, "data", null, 0, 1, OsBranchQueryStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osBranchQueryEClass, OsBranchQuery.class, "OsBranchQuery", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osBranchQueryByIdEClass, OsBranchQueryById.class, "OsBranchQueryById", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsBranchQueryById_Name(), this.getOsExpression(), null, "name", null, 0, 1, OsBranchQueryById.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osBranchQueryAllEClass, OsBranchQueryAll.class, "OsBranchQueryAll", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsBranchQueryAll_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsBranchQueryAll.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osBranchQueryByPredicateEClass, OsBranchQueryByPredicate.class, "OsBranchQueryByPredicate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsBranchQueryByPredicate_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsBranchQueryByPredicate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsBranchQueryByPredicate_Criteria(), this.getOsBranchCriteria(), null, "criteria", null, 0, -1, OsBranchQueryByPredicate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osBranchCriteriaEClass, OsBranchCriteria.class, "OsBranchCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osBranchNameCriteriaEClass, OsBranchNameCriteria.class, "OsBranchNameCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsBranchNameCriteria_Clause(), this.getOsBranchNameClause(), null, "clause", null, 0, 1, OsBranchNameCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osBranchNameClauseEClass, OsBranchNameClause.class, "OsBranchNameClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsBranchNameClause_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsBranchNameClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsBranchNameClause_Value(), this.getOsExpression(), null, "value", null, 0, 1, OsBranchNameClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osBranchNameEqualsClauseEClass, OsBranchNameEqualsClause.class, "OsBranchNameEqualsClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osBranchNamePatternClauseEClass, OsBranchNamePatternClause.class, "OsBranchNamePatternClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osBranchTypeCriteriaEClass, OsBranchTypeCriteria.class, "OsBranchTypeCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsBranchTypeCriteria_Types(), this.getOsBranchType(), "types", null, 0, -1, OsBranchTypeCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osBranchStateCriteriaEClass, OsBranchStateCriteria.class, "OsBranchStateCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsBranchStateCriteria_States(), this.getOsBranchState(), "states", null, 0, -1, OsBranchStateCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osBranchArchivedCriteriaEClass, OsBranchArchivedCriteria.class, "OsBranchArchivedCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsBranchArchivedCriteria_Filter(), this.getOsBranchArchiveFilter(), "filter", null, 0, 1, OsBranchArchivedCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osBranchIdCriteriaEClass, OsBranchIdCriteria.class, "OsBranchIdCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsBranchIdCriteria_Ids(), this.getOsExpression(), null, "ids", null, 0, -1, OsBranchIdCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osBranchOfCriteriaEClass, OsBranchOfCriteria.class, "OsBranchOfCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsBranchOfCriteria_Clause(), this.getOsBranchClause(), null, "clause", null, 0, 1, OsBranchOfCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osBranchClauseEClass, OsBranchClause.class, "OsBranchClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsBranchClause_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsBranchClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsBranchClause_Id(), this.getOsExpression(), null, "id", null, 0, 1, OsBranchClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osBranchChildOfClauseEClass, OsBranchChildOfClause.class, "OsBranchChildOfClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osBranchParentOfClauseEClass, OsBranchParentOfClause.class, "OsBranchParentOfClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osTxQueryStatementEClass, OsTxQueryStatement.class, "OsTxQueryStatement", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsTxQueryStatement_Data(), this.getOsTxQuery(), null, "data", null, 0, 1, OsTxQueryStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxQueryEClass, OsTxQuery.class, "OsTxQuery", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osTxQueryByIdEClass, OsTxQueryById.class, "OsTxQueryById", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsTxQueryById_Name(), this.getOsExpression(), null, "name", null, 0, 1, OsTxQueryById.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxQueryAllEClass, OsTxQueryAll.class, "OsTxQueryAll", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsTxQueryAll_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsTxQueryAll.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxQueryByPredicateEClass, OsTxQueryByPredicate.class, "OsTxQueryByPredicate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsTxQueryByPredicate_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsTxQueryByPredicate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsTxQueryByPredicate_Criteria(), this.getOsTxCriteria(), null, "criteria", null, 0, -1, OsTxQueryByPredicate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxCriteriaEClass, OsTxCriteria.class, "OsTxCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osTxTypeCriteriaEClass, OsTxTypeCriteria.class, "OsTxTypeCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsTxTypeCriteria_Types(), this.getOsTxType(), "types", null, 0, -1, OsTxTypeCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxCommentCriteriaEClass, OsTxCommentCriteria.class, "OsTxCommentCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsTxCommentCriteria_Clause(), this.getOsTxCommentClause(), null, "clause", null, 0, 1, OsTxCommentCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxCommentClauseEClass, OsTxCommentClause.class, "OsTxCommentClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsTxCommentClause_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsTxCommentClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsTxCommentClause_Value(), this.getOsExpression(), null, "value", null, 0, 1, OsTxCommentClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxCommentEqualsClauseEClass, OsTxCommentEqualsClause.class, "OsTxCommentEqualsClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osTxCommentPatternClauseEClass, OsTxCommentPatternClause.class, "OsTxCommentPatternClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osTxBranchIdCriteriaEClass, OsTxBranchIdCriteria.class, "OsTxBranchIdCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsTxBranchIdCriteria_Ids(), this.getOsExpression(), null, "ids", null, 0, -1, OsTxBranchIdCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxHeadOfBranchIdCriteriaEClass, OsTxHeadOfBranchIdCriteria.class, "OsTxHeadOfBranchIdCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsTxHeadOfBranchIdCriteria_Id(), this.getOsExpression(), null, "id", null, 0, 1, OsTxHeadOfBranchIdCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxAuthorIdCriteriaEClass, OsTxAuthorIdCriteria.class, "OsTxAuthorIdCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsTxAuthorIdCriteria_Ids(), this.getOsExpression(), null, "ids", null, 0, -1, OsTxAuthorIdCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxCommitIdCriteriaEClass, OsTxCommitIdCriteria.class, "OsTxCommitIdCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsTxCommitIdCriteria_Clause(), this.getOsTxCommitIdClause(), null, "clause", null, 0, 1, OsTxCommitIdCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxCommitIdClauseEClass, OsTxCommitIdClause.class, "OsTxCommitIdClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsTxCommitIdClause_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsTxCommitIdClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxCommitIdEqualsClauseEClass, OsTxCommitIdEqualsClause.class, "OsTxCommitIdEqualsClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsTxCommitIdEqualsClause_Ids(), this.getOsExpression(), null, "ids", null, 0, -1, OsTxCommitIdEqualsClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxCommitIdIsNullClauseEClass, OsTxCommitIdIsNullClause.class, "OsTxCommitIdIsNullClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osTxIdCriteriaEClass, OsTxIdCriteria.class, "OsTxIdCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsTxIdCriteria_Clause(), this.getOsTxIdClause(), null, "clause", null, 0, 1, OsTxIdCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxIdClauseEClass, OsTxIdClause.class, "OsTxIdClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osTxIdEqualsClauseEClass, OsTxIdEqualsClause.class, "OsTxIdEqualsClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsTxIdEqualsClause_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsTxIdEqualsClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsTxIdEqualsClause_Ids(), this.getOsExpression(), null, "ids", null, 0, -1, OsTxIdEqualsClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxIdOpClauseEClass, OsTxIdOpClause.class, "OsTxIdOpClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsTxIdOpClause_Op(), this.getOsNonEqualOperator(), "op", null, 0, 1, OsTxIdOpClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsTxIdOpClause_Id(), this.getOsExpression(), null, "id", null, 0, 1, OsTxIdOpClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxIdRangeClauseEClass, OsTxIdRangeClause.class, "OsTxIdRangeClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsTxIdRangeClause_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsTxIdRangeClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsTxIdRangeClause_FromId(), this.getOsExpression(), null, "fromId", null, 0, 1, OsTxIdRangeClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsTxIdRangeClause_ToId(), this.getOsExpression(), null, "toId", null, 0, 1, OsTxIdRangeClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxTimestampCriteriaEClass, OsTxTimestampCriteria.class, "OsTxTimestampCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsTxTimestampCriteria_Clause(), this.getOsTxTimestampClause(), null, "clause", null, 0, 1, OsTxTimestampCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxTimestampClauseEClass, OsTxTimestampClause.class, "OsTxTimestampClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osTxTimestampOpClauseEClass, OsTxTimestampOpClause.class, "OsTxTimestampOpClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsTxTimestampOpClause_Op(), this.getOsOperator(), "op", null, 0, 1, OsTxTimestampOpClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsTxTimestampOpClause_Timestamp(), this.getOsExpression(), null, "timestamp", null, 0, 1, OsTxTimestampOpClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTxTimestampRangeClauseEClass, OsTxTimestampRangeClause.class, "OsTxTimestampRangeClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsTxTimestampRangeClause_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsTxTimestampRangeClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsTxTimestampRangeClause_From(), this.getOsExpression(), null, "from", null, 0, 1, OsTxTimestampRangeClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsTxTimestampRangeClause_To(), this.getOsExpression(), null, "to", null, 0, 1, OsTxTimestampRangeClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osArtifactQueryStatementEClass, OsArtifactQueryStatement.class, "OsArtifactQueryStatement", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsArtifactQueryStatement_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsArtifactQueryStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsArtifactQueryStatement_Data(), this.getOsArtifactQuery(), null, "data", null, 0, 1, OsArtifactQueryStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsArtifactQueryStatement_Collect(), this.getOsCollectClause(), null, "collect", null, 0, 1, OsArtifactQueryStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osArtifactQueryEClass, OsArtifactQuery.class, "OsArtifactQuery", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsArtifactQuery_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsArtifactQuery.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osArtifactQueryAllEClass, OsArtifactQueryAll.class, "OsArtifactQueryAll", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osArtifactQueryByPredicateEClass, OsArtifactQueryByPredicate.class, "OsArtifactQueryByPredicate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsArtifactQueryByPredicate_Criteria(), this.getOsItemCriteria(), null, "criteria", null, 0, -1, OsArtifactQueryByPredicate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osItemCriteriaEClass, OsItemCriteria.class, "OsItemCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osArtifactCriteriaEClass, OsArtifactCriteria.class, "OsArtifactCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEClass(osArtifactTypeClauseEClass, OsArtifactTypeClause.class, "OsArtifactTypeClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsArtifactTypeClause_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsArtifactTypeClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsArtifactTypeClause_Types(), this.getOsExpression(), null, "types", null, 0, -1, OsArtifactTypeClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osArtifactTypeEqualsClauseEClass, OsArtifactTypeEqualsClause.class, "OsArtifactTypeEqualsClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osArtifactTypeInstanceOfClauseEClass, OsArtifactTypeInstanceOfClause.class, "OsArtifactTypeInstanceOfClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osAttributeCriteriaEClass, OsAttributeCriteria.class, "OsAttributeCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsAttributeCriteria_Clause(), this.getOsAttributeClause(), null, "clause", null, 0, 1, OsAttributeCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osAttributeClauseEClass, OsAttributeClause.class, "OsAttributeClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsAttributeClause_Types(), this.getOsExpression(), null, "types", null, 0, -1, OsAttributeClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getOsAttributeClause_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsAttributeClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osAttributeExistClauseEClass, OsAttributeExistClause.class, "OsAttributeExistClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(oseAttributeOpClauseEClass, OseAttributeOpClause.class, "OseAttributeOpClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOseAttributeOpClause_Options(), this.getOsQueryOption(), "options", null, 0, -1, OseAttributeOpClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOseAttributeOpClause_Values(), this.getOsExpression(), null, "values", null, 0, -1, OseAttributeOpClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osRelationCriteriaEClass, OsRelationCriteria.class, "OsRelationCriteria", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsRelationCriteria_Clause(), this.getOsRelationClause(), null, "clause", null, 0, 1, OsRelationCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osRelationClauseEClass, OsRelationClause.class, "OsRelationClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsRelationClause_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsRelationClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsRelationClause_Type(), this.getOsExpression(), null, "type", null, 0, 1, OsRelationClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getOsRelationClause_Side(), this.getOsRelationSide(), "side", null, 0, 1, OsRelationClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osRelationExistClauseEClass, OsRelationExistClause.class, "OsRelationExistClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsRelationExistClause_Op(), this.getOsExistenceOperator(), "op", null, 0, 1, OsRelationExistClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osRelatedToClauseEClass, OsRelatedToClause.class, "OsRelatedToClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsRelatedToClause_Ids(), this.getOsExpression(), null, "ids", null, 0, -1, OsRelatedToClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osFollowClauseEClass, OsFollowClause.class, "OsFollowClause", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsFollowClause_Stmt(), this.getOsFollowStatement(), null, "stmt", null, 0, 1, OsFollowClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osFollowStatementEClass, OsFollowStatement.class, "OsFollowStatement", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osFollowRelationTypeEClass, OsFollowRelationType.class, "OsFollowRelationType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsFollowRelationType_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsFollowRelationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsFollowRelationType_Type(), this.getOsExpression(), null, "type", null, 0, 1, OsFollowRelationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getOsFollowRelationType_Side(), this.getOsRelationSide(), "side", null, 0, 1, OsFollowRelationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsFollowRelationType_Criteria(), this.getOsItemCriteria(), null, "criteria", null, 0, -1, OsFollowRelationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsFollowRelationType_Collect(), this.getOsCollectClause(), null, "collect", null, 0, 1, OsFollowRelationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osVariableDeclarationEClass, OsVariableDeclaration.class, "OsVariableDeclaration", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsVariableDeclaration_Elements(), this.getOsExpression(), null, "elements", null, 0, -1, OsVariableDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osVariableEClass, OsVariable.class, "OsVariable", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsVariable_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsVariable_Right(), this.getOsExpression(), null, "right", null, 0, 1, OsVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osAssignmentEClass, OsAssignment.class, "OsAssignment", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsAssignment_Right(), this.getOsExpression(), null, "right", null, 0, 1, OsAssignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osBooleanLiteralEClass, OsBooleanLiteral.class, "OsBooleanLiteral", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsBooleanLiteral_IsTrue(), ecorePackage.getEBoolean(), "isTrue", null, 0, 1, OsBooleanLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osNullLiteralEClass, OsNullLiteral.class, "OsNullLiteral", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osNumberLiteralEClass, OsNumberLiteral.class, "OsNumberLiteral", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsNumberLiteral_Value(), ecorePackage.getEString(), "value", null, 0, 1, OsNumberLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osStringLiteralEClass, OsStringLiteral.class, "OsStringLiteral", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsStringLiteral_Value(), ecorePackage.getEString(), "value", null, 0, 1, OsStringLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osTemplateLiteralEClass, OsTemplateLiteral.class, "OsTemplateLiteral", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsTemplateLiteral_Value(), ecorePackage.getEString(), "value", null, 0, 1, OsTemplateLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osVariableReferenceEClass, OsVariableReference.class, "OsVariableReference", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsVariableReference_Ref(), this.getOsVariable(), null, "ref", null, 0, 1, OsVariableReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osDotExpressionEClass, OsDotExpression.class, "OsDotExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsDotExpression_Ref(), this.getOsExpression(), null, "ref", null, 0, 1, OsDotExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsDotExpression_Tail(), this.getOsExpression(), null, "tail", null, 0, 1, OsDotExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osQueryExpressionEClass, OsQueryExpression.class, "OsQueryExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOsQueryExpression_Name(), ecorePackage.getEString(), "name", null, 0, 1, OsQueryExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsQueryExpression_Query(), this.getOsQuery(), null, "query", null, 0, 1, OsQueryExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsQueryExpression_Clause(), this.getOsClause(), null, "clause", null, 0, -1, OsQueryExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osCollectObjectExpressionEClass, OsCollectObjectExpression.class, "OsCollectObjectExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsCollectObjectExpression_Alias(), this.getOsExpression(), null, "alias", null, 0, 1, OsCollectObjectExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOsCollectObjectExpression_Expressions(), this.getOsCollectExpression(), null, "expressions", null, 0, -1, OsCollectObjectExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(osCollectAllFieldsExpressionEClass, OsCollectAllFieldsExpression.class, "OsCollectAllFieldsExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(osCollectFieldExpressionEClass, OsCollectFieldExpression.class, "OsCollectFieldExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOsCollectFieldExpression_Alias(), this.getOsExpression(), null, "alias", null, 0, 1, OsCollectFieldExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
