...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Os Branch Archive Filter</b></em>',
...
{
  /**
   * The '<em><b>ARCHIVED EXCLUDED</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The '<em><b>ARCHIVED INCLUDED</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The '<em><b>ARCHIVED EXCLUDED</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>ARCHIVED EXCLUDED</b></em>' literal object isn't clear,
  ...
  /**
   * The '<em><b>ARCHIVED INCLUDED</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>ARCHIVED INCLUDED</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
  ...
  /**
   * An array of all the '<em><b>Os Branch Archive Filter</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final OsBranchArchiveFilter[] VALUES_ARRAY =
    new OsBranchArchiveFilter[]
    {
      ARCHIVED_EXCLUDED,
      ARCHIVED_INCLUDED,
    };
  ...
  /**
   * A public read-only list of all the '<em><b>Os Branch Archive Filter</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Os Branch Archive Filter</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  public static OsBranchArchiveFilter get(int value)
  {
    switch (value)
    {
      case ARCHIVED_EXCLUDED_VALUE: return ARCHIVED_EXCLUDED;
      case ARCHIVED_INCLUDED_VALUE: return ARCHIVED_INCLUDED;
    }
    return null;
  }
