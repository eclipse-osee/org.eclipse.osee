...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Tx Query By Id</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsTxQueryByIdImpl extends OsTxQueryImpl implements OsTxQueryById
{
  ...
  public NotificationChain basicSetName(OsExpression newName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_QUERY_BY_ID__NAME, oldName, newName);
  ...
  public void setName(OsExpression newName)
  {
    if (newName != name)
    {
      ...
      if (name != null)
        msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_QUERY_BY_ID__NAME, null, msgs);
      if (newName != null)
        msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_TX_QUERY_BY_ID__NAME, null, msgs);
      msgs = basicSetName(newName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_TX_QUERY_BY_ID__NAME, newName, newName));
  }
