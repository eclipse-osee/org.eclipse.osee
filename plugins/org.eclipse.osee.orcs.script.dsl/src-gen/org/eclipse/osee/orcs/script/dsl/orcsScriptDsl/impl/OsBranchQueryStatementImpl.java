...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Branch Query Statement</b></em>'. <!--
 * end-user-doc -->
 * <p>
   ...
   public NotificationChain basicSetData(OsBranchQuery newData, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_BRANCH_QUERY_STATEMENT__DATA, oldData, newData);
         if (msgs == null) {
            msgs = notification;
         } else {
      ...
      if (newData != data) {
         ...
         if (data != null) {
            msgs = ((InternalEObject) data).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_BRANCH_QUERY_STATEMENT__DATA, null, msgs);
         }
         if (newData != null) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_BRANCH_QUERY_STATEMENT__DATA, newData, newData));
      }
   }
