...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Follow Relation Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsFollowRelationTypeImpl#getCriteria <em>Criteria</em>}</li>
 *   <li>{@link org.eclipse.osee.orcs.script.dsl.orcsScriptDsl.impl.OsFollowRelationTypeImpl#getCollect <em>Collect</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OsFollowRelationTypeImpl extends OsFollowStatementImpl implements OsFollowRelationType
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_FOLLOW_RELATION_TYPE__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetType(OsExpression newType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_FOLLOW_RELATION_TYPE__TYPE, oldType, newType);
  ...
  public void setType(OsExpression newType)
  {
    if (newType != type)
    {
      ...
      if (type != null)
        msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_FOLLOW_RELATION_TYPE__TYPE, null, msgs);
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_FOLLOW_RELATION_TYPE__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_FOLLOW_RELATION_TYPE__TYPE, newType, newType));
  }
  ...
  public void setSide(OsRelationSide newSide)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_FOLLOW_RELATION_TYPE__SIDE, oldSide, side));
  }
  ...
  public NotificationChain basicSetCollect(OsCollectClause newCollect, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_FOLLOW_RELATION_TYPE__COLLECT, oldCollect, newCollect);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setCollect(OsCollectClause newCollect)
  {
    if (newCollect != collect)
    {
      NotificationChain msgs = null;
      if (collect != null)
        msgs = ((InternalEObject)collect).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_FOLLOW_RELATION_TYPE__COLLECT, null, msgs);
      if (newCollect != null)
        msgs = ((InternalEObject)newCollect).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_FOLLOW_RELATION_TYPE__COLLECT, null, msgs);
      msgs = basicSetCollect(newCollect, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_FOLLOW_RELATION_TYPE__COLLECT, newCollect, newCollect));
  }
