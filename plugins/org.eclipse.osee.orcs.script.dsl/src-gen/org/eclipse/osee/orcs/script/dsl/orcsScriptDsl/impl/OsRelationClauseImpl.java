...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Os Relation Clause</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class OsRelationClauseImpl extends MinimalEObjectImpl.Container implements OsRelationClause {
   ...
   public void setName(String newName) {
      ...
      if (eNotificationRequired()) {
         eNotify(
            new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_RELATION_CLAUSE__NAME, oldName, name));
      }
   }
   ...
   public NotificationChain basicSetType(OsExpression newType, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_RELATION_CLAUSE__TYPE, oldType, newType);
         if (msgs == null) {
            msgs = notification;
         } else {
      ...
      if (newType != type) {
         ...
         if (type != null) {
            msgs = ((InternalEObject) type).eInverseRemove(this,
               EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_RELATION_CLAUSE__TYPE, null, msgs);
         }
         if (newType != null) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET,
            OrcsScriptDslPackage.OS_RELATION_CLAUSE__TYPE, newType, newType));
      }
   }
   ...
   public void setSide(OsRelationSide newSide) {
      ...
      if (eNotificationRequired()) {
         eNotify(
            new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_RELATION_CLAUSE__SIDE, oldSide, side));
      }
   }
