...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Os Existence Operator</b></em>',
...
public enum OsExistenceOperator implements Enumerator
{
  ...
  /**
   * An array of all the '<em><b>Os Existence Operator</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final OsExistenceOperator[] VALUES_ARRAY =
    new OsExistenceOperator[]
    {
      EXISTS,
      NOT_EXISTS,
    };
  ...
  /**
   * A public read-only list of all the '<em><b>Os Existence Operator</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Os Existence Operator</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Os Existence Operator</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Os Existence Operator</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
