...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Query Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsQueryExpressionImpl extends OsExpressionImpl implements OsQueryExpression
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_QUERY_EXPRESSION__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetQuery(OsQuery newQuery, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_QUERY_EXPRESSION__QUERY, oldQuery, newQuery);
  ...
  public void setQuery(OsQuery newQuery)
  {
    if (newQuery != query)
    {
      ...
      if (query != null)
        msgs = ((InternalEObject)query).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_QUERY_EXPRESSION__QUERY, null, msgs);
      if (newQuery != null)
        msgs = ((InternalEObject)newQuery).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_QUERY_EXPRESSION__QUERY, null, msgs);
      msgs = basicSetQuery(newQuery, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_QUERY_EXPRESSION__QUERY, newQuery, newQuery));
  }
