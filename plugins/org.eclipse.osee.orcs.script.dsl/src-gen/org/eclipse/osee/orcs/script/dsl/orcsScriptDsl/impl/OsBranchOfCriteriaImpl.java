...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Os Branch Of Criteria</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OsBranchOfCriteriaImpl extends OsBranchCriteriaImpl implements OsBranchOfCriteria
{
  ...
  public NotificationChain basicSetClause(OsBranchClause newClause, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_BRANCH_OF_CRITERIA__CLAUSE, oldClause, newClause);
  ...
  public void setClause(OsBranchClause newClause)
  {
    if (newClause != clause)
    {
      ...
      if (clause != null)
        msgs = ((InternalEObject)clause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_BRANCH_OF_CRITERIA__CLAUSE, null, msgs);
      if (newClause != null)
        msgs = ((InternalEObject)newClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrcsScriptDslPackage.OS_BRANCH_OF_CRITERIA__CLAUSE, null, msgs);
      msgs = basicSetClause(newClause, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrcsScriptDslPackage.OS_BRANCH_OF_CRITERIA__CLAUSE, newClause, newClause));
  }
