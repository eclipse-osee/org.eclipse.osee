...
public class PropertyStoreWriterTest {
   ...
   public void testReadWriteStream() throws Exception {
      PropertyStore actual = PropertyStoreTestUtil.createPropertyStore();
   ...
   public void testLoadingXml() throws Exception {
      ...
      PropertyStore expected = PropertyStoreTestUtil.createPropertyStore("coverage.item");
