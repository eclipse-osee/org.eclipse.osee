...
public class TokenMatcherTest {
   ...
   private static final String testSequence1 =
     ...
     //v         v         v         v         v         v         v         v         v         v         v
      "abcdefghijklmnopqrstuvwxyz<w:p><w:r><w:t>INSERT_ARTIFACT_HERE</w:t></w:r></w:p>abcdefghijklmnopqrstuvwxyz";
   //@formatter:on
   ...
   public void testSequence1() {
      ...
      Assert.assertEquals( "tokenMatcher.suffixGroupString(0)",          "</w:t></w:r></w:p>",   tokenMatcher.suffixGroupString(0)                     );
      Assert.assertEquals( "tokenMatcher.suffixGroupCharSequence(0)",    "</w:t></w:r></w:p>",   tokenMatcher.suffixGroupCharSequence(0).toString()    );
      ...
      Assert.assertEquals( "tokenMatcher.suffixGroupString(1)",          "</w:r>",               tokenMatcher.suffixGroupString(1)                     );
      Assert.assertEquals( "tokenMatcher.suffixGroupCharSequence(1)",    "</w:r>",               tokenMatcher.suffixGroupCharSequence(1).toString()    );
