...
public class XCommitManagerArtWidget extends XWidget implements IBranchEventListener, IArtifactEventListener, IArtifactTopicEventListener {

   public static WidgetId ID = WidgetIdAts.XCommitManagerArtWidget;
   ...
   public XCommitManagerArtWidget() {
      super(ID, NAME);
   ...
   private void redrawComposite() {
      ...
      try {
         if (AtsApiService.get().getBranchService().isWorkingBranchCreationInProgress(teamArt)) {
            ...
            if (getToolkit() != null && xCommitManager.getStatusLabel() != null) {
               getToolkit().adapt(xCommitManager.getStatusLabel(), false, false);
            }
   ...
   public void setArtifact(Artifact artifact) {
      ...
      if (!artifact.isOfType(AtsArtifactTypes.TeamWorkflow)) {
         throw new OseeStateException("Must be TeamWorkflowArtifact, set was a [%s]",
            getArtifact().getArtifactTypeName());
      }
