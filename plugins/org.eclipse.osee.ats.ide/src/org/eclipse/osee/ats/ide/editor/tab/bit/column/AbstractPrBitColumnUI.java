 ...
 */
public abstract class AbstractPrBitColumnUI extends BackgroundLoadingPreComputedColumnUI {

   protected final AttributeTypeToken attrType;

   public AbstractPrBitColumnUI(CoreCodeColumnTokenDefault colTok, AttributeTypeToken attrType) {
      super(colTok);
