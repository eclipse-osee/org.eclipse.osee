...
import org.eclipse.osee.ats.ide.workflow.task.mini.XAbstractMiniTaskArtWidget;
 ...
 */
public abstract class XAbstractTaskEstWidget extends XAbstractMiniTaskArtWidget {
   ...
   public XAbstractTaskEstWidget(WidgetId widgetId) {
      super(widgetId, NAME, new XTaskEstXViewerFactory());
   }
