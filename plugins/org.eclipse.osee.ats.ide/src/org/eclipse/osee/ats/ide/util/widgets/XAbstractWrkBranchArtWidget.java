 ...
 * @author Shawn F. Cook
 */
public abstract class XAbstractWrkBranchArtWidget extends XWidget implements IArtifactEventListener, IArtifactTopicEventListener, IBranchEventListener {
   ...
   public XAbstractWrkBranchArtWidget(WidgetId widgetId) {
      super(widgetId);
