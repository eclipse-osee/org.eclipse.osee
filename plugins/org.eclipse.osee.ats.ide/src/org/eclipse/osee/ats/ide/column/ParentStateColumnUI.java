 ...
 */
public class ParentStateColumnUI extends XViewerAtsColumn implements IXViewerValueColumn {

   public static ParentStateColumnUI instance = new ParentStateColumnUI();

   public static ParentStateColumnUI getInstance() {
      return instance;
   }

   private ParentStateColumnUI() {
    ...
    */
   @Override
   public ParentStateColumnUI copy() {
      ParentStateColumnUI newXCol = new ParentStateColumnUI();
