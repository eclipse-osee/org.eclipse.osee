...
/**
 * TopicHandler for { public static final WidgetId ID = WidgetIdAts.XWrkBranchButtonLockWidget;@link
 * AccessTopicEvent.ACCESS_BRANCH_MODIFIED}
 *
 * @author Shawn F. Cook
 */
@Component(service = XWidget.class, immediate = true)
public class XWrkBranchButtonLockWidget extends XAbstractWrkBranchButtonWidget implements EventHandler {
   public static WidgetId ID = WidgetIdAts.XWrkBranchButtonLockWidget;

   public XWrkBranchButtonLockWidget() {
      super(ID);
   }
   ...
   protected boolean isWidgetAllowedInCurrentState() {
      return isWidgetInState(XWrkBranchButtonLockWidget.class.getSimpleName());
   }
