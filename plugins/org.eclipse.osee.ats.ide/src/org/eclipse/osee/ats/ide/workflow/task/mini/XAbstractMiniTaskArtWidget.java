 ...
 */
public abstract class XAbstractMiniTaskArtWidget extends XWidget implements IArtifactEventListener, IArtifactTopicEventListener {
   ...
   protected XLabelValueWidget pointsLabel;
   private final IXViewerFactory xViewerFactory;
   protected IAtsTeamWorkflow teamWf;

   public XAbstractMiniTaskArtWidget(WidgetId widgetId, String label, IXViewerFactory xViewerFactory) {
   ...
   protected void createControls(Composite parent, int horizontalSpan) {
      ...
      final XAbstractMiniTaskArtWidget fWidget = this;
   ...
   private void redrawComposite() {
      ...
      try {
         ...
         if (getToolkit() != null && xTaskViewer.getStatusLabel() != null) {
            getToolkit().adapt(xTaskViewer.getStatusLabel(), false, false);
         }

         pointsLabel = new XLabelValueWidget("Total Estimated Points", "0");
         ...
         if (getToolkit() != null) {
            getToolkit().adapt(pointsLabel.getLabelWidget(), false, false);
            getToolkit().adapt(pointsLabel.getValueTextWidget(), false, false);
         }
