...
public class XHyperlinkPrBuildSelectionWidget extends XAbstractHyperlinkLabelValueSelWidget {

   public static final WidgetId ID = WidgetIdAts.XHyperlinkPrBuildSelectionWidget;
   ...
   public XHyperlinkPrBuildSelectionWidget() {
      this(LABEL);
   }

   public XHyperlinkPrBuildSelectionWidget(String label) {
      super(ID, label);
   }
