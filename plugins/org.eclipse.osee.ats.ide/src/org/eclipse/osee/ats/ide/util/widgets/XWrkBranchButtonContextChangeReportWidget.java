...
public class XWrkBranchButtonContextChangeReportWidget extends XAbstractWrkBranchButtonWidget {

   public static final WidgetId ID = WidgetIdAts.XWrkBranchButtonContextChangeReportWidget;

   public XWrkBranchButtonContextChangeReportWidget() {
      super(ID);
   }
