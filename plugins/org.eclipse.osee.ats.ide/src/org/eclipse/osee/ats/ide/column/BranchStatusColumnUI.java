 ...
 */
public class BranchStatusColumnUI extends BackgroundLoadingPreComputedColumnUI {

   public static BranchStatusColumnUI instance = new BranchStatusColumnUI();

   public static BranchStatusColumnUI getInstance() {
      return instance;
   }

   private BranchStatusColumnUI() {
    ...
    */
   @Override
   public BranchStatusColumnUI copy() {
      BranchStatusColumnUI newXCol = new BranchStatusColumnUI();
