 ...
 */
public class WorkDaysNeededColumnUI extends XViewerAtsColumn implements IXViewerValueColumn, IAltLeftClickProvider {

   public static WorkDaysNeededColumnUI instance = new WorkDaysNeededColumnUI();

   public static WorkDaysNeededColumnUI getInstance() {
      return instance;
   }

   private WorkDaysNeededColumnUI() {
    ...
    */
   @Override
   public WorkDaysNeededColumnUI copy() {
      WorkDaysNeededColumnUI newXCol = new WorkDaysNeededColumnUI();
   ...
   public static Result isWorldViewManDaysNeededValid(Object object) {
      if (object instanceof AbstractWorkflowArtifact) {
         ...
         Result result = RemainingHoursColumnUI.isRemainingHoursValid(aba);
         if (result.isFalse()) {
            return result;
         }
   ...
   public static double getWorldViewManDaysNeeded(Object object) {
      if (object instanceof AbstractWorkflowArtifact) {
         double hrsRemain = RemainingHoursColumnUI.getRemainingHours(object);
