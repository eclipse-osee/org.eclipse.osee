...
public class XOpenStoredSprintReportsArtWidget extends XButtonWidget {

   protected IAgileSprint sprint;
   public static WidgetId ID = WidgetIdAts.XOpenStoredSprintReportsArtWidget;

   public XOpenStoredSprintReportsArtWidget() {
      super(ID, "Open Snapshots of Stored Sprint Charts");
