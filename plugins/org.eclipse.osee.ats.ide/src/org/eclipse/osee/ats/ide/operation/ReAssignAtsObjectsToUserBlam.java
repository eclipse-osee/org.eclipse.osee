...
public class ReAssignAtsObjectsToUserBlam extends AbstractAtsBlam {
            ...
            try {
               ...
               for (Artifact artifact : artsToReAssign) {
                  if (artifact instanceof AbstractWorkflowArtifact) {
                     ...
                     changes.removeAssignee(awa, AtsApiService.get().getUserService().getUserById(fromUser));
                     changes.addAssignee(awa, AtsApiService.get().getUserService().getUserById(toUser));
                     changes.add(awa);
                  }
               }
               changes.execute();
   ...
   public List<XWidgetData> getXWidgetItems() {
      createWidgetBuilder();
      wb.andWidget(FROM_ASSIGNEE, WidgetId.XMembersComboWidget);
      wb.andWidget(TO_ASSIGNEE, WidgetId.XMembersComboWidget);
