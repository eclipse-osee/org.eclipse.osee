...
public class XHyperlinkWfdForConfigurationWidget extends XAbstractHyperlinkWithFilteredDialogWidget<ArtifactToken> {

   public static final WidgetId ID = WidgetIdAts.XHyperlinkWfdForConfigurationWidget;
   BranchId branch = BranchId.SENTINEL;

   public XHyperlinkWfdForConfigurationWidget() {
      this(ID);
   }

   public XHyperlinkWfdForConfigurationWidget(WidgetId widgetId) {
      super(widgetId, "");
   }
