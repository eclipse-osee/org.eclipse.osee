...
public class XWorkingBranchLabelWidget extends XAbstractWrkBranchArtWidget {

   public static final WidgetId ID = WidgetIdAts.XWorkingBranchLabelWidget;

   public static String NAME = "Working Branch";

   public XWorkingBranchLabelWidget() {
      super(ID);
