...
import org.eclipse.osee.framework.ui.skynet.widgets.XAbstractTextWithFileDirSelDialogWidget;
import org.eclipse.osee.framework.ui.skynet.widgets.XAbstractTextWithFileDirSelDialogWidget.Type;
...
public class ImportGeneralDocumentsBlam extends AbstractAtsBlam {
   ...
   public void widgetCreating(XWidget xWidget, FormToolkit toolkit, Artifact art,
      ...
      if (xWidget.getLabel().equals(FILE_SELECTION)) {
         XAbstractTextWithFileDirSelDialogWidget widget = (XAbstractTextWithFileDirSelDialogWidget) xWidget;
