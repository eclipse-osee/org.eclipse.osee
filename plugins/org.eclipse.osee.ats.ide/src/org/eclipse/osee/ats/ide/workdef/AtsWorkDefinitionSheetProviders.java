...
import org.eclipse.osee.ats.ide.workdef.config.ImportAIsAndTeamDefinitionsToDb;
...
public final class AtsWorkDefinitionSheetProviders {
   ...
   private synchronized static Set<IAtsWorkDefinitionSheetProvider> getProviders(String dbType) {
      ...
      IExtensionPoint point =
         Platform.getExtensionRegistry().getExtensionPoint("org.eclipse.osee.ats.ide.AtsWorkDefinitionSheetProvider");
      if (point == null) {
