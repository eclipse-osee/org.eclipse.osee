 ...
 */
public class RelatedArtifactLastModifiedDateColumnUI extends XViewerAtsColumn implements IXViewerValueColumn {

   public static RelatedArtifactLastModifiedDateColumnUI instance = new RelatedArtifactLastModifiedDateColumnUI();

   public static RelatedArtifactLastModifiedDateColumnUI getInstance() {
      return instance;
   }

   private RelatedArtifactLastModifiedDateColumnUI() {
    ...
    */
   @Override
   public RelatedArtifactLastModifiedDateColumnUI copy() {
      RelatedArtifactLastModifiedDateColumnUI newXCol = new RelatedArtifactLastModifiedDateColumnUI();
