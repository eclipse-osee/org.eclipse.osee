 ...
 */
public class ReviewDeciderColumnUI extends XViewerAtsColumn implements IXViewerValueColumn {

   public static ReviewDeciderColumnUI instance = new ReviewDeciderColumnUI();

   public static ReviewDeciderColumnUI getInstance() {
      return instance;
   }

   private ReviewDeciderColumnUI() {
    ...
    */
   @Override
   public ReviewDeciderColumnUI copy() {
      ReviewDeciderColumnUI newXCol = new ReviewDeciderColumnUI();
