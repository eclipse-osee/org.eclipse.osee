...
public class XTeamDefinitionComboWidget extends XComboViewerWidget {

   public static WidgetId ID = WidgetIdAts.XTeamDefinitionComboWidget;
   private Artifact selectedTeamDef = null;

   public XTeamDefinitionComboWidget() {
      super(ID, "Team Definition", SWT.READ_ONLY);
   }
