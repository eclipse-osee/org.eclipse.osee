...
public class RealignActionableItemsBlam extends AbstractAtsBlam {
   ...
   private XActionableItemComboWidget xActionableItemCombo;
   private XListDropViewerWidget xListDropViewer;
   private XCheckBoxWidget xPersistCheckBox;
   private XCheckBoxWidget xDeleteCheckBox;
   ...
   public void widgetCreated(XWidget xWidget, FormToolkit toolkit, Artifact art, XWidgetSwtRenderer swtXWidgetRenderer,
      ...
      if (xWidget.getLabel().equals(ACTIONABLE_ITEM_TO)) {
         ...
         xListDropViewer = (XListDropViewerWidget) xWidget;
      } else if (xWidget.getLabel().equals(PERSIST)) {
         xPersistCheckBox = (XCheckBoxWidget) xWidget;
         ...
         xDeleteCheckBox = (XCheckBoxWidget) xWidget;
         xDeleteCheckBox.setEditable(false);
      }
   }
