...
public class XHyperlinkFeatureArtWidget extends XAbstractHyperlinkLabelValueSelWidget {

   public static WidgetId ID = WidgetIdAts.XHyperlinkFeatureArtWidget;
   private IAtsTeamWorkflow teamWf;
   private final AtsApi atsApi;
   private String value = Widgets.NOT_SET;
   private Collection<Object> values;

   public XHyperlinkFeatureArtWidget() {
      this("Feature");
   }

   public XHyperlinkFeatureArtWidget(String label) {
      super(ID, label);
   ...
   public boolean handleSelection() {
      try {
         ...
         if (dialog.open() == Window.OK) {
            ...
            changes.setAttributeValues(teamWf, getAttributeType(), values);
            changes.execute();
         }
      } catch (Exception ex) {
   ...
   private Collection<FeatureDefinition> getSelectedFeatures() {
      ...
      values = atsApi.getAttributeResolver().getAttributeValues(teamWf, getAttributeType());
      if (!values.isEmpty()) {
   ...
   public void refresh() {
      ...
      if (values.isEmpty()) {
         ...
         final XHyperlinkFeatureArtWidget fHyperlinkFeatureDam = this;
   ...
   private final class ReloadJobChangeAdapter extends JobChangeAdapter {
      ...
      private final XHyperlinkFeatureArtWidget xHyperlinkFeatureDam;

      private ReloadJobChangeAdapter(XHyperlinkFeatureArtWidget xHyperlinkFeatureDam) {
