...
public final class TransitionListeners {
    ...
    * org.eclipse.osee.ats.ide.core.AtsTransitionListener extension point. <br/>
   ...
   public synchronized static List<ITransitionListener> getListeners() {
      if (!loaded) {
         ...
         ExtensionDefinedObjects<ITransitionListener> objects = new ExtensionDefinedObjects<>(
            "org.eclipse.osee.ats.ide.AtsTransitionListener", "AtsTransitionListener", "classname");
