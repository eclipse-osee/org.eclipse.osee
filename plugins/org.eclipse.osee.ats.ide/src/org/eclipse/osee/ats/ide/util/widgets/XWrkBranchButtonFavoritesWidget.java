...
public class XWrkBranchButtonFavoritesWidget extends XAbstractWrkBranchButtonWidget {

   public static final WidgetId ID = WidgetIdAts.XWrkBranchButtonFavoritesWidget;

   public XWrkBranchButtonFavoritesWidget() {
      super(ID);
   }
