...
import org.eclipse.osee.ats.ide.world.mini.XAbstractMiniWorldWidget;
 ...
 */
public abstract class XAbstractSiblingWorldArtWidget extends XAbstractMiniWorldWidget implements IArtifactEventListener, IArtifactTopicEventListener {

   protected IAtsTeamWorkflow teamWf;

   public XAbstractSiblingWorldArtWidget(WidgetId widgetId, XSiblingXViewerFactory xSiblingXViewerFactory) {
      super(widgetId, "Sibling Workflows", xSiblingXViewerFactory);
      OseeEventManager.addListener(this);
   }

   @Override
   public ToolBar createActionBar(Composite tableComp) {
      final XAbstractSiblingWorldArtWidget fWidget = this;
