 ...
 */
public class RemainingPointsNumericTotalColumnUI extends AbstractNumericTotalColumnUI {
   ...
   private static RemainingPointsNumericTotalColumnUI instance = new RemainingPointsNumericTotalColumnUI();

   public static RemainingPointsNumericTotalColumnUI getInstance() {
      return instance;
   }

   private RemainingPointsNumericTotalColumnUI() {
    ...
    */
   @Override
   public RemainingPointsNumericTotalColumnUI copy() {
      RemainingPointsNumericTotalColumnUI newXCol = new RemainingPointsNumericTotalColumnUI();
