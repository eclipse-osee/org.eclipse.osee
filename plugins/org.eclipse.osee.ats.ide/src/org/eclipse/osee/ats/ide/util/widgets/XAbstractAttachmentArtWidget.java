...
public abstract class XAbstractAttachmentArtWidget extends XLabelValueWidget {
   ...
   public XAbstractAttachmentArtWidget(WidgetId widgetId, String displayLabel, String configKey) {
      super(widgetId, displayLabel, configKey);
