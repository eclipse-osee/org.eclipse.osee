 ...
 * @author Shawn F. Cook
 */
public abstract class XAbstractWrkBranchButtonWidget extends XAbstractWrkBranchArtWidget {
   public XAbstractWrkBranchButtonWidget(WidgetId widgetId) {
      super(widgetId);
   }
   ...
   private Button createNewButton(Composite comp) {
      if (getToolkit() != null) {
         return getToolkit().createButton(comp, null, SWT.PUSH);
      }
