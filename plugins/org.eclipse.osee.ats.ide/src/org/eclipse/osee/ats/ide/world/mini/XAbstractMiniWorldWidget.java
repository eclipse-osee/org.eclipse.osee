 ...
 */
public abstract class XAbstractMiniWorldWidget extends XWidget {
   ...
   private XLabelValueWidget pointsLabel;
   private final IXViewerFactory xViewerFactory;

   public XAbstractMiniWorldWidget(WidgetId widgetId, String label, IXViewerFactory xViewerFactory) {
   ...
   private void redrawComposite() {
      ...
      try {
         ...
         if (getToolkit() != null && xWorldViewer.getStatusLabel() != null) {
            getToolkit().adapt(xWorldViewer.getStatusLabel(), false, false);
         }
