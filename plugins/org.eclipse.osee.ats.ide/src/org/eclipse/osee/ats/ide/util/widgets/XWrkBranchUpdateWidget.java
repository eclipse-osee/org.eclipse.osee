...
public class XWrkBranchUpdateWidget extends XAbstractWrkBranchButtonWidget {

   public static final WidgetId ID = WidgetIdAts.XWrkBranchUpdateWidget;

   public XWrkBranchUpdateWidget() {
      super(ID);
   }
   ...
   protected boolean isWidgetAllowedInCurrentState() {
      return isWidgetInState(XWrkBranchUpdateWidget.class.getSimpleName());
   }
