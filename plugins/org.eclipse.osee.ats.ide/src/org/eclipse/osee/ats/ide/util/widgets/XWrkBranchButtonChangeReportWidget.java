...
public class XWrkBranchButtonChangeReportWidget extends XAbstractWrkBranchButtonWidget {

   public static final WidgetId ID = WidgetIdAts.XWrkBranchButtonChangeReportWidget;

   public XWrkBranchButtonChangeReportWidget() {
      super(ID);
   }
