...
public class XWrkBranchButtonWordChangeReportWidget extends XAbstractWrkBranchButtonWidget {

   public static final WidgetId ID = WidgetIdAts.XWrkBranchButtonWordChangeReportWidget;

   public XWrkBranchButtonWordChangeReportWidget() {
      super(ID);
   }
