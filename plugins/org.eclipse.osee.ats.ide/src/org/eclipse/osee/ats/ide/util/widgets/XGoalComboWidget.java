...
public class XGoalComboWidget extends XComboViewerWidget {

   public static WidgetId ID = WidgetIdAts.XGoalComboWidget;
   private Artifact selectedGoal = null;

   public XGoalComboWidget() {
      super(ID, "Goal", SWT.READ_ONLY);
   }
