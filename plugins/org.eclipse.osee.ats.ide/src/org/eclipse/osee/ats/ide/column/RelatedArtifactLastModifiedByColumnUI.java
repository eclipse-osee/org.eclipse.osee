 ...
 */
public class RelatedArtifactLastModifiedByColumnUI extends XViewerAtsColumn implements IXViewerValueColumn {

   public static RelatedArtifactLastModifiedByColumnUI instance = new RelatedArtifactLastModifiedByColumnUI();

   public static RelatedArtifactLastModifiedByColumnUI getInstance() {
      return instance;
   }

   private RelatedArtifactLastModifiedByColumnUI() {
    ...
    */
   @Override
   public RelatedArtifactLastModifiedByColumnUI copy() {
      RelatedArtifactLastModifiedByColumnUI newXCol = new RelatedArtifactLastModifiedByColumnUI();
