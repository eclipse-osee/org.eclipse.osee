...
public class XUserRoleViewerWidget extends XWidget implements IArtifactEventListener, IArtifactTopicEventListener {

   public static WidgetId ID = WidgetIdAts.XUserRoleViewerWidget;
   ...
   protected void createControls(Composite parent, int horizontalSpan) {
      ...
      if (getToolkit() != null) {
         getToolkit().adapt(xViewer.getStatusLabel(), false, false);
      }
