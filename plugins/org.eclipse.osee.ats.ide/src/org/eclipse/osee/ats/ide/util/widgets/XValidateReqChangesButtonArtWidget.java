...
public class XValidateReqChangesButtonArtWidget extends XAbstractButtonWithLabelArtWidget {

   public static WidgetId ID = WidgetIdAts.XValidateReqChangesButtonArtWidget;
   private IAtsTeamWorkflow teamWf;
   private IAtsProgramManager programMgr;

   public XValidateReqChangesButtonArtWidget() {
      super(ID, "Validate Requirement Changes", "Click to validate requirement changes", AtsImage.PLAY_GREEN);
