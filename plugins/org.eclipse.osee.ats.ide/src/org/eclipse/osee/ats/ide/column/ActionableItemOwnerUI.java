 ...
 */
public class ActionableItemOwnerUI extends XViewerAtsColumn implements IXViewerValueColumn {

   public static ActionableItemOwnerUI instance = new ActionableItemOwnerUI();

   public static ActionableItemOwnerUI getInstance() {
      return instance;
   }

   protected ActionableItemOwnerUI() {
    ...
    */
   @Override
   public ActionableItemOwnerUI copy() {
      ActionableItemOwnerUI newXCol = new ActionableItemOwnerUI();
