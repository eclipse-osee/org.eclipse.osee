...
public class XHyperlinkSprintWidget extends XAbstractHyperlinkLabelCmdValueSelWidget {

   public static WidgetId ID = WidgetIdAts.XHyperlinkSprintWidget;
   protected IAgileSprint sprint;
   protected IAtsTeamWorkflow teamWf;
   protected IAtsTeamDefinition teamDef;
   AtsApi atsApi;

   public XHyperlinkSprintWidget() {
      this(ID);
   }

   public XHyperlinkSprintWidget(WidgetId widgetId) {
      super(widgetId, "Sprint", true, 50);
