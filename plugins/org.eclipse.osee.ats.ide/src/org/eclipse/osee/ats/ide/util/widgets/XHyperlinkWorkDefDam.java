...
public class XHyperlinkWorkDefDam extends XHyperlinkLabelValueSelection implements AttributeWidget {
   ...
   public String getCurrentValue() {
      if (artifact == null) {
         ...
         Long workDefId = atsApi.getAttributeResolver().getSoleAttributeValue(artifact, attributeTypeToken, null);
         if (workDefId == null) {
            value = "Not Set";
         } else {
      ...
      try {
         if (MessageDialog.openConfirm(AWorkbench.getActiveShell(), "Change Work Definition",
            ...
            if (dialog.open() == Window.OK) {
               ...
               changes.setSoleAttributeValue(artifact, attributeTypeToken, workDef.getId());
               changes.execute();
