...
public class AgileFeatureGroupColumnUI extends BackgroundLoadingPreComputedColumnUI implements IAtsWorldArtifactEventColumn {
   ...
   public static AgileFeatureGroupColumnUI getInstance() {
      return instance;
   }

   private AgileFeatureGroupColumnUI() {
      super(AtsColumnTokensDefault.AgileFeatureGroupColumn);
   }
    ...
    */
   @Override
   public AgileFeatureGroupColumnUI copy() {
      AgileFeatureGroupColumnUI newXCol = new AgileFeatureGroupColumnUI();
