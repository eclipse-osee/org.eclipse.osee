 ...
 */
public abstract class XAbstractCreateEscapeWfButtonArtWidget extends XButtonWidget {

   private TeamWorkFlowArtifact teamWf;
   boolean creating = false;
   protected AtsApi atsApi;

   public XAbstractCreateEscapeWfButtonArtWidget(WidgetId widgetId, String name) {
      super(widgetId, name);
