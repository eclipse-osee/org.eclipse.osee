 ...
 */
public class SiblingTeamDefColumn extends BackgroundLoadingPreComputedColumn {

   public static SiblingTeamDefColumn instance = new SiblingTeamDefColumn();
   private final List<String> teamDefs = new ArrayList<>();
   private boolean preloaded = false;

   public static SiblingTeamDefColumn getInstance() {
      return instance;
   }

   private SiblingTeamDefColumn() {
    ...
    */
   @Override
   public SiblingTeamDefColumn copy() {
      SiblingTeamDefColumn newXCol = new SiblingTeamDefColumn();
