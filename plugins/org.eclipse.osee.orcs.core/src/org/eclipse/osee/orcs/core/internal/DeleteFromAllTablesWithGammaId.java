...
public final class DeleteFromAllTablesWithGammaId {
   ...
   public static OrcsPurgeResult deleteAllGammas(JdbcClient client, String gammaQuery, List<Object> parameters,
      ...
      return new OrcsPurgeResult(
         "Counts: search_tags: " + purgeSearchTags + " txs:" + purgeTxs + " txsArchived: " + purgeTxsArchived + //
            ...
            + " tuple3: " + purgeTuple3 + " tuple4: " + purgeTuple4 + " artifact: " + purgeArtifact,
         false);
   }
