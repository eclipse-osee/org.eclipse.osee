...
public class OseeEmailServer extends OseeEmail {
   ...
   OseeEmailServer(Collection<String> toAddresses, String fromAddress, String replyToAddress, String subject, String body, BodyType bodyType, Collection<String> emailAddressesAbridged, String subjectAbridged, String bodyAbridged) {
      super(toAddresses, fromAddress, replyToAddress, subject, body, bodyType, emailAddressesAbridged, subjectAbridged,
         bodyAbridged);
   }

   OseeEmailServer(String fromEmail, String toAddress, String subject, String body, BodyType bodyType, String emailAddressesAbridged, String subjectAbridged, String bodyAbridged) {
