 ...
 */
public class Pdd82CreateCantLoadDiagramTreeActionTest extends AbstractPopulateDemoDatabaseTest {

   public Pdd82CreateCantLoadDiagramTreeActionTest(XResultData rd, AtsApi atsApi) {
      super(rd, atsApi);
   }
   ...
   public void run() {
      ...
      IAtsTeamWorkflow teamWf = atsApi.getQueryService().getTeamWf(DemoArtifactToken.CantLoadDiagramTree_TeamWf);
      ...
      testTeamContents(teamWf, DemoArtifactToken.CantLoadDiagramTree_TeamWf.getName(), "3", "",
         ...
         AtsArtifactTypes.DemoTestTeamWorkflow, getTeamDef(DemoArtifactToken.CIS_Test));
