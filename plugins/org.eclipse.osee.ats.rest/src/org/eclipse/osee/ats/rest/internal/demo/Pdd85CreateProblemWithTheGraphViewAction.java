...
public class Pdd85CreateProblemWithTheGraphViewAction extends AbstractPopulateDemoDatabase {
   ...
   public void run() {
      ...
      ActionResult actionResult = atsApi.getActionService().createAction(null,
         DemoArtifactToken.ProblemWithTheGraphView_TeamWf.getName(), "Problem with the Graph View", ChangeTypes.Problem,
         "1", false, null, aias, new Date(), atsApi.getUserService().getCurrentUser(),
