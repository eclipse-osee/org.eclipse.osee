...
public class DataRightsClassificationAttributeType extends AttributeTypeEnum<DataRightsClassificationEnum> {
   ...
   // @formatter:off
	public final DataRightsClassificationEnum RestrictedRights = new DataRightsClassificationEnum(0, "Restricted Rights");
	public final DataRightsClassificationEnum GovernmentPurposeRights = new DataRightsClassificationEnum(1, "Government Purpose Rights");
	...
	public final DataRightsClassificationEnum ExportControlledItar = new DataRightsClassificationEnum(6, "Export Controlled ITAR");
	// @formatter:on
