...
public interface CoreAttributeTypes {
   ...
   HazardSeverityAttributeType HazardSeverity = osee.createEnum(new HazardSeverityAttributeType());
   ...
   TestFrequencyAttributeType TestFrequency = osee.createEnum(new TestFrequencyAttributeType());
