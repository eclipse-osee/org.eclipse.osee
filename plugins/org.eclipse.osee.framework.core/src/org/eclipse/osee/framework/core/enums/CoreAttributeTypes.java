...
import org.eclipse.osee.framework.core.enums.token.InterfaceDataTypeAttribute;
import org.eclipse.osee.framework.core.enums.token.InterfaceElementUnitsAttribute;
...
public interface CoreAttributeTypes {
   ...
   InterfaceElementUnitsAttribute InterfaceElementUnits = osee.createEnum(new InterfaceElementUnitsAttribute());
   AttributeTypeString InterfaceConnectionPrimaryNode = osee.createString(7550463715158384533L, "Interface Primary Node", MediaType.TEXT_PLAIN, "");
   AttributeTypeString InterfaceConnectionSecondaryNode = osee.createString(7550463715158384534L, "Interface Secondary Node", MediaType.TEXT_PLAIN, "");
   AttributeTypeString InterfaceMessageNode = osee.createString(2455059983007225753L, "Interface Message Node", MediaType.TEXT_PLAIN, "");
   ...
   AttributeTypeString InterfaceInitiator = osee.createString(2455059983007225759L, "Interface Initiator", MediaType.TEXT_PLAIN, "");
   ...
   AttributeTypeInteger InterfaceSequenceNo = osee.createInteger(2455059983007225761L, "Interface Sequence Number", MediaType.TEXT_PLAIN, "");
   InterfaceDataTypeAttribute InterfaceElementDataType = osee.createEnum(new InterfaceDataTypeAttribute());
   AttributeTypeInteger InterfaceElementByteSize = osee.createInteger(2455059983007225786L, "Interface Element Byte Size", MediaType.TEXT_PLAIN, "");
   AttributeTypeString InterfaceElementValidRange = osee.createString(2455059983007225787L, "Interface Element Valid Range", MediaType.TEXT_PLAIN, "");
   AttributeTypeString InterfaceElementDefaultValue = osee.createString(2886273464685805413L, "Interface Element Default Value", MediaType.TEXT_PLAIN, "");
   ...
   AttributeTypeBoolean InterfaceElementIsArray = osee.createBoolean(2455059983007225800L, "Interface Element Is Array", MediaType.TEXT_PLAIN, "Element is an array.");
   ...
   AttributeTypeString InterfaceEnumLiteral = osee.createString(2455059983007225803L, "Interface Enum Description", MediaType.TEXT_PLAIN, "");
