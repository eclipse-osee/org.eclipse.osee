...
public class CoreAttributeTypes extends NamedIdentity implements IAttributeType {
   ...
   public static final CoreAttributeTypes FAVORITE_BRANCH = new CoreAttributeTypes("AAMFEbMnzS7P92knZKAA",
      "Favorite Branch");
   public static final CoreAttributeTypes GENERAL_STRING_DATA = new CoreAttributeTypes("AAMFEca+MB5ssx+Ax5wA",
      "General String Data");
   public static final CoreAttributeTypes NAME = new CoreAttributeTypes("AAMFEcF1AzV7PKuHmxwA", "Name");
   public static final CoreAttributeTypes NATIVE_CONTENT = new CoreAttributeTypes("AAMFEcdBJGBK9nr9TTQA",
      "Native Content");
   public static final CoreAttributeTypes NATIVE_EXTENSION =
      new CoreAttributeTypes("AAMFEcUbJEERZTnwJzAA", "Extension");
   public static final CoreAttributeTypes PARAGRAPH_NUMBER = new CoreAttributeTypes("AAMFEQ3boD3sp6VfArAA",
      "Imported Paragraph Number");
   public static final CoreAttributeTypes PHONE = new CoreAttributeTypes("AAMFEbUkVSwKu4LSpWAA", "Phone");
   public static final CoreAttributeTypes QUALIFICATION_METHOD = new CoreAttributeTypes("AAMFERMRKHkM9k_Rg2QA",
      "Qualification Method");
   public static final CoreAttributeTypes WHOLE_WORD_CONTENT = new CoreAttributeTypes("AAMFEchZmAzZo2tHjVAA",
      "Whole Word Content");
   public static final CoreAttributeTypes WORD_TEMPLATE_CONTENT = new CoreAttributeTypes("AAMFEcfcGS2V3SqQN2wA",
      "Word Template Content");
   public static final CoreAttributeTypes WORD_OLE_DATA = new CoreAttributeTypes("AAMFEcP2rmoCzqmzJxQA",
      "Word Ole Data");
   public static final CoreAttributeTypes RELATION_ORDER = new CoreAttributeTypes("ABM5kHa9cFsTbI_ooyQA",
      "Relation Order");
   ...
   public static final CoreAttributeTypes TEST_PROCEDURE_STATUS = new CoreAttributeTypes("AKkUuN2K1ilSHnvIMPQA",
      "Test Procedure Status");
   public static final CoreAttributeTypes USER_ID = new CoreAttributeTypes("AAMFEbKl8RCQr17bDAQA", "User Id");
   public static final CoreAttributeTypes VERIFICATION_LEVEL = new CoreAttributeTypes("AAMFEXRTkyKVIFqcMwQA",
      "Verification Level");
   ...
   public static final CoreAttributeTypes SAFETY_CRITICALITY = new CoreAttributeTypes("AAMFERg99R51HIz45HAA",
      "Safety Criticality");
