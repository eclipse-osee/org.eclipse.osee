...
public interface CoreAttributeTypes {
   ...
   AttributeTypeString EmailCertificateInstructions = osee.createString(9211057726662841963L, "Email Certificate Instructions", MediaType.TEXT_PLAIN, "Supplementary organization specific instructions for email certificates. Sent to users when a valid certificate is not available.");
   ...
   AttributeTypeLong RecentlyVisitedItemsKey = osee.createLong(419331594964206L, "Recently Visited Items Key", TEXT_PLAIN, "Key into OSEE_KEY_VALUE");
    ...
    * <dd>Attributes of this attribute type specify a CUI Category and CUI Type of the data contained in the controlled
    * artifact.</dd>
    ...
    * </dl>
    * The enumeration members are created from all permutations of the {@link CuiCategoryIndicator} and
    * {@link CuiTypeIndicator} enumerations. The allowable CUI Categories are defined by the
    * <a href="https://www.archives.gov/cui/registry/category-list" target="_blank">National Archives CUI Registry
    * Category List</a>
    */

   DataClassificationAttributeType DataClassification = osee.createEnum(DataClassificationAttributeType::new,
      DataClassificationAttributeType::getConfiguredNameAndDescription, 4024614255972662076L, MediaType.TEXT_PLAIN,
      NamespaceToken.OSEE, TaggerTypeToken.PlainTextTagger);

   /**
    * Attribute type for the CUI Category and CUI Type Rational.
    * <p>
    * This attribute is used by the {@link CoreArtifactTypes#Controlled} artifact to document the rationale for the
    * selected CUI Category and CUI Type pairs in the {@link CoreAttributeTypes#DataClassification} attribute for the
    * artifact with controlled data.
    * <dl>
    * <dt>Display Name:</dt>
    * <dd>
    * <dl>
    ...
    * <p>
    * This attribute is used by the {@link CoreArtifactTypes#Controlled} artifact to document the rationale for the
    * selected Required Indicators in the {@link CoreAttributeTypes#DataRightsClassification} attribute for the artifact
    ...
    * <dl>
    * <dt>{@link CoreArtifactTypes#Controlled}</dt>
    * <dd>Attributes of this attribute type specify the Required Indicator statements for a publishing containing the
    * controlled artifact.</dd>
    * <dt>{@link CoreArtifactTypes#DataRightsConfiguration}</dt>
    * <dd>Attributes of this attribute type specify globally required Required Indicator statements for the
    * publish.</dd></dt>
    * <dl>
    * <dt>Display Name:</dt>
    * <dl>
   ...
   DataRightsClassificationAttributeType DataRightsClassification =
      osee.createEnum(DataRightsClassificationAttributeType::new,
         DataRightsClassificationAttributeType::getConfiguredNameAndDescription, 1152921504606847317L,
         MediaType.TEXT_PLAIN, NamespaceToken.OSEE, TaggerTypeToken.PlainTextTagger);

   /**
    * This attribute type is used by the following artifact types:
    * <dl>
    * <dt>{@link CoreArtifactTypes#Controlled}:</dt>
    * <dd>Attributes of this attribute type specify a CUI Limited Dissemination Control for the data contained in the
    * controlled artifact.</dd>
    * <dt>{@link CoreArtifactTypes#DataRightsConfiguration}:</dt>
    * <dd>Attributes of this attribute type specify an allowed CUI Limited Dissemination Control for artifacts in a
    * publish.</dd>
    * </dl>
    * <dl>
    * <dt>Display Name:</dt>
   ...
   CuiLimitedDisseminationControlIndicatorAttributeType DataRightsCuiLimitedDisseminationControl =
      osee.createEnum(new CuiLimitedDisseminationControlIndicatorAttributeType());

   /**
    * Attribute type for mapping Required Indicators to CUI Category and CUI Type pairs.
    * <p>
    * This attribute is used by the {@link CoreArtifactTypes#DataRightsConfiguration} artifact to associated the
    * Required Indicators to the allowed CUI Category and CUI Type pairs for the publish.
    * <dl>
    * <dt>Display Name:</dt>
   ...
   AttributeTypeMapEntry DataRightsRequiredIndicatorByCuiCategoryCuiTypeMapEntry =
      osee.createMapEntry(428007622831294440L, "CUI Category CUI Type pairs to Required Indicators Map Entry",
         "JSON that defines a key (CUI Category and CUI Type) value (Required Indicator) map entry.",
         () -> "CUI Category and CUI Type", () -> "Required Indicator", "defaultKey", "defaultValue");

   /**
    * Attribute type for specifying the Required Indicator Configuration to be used for a Required Indicator.
    * <p>
    * This attribute is used by the {@link CoreArtifactTypes#DataRightsConfigurationArtifact} to map Required Indicators
    * for a publish to the Required Indicator Configuration to be used for each Required Indicator. The keys must be the
    * name of a {@link RequiredIndicatorIndicator} enumeration member. The values must be the name of a
   ...
   AttributeTypeMapEntry DataRightsRequiredIndicatorConfigurationByRequiredIndicatorMapEntry = osee.createMapEntry(
      194620179570089921L, "Required Indicator Configuration Entry",
      ...
      () -> "Required Indicator", () -> "Required Indicator Configuration", "defaultKey", "defaultValue");
    ...
    * specify the Footer Statement for a Required Indicator. The value of this attribute should be the name of an
   ...
   RequiredIndicatorFrequencyIndicatorAttributeType DataRightsRequiredIndicatorFrequencyIndicator =
      osee.createEnum(new RequiredIndicatorFrequencyIndicatorAttributeType(NamespaceToken.OSEE));

   /**
    * Attribute type for specifying the Header Statement for a Required Indicator.
    * <p>
    * This attribute is used by the {@link CoreArtifactTypes#DataRightsRequiredIndicatorConfiguration} artifact to
    * specify the Header Statement for a Required Indicator. The value of this attribute should be the name of an
    * {@link CoreArtifactTypes#DataRightsRequiredIndicatorStatement} artifact.
    * <dl>
    * <dt>Display Name:</dt>
    ...
    * <p>
    * This attribute is used by the {@link CoreArtifactTypes#DataRightsRequiredIndicatorStatement} to specify a Format
    * Indicator (key) and a statement (value) in the specified format.
    * <dl>
    * <dt>Display Name:</dt>
   ...
   AttributeTypeMapEntry DataRightsRequiredIndicatorStatementEntry =
      osee.createMapEntry(4689764541412006527L, "Required Indicator Statement Entry",
         "JSON that defines a key (Statement Format) value (Statement Text) map entry.", () -> "Statement Format",
         () -> "Statement Text", "defaultKey", "defaultValue");

   /**
    * Attribute type for specifying the Statement to be used on the title page for a Required Indicator.
    * <p>
    * This attribute is used by the {@link CoreArtifactTypes#DataRightsRequiredIndicatorConfiguration} artifact to
    * specify the Statement to be used on the title page for a Required Indicator. The value of this attribute should be
    * the name of an {@link CoreArtifactTypes#DataRightsRequiredIndicatorStatement} artifact.
    * <dl>
    * <dt>Display Name:</dt>
    ...
    * <dl>
    * <dt>{@link CoreArtifactTypes#Controlled}:</dt>
    * <dd>Attributes of this type specify the countries the data in a controlled artifact are allowed to be distributed
    * to.</dd>
    * <dt>{@link CoreArtifactTypes#DataRightsConfiguration}:</dt>
   ...
   TrigraphCountryCodeIndicatorAttributeType DataRightsTrigraphCountryCode =
      osee.createEnum(new TrigraphCountryCodeIndicatorAttributeType());
