...
public interface CoreAttributeTypes {
   ...
   AttributeTypeString InterfaceLevelsToUse = osee.createString(1668394842614655222L, "MIM Levels to Use", MediaType.TEXT_PLAIN, "String representation of an array of MIM artifact types in use ex. ['Connection','Node','Message','Submessage','Structure','Element','PlatformType','Enumeration Set','Enumeration']");
