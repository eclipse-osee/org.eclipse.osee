...
/**
 * JSON Deserializer for JSON encoded {@link IncludeMetadataAttributesDeserializer} objects.
 *
 * @author Loren K. Ashley
 */

public class IncludeMetadataAttributesDeserializer extends StdDeserializer<@NonNull IncludeMetadataAttributes> {
   ...
   public IncludeMetadataAttributesDeserializer() {
      super(IncludeMetadataAttributesDeserializer.class);
   }

   /**
    * Deserializes a JSON representation of a {@link IncludeMetadataAttributes} as follows:
    * <dl>
    * <dt>When the {@link IncludeMetadataAttributes} is deserialized from a serialized POJO:
    * <dt>
    ...
    *
    * </dd>
    * <dt>When the {@link IncludeMetadataAttributes} is deserialized from a {@link RendererMap}:
    * <dt>
    ...
    * @throws OseeCoreException when the JSON does not reference a valid {@link IncludeMetadataAttributes}.
    */

   @Override
   public @NonNull IncludeMetadataAttributes deserialize(@NonNull JsonParser jsonParser,
      ...
      var optionName =
         ( safeReadTree instanceof TextNode )
            ...
            : readTree.get(IncludeMetadataAttributes.jsonObjectName).asText();

      var includeMetadataAttributes =
            ...
            .orElseThrow
               (
                  () -> new OseeCoreException
                               (
                                  new Message()
                                         .title( "IncludeMetadataAttributes::deserialize, unknown option name." )
                                         .indentInc()
      ...
      //@formatter:on
      return Conditions.requireNonNull(includeMetadataAttributes);
   }
