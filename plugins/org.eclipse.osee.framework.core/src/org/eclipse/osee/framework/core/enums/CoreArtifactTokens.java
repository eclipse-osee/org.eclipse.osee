...
public final class CoreArtifactTokens {
   ...
   public static final ArtifactToken EnumeratedArtifactsFolder                   = ArtifactToken.valueOf(89216872, "Enumerated Artifacts", COMMON, Folder);
   ...
   public static final ArtifactToken SystemRequirementsFolderMarkdown            = ArtifactToken.valueOf(80702119, "System Requirements - Markdown", Folder);
   public static final ArtifactToken SubSystemRequirementsFolder                 = ArtifactToken.valueOf(119106, "SubSystem Requirements", Folder);
   public static final ArtifactToken SubSystemRequirementsFolderMarkdown         = ArtifactToken.valueOf(697897575, "SubSystem Requirements - Markdown", Folder);
