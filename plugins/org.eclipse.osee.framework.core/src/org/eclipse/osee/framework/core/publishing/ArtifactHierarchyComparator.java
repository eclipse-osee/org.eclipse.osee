 ...
 */
public final class ArtifactHierarchyComparator implements Comparator<ArtifactReadable> {
   ...
   private int getPosition(ArtifactReadable artifact) {
      var parent = artifact.getParent();
      var children = parentToChildrenCache.get(parent.getId());
      if (children == null) {
