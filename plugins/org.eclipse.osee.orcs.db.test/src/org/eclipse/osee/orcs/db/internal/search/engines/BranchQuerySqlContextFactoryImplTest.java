...
public class BranchQuerySqlContextFactoryImplTest {
   ...
   public void testQueryStateArchive() throws Exception {
      String expected = "SELECT br1.*\n" + //
         " FROM osee_branch br1, osee_join_id jid1\n" + //
         " WHERE br1.branch_state = jid1.id AND jid1.query_id = ? AND\n" + //
         "br1.archived = ?\n" + //
         " ORDER BY br1.branch_id";
   ...
   public void testQueryChildOf() {
      String expected = "WITH RECURSIVE chof1 (child_id, branch_level) AS ( \n" + //
         ...
         " )\n" + //
         "SELECT br1.*\n" + //
         " FROM chof1, osee_branch br1\n" + //
         " WHERE chof1.child_id = br1.branch_id\n" + //
         " ORDER BY br1.branch_id";
   ...
   public void testQueryAncestorOf() {
      String expected = "WITH RECURSIVE anstrof1 (parent_id, branch_level) AS ( \n" + //
         ...
         " )\n" + //
         "SELECT br1.*\n" + //
         " FROM anstrof1, osee_branch br1\n" + //
         " WHERE anstrof1.parent_id = br1.branch_id\n" + //
         " ORDER BY br1.branch_id";
   ...
   public void testMultiples() {
      String expected = "WITH RECURSIVE chof1 (child_id, branch_level) AS ( \n" + //
         ...
         " )\n" + //
         "SELECT br1.*\n" + //
         " FROM chof1, osee_branch br1, osee_join_id jid1\n" + //
         " WHERE chof1.child_id = br1.branch_id AND\n" + //
         "br1.branch_type = ? AND\n" + //
         "br1.branch_state = jid1.id AND jid1.query_id = ? AND\n" + //
         "br1.archived = ? AND\n" + //
   ...
   public void testMergeBranchFor() throws Exception {
      String expected = "SELECT br1.*\n" + //
         ...
         " WHERE mbr1.source_branch_id = ? AND mbr1.dest_branch_id = ? AND mbr1.merge_branch_id = br1.branch_id\n" + //
         " ORDER BY br1.branch_id";
