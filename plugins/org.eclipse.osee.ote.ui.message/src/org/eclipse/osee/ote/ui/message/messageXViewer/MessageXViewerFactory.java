...
public class MessageXViewerFactory extends XViewerFactory {
   ...
   public static XViewerColumn name =
         new XViewerColumn("osee.message.name", "Name", 200, SWT.LEFT, true, SortDataType.String, false, null);
   public static XViewerColumn psUpdateCount =
         new XViewerColumn("osee.message.udpates", "Updates", 60, SWT.LEFT, true, SortDataType.Integer, false, null);
   public static XViewerColumn value =
         new XViewerColumn("osee.message.value", "Value", 100, SWT.LEFT, true, SortDataType.String, false, null);
   public static XViewerColumn byteOffset =
         new XViewerColumn("osee.message.offset", "Offset", 50, SWT.LEFT, true, SortDataType.Integer, false, null);
   public static XViewerColumn msb =
         new XViewerColumn("osee.message.msb", "MSB", 50, SWT.LEFT, true, SortDataType.Integer, false, null);
   public static XViewerColumn lsb =
         new XViewerColumn("osee.message.lsb", "LSB", 50, SWT.LEFT, true, SortDataType.Integer, false, null);
   public static XViewerColumn bitSize =
         new XViewerColumn("osee.message.bitSize", "Bit Size", 60, SWT.LEFT, true, SortDataType.Integer, false, null);
   public static XViewerColumn elementType =
         new XViewerColumn("osee.message.type", "Type", 100, SWT.LEFT, true, SortDataType.String, false, null);
   ...
   public MessageXViewerFactory() {
      ...
      propertyStoreCustomizations =
            new FileStoreCustomizations(folder, "OteMessageWatch", ".xml", "DefaultMessageWatch.xml",
                  defaultCustomDataXml);
