		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getActionableItemDefAccess().getGroup_2_11(), "rule__ActionableItemDef__Group_2_11__0");
					put(grammarAccess.getActionableItemDefAccess().getGroup_2_11_2(), "rule__ActionableItemDef__Group_2_11_2__0");
					...
					put(grammarAccess.getProgramDefAccess().getArtifactTypeNameAssignment_5_1(), "rule__ProgramDef__ArtifactTypeNameAssignment_5_1");
					put(grammarAccess.getProgramDefAccess().getActiveAssignment_6_1(), "rule__ProgramDef__ActiveAssignment_6_1");
					put(grammarAccess.getProgramDefAccess().getNamespaceAssignment_7_1(), "rule__ProgramDef__NamespaceAssignment_7_1");
					put(grammarAccess.getProgramDefAccess().getTeamDefinitionAssignment_8_1(), "rule__ProgramDef__TeamDefinitionAssignment_8_1");
					put(grammarAccess.getProgramDefAccess().getAttributesAssignment_9_1(), "rule__ProgramDef__AttributesAssignment_9_1");
					...
					put(grammarAccess.getTeamDefAccess().getStaticIdAssignment_6_1(), "rule__TeamDef__StaticIdAssignment_6_1");
					...
					put(grammarAccess.getTeamDefAccess().getPrivilegedAssignment_9_1(), "rule__TeamDef__PrivilegedAssignment_9_1");
					put(grammarAccess.getTeamDefAccess().getWorkDefinitionAssignment_10_1(), "rule__TeamDef__WorkDefinitionAssignment_10_1");
					put(grammarAccess.getTeamDefAccess().getRelatedTaskWorkDefinitionAssignment_11_1(), "rule__TeamDef__RelatedTaskWorkDefinitionAssignment_11_1");
					put(grammarAccess.getTeamDefAccess().getTeamWorkflowArtifactTypeAssignment_12_1(), "rule__TeamDef__TeamWorkflowArtifactTypeAssignment_12_1");
					put(grammarAccess.getTeamDefAccess().getAccessContextIdAssignment_13_1(), "rule__TeamDef__AccessContextIdAssignment_13_1");
					put(grammarAccess.getTeamDefAccess().getVersionAssignment_14_1(), "rule__TeamDef__VersionAssignment_14_1");
					put(grammarAccess.getTeamDefAccess().getRulesAssignment_15_1(), "rule__TeamDef__RulesAssignment_15_1");
					put(grammarAccess.getTeamDefAccess().getChildrenAssignment_16_2_1(), "rule__TeamDef__ChildrenAssignment_16_2_1");
					...
					put(grammarAccess.getActionableItemDefAccess().getGuidAssignment_2_1_1(), "rule__ActionableItemDef__GuidAssignment_2_1_1");
					put(grammarAccess.getActionableItemDefAccess().getUuidAssignment_2_2_1(), "rule__ActionableItemDef__UuidAssignment_2_2_1");
					put(grammarAccess.getActionableItemDefAccess().getActiveAssignment_2_3_1(), "rule__ActionableItemDef__ActiveAssignment_2_3_1");
					put(grammarAccess.getActionableItemDefAccess().getActionableAssignment_2_4_1(), "rule__ActionableItemDef__ActionableAssignment_2_4_1");
					put(grammarAccess.getActionableItemDefAccess().getLeadAssignment_2_5_1(), "rule__ActionableItemDef__LeadAssignment_2_5_1");
					put(grammarAccess.getActionableItemDefAccess().getOwnerAssignment_2_6_1(), "rule__ActionableItemDef__OwnerAssignment_2_6_1");
					put(grammarAccess.getActionableItemDefAccess().getStaticIdAssignment_2_7_1(), "rule__ActionableItemDef__StaticIdAssignment_2_7_1");
					put(grammarAccess.getActionableItemDefAccess().getTeamDefAssignment_2_8_1(), "rule__ActionableItemDef__TeamDefAssignment_2_8_1");
					put(grammarAccess.getActionableItemDefAccess().getAccessContextIdAssignment_2_9_1(), "rule__ActionableItemDef__AccessContextIdAssignment_2_9_1");
					put(grammarAccess.getActionableItemDefAccess().getRulesAssignment_2_10_1(), "rule__ActionableItemDef__RulesAssignment_2_10_1");
					put(grammarAccess.getActionableItemDefAccess().getChildrenAssignment_2_11_2_1(), "rule__ActionableItemDef__ChildrenAssignment_2_11_2_1");
					...
					put(grammarAccess.getVersionDefAccess().getStaticIdAssignment_4_1(), "rule__VersionDef__StaticIdAssignment_4_1");
					put(grammarAccess.getVersionDefAccess().getNextAssignment_5_1(), "rule__VersionDef__NextAssignment_5_1");
					put(grammarAccess.getVersionDefAccess().getReleasedAssignment_6_1(), "rule__VersionDef__ReleasedAssignment_6_1");
					put(grammarAccess.getVersionDefAccess().getAllowCreateBranchAssignment_7_1(), "rule__VersionDef__AllowCreateBranchAssignment_7_1");
					put(grammarAccess.getVersionDefAccess().getAllowCommitBranchAssignment_8_1(), "rule__VersionDef__AllowCommitBranchAssignment_8_1");
					put(grammarAccess.getVersionDefAccess().getBaselineBranchUuidAssignment_9_1(), "rule__VersionDef__BaselineBranchUuidAssignment_9_1");
					put(grammarAccess.getVersionDefAccess().getParallelVersionAssignment_10_1(), "rule__VersionDef__ParallelVersionAssignment_10_1");
