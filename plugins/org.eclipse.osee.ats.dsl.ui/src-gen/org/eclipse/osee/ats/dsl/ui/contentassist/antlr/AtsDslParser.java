		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAtsDslAccess().getGroup_4(), "rule__AtsDsl__Group_4__0");
					...
					put(grammarAccess.getAtsDslAccess().getProgramAssignment_4_1(), "rule__AtsDsl__ProgramAssignment_4_1");
