		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTeamDefAccess().getGroup_12_2(), "rule__TeamDef__Group_12_2__0");
					...
					put(grammarAccess.getTeamDefAccess().getStaticIdAssignment_4_1(), "rule__TeamDef__StaticIdAssignment_4_1");
					put(grammarAccess.getTeamDefAccess().getLeadAssignment_5_1(), "rule__TeamDef__LeadAssignment_5_1");
					put(grammarAccess.getTeamDefAccess().getMemberAssignment_6_1(), "rule__TeamDef__MemberAssignment_6_1");
					put(grammarAccess.getTeamDefAccess().getPrivilegedAssignment_7_1(), "rule__TeamDef__PrivilegedAssignment_7_1");
					put(grammarAccess.getTeamDefAccess().getWorkDefinitionAssignment_8_1(), "rule__TeamDef__WorkDefinitionAssignment_8_1");
					put(grammarAccess.getTeamDefAccess().getRelatedTaskWorkDefinitionAssignment_9_1(), "rule__TeamDef__RelatedTaskWorkDefinitionAssignment_9_1");
					put(grammarAccess.getTeamDefAccess().getAccessContextIdAssignment_10_1(), "rule__TeamDef__AccessContextIdAssignment_10_1");
					put(grammarAccess.getTeamDefAccess().getVersionAssignment_11_1(), "rule__TeamDef__VersionAssignment_11_1");
					put(grammarAccess.getTeamDefAccess().getChildrenAssignment_12_2_1(), "rule__TeamDef__ChildrenAssignment_12_2_1");
					...
					put(grammarAccess.getVersionDefAccess().getReleasedAssignment_4_1(), "rule__VersionDef__ReleasedAssignment_4_1");
					put(grammarAccess.getVersionDefAccess().getAllowCreateBranchAssignment_5_1(), "rule__VersionDef__AllowCreateBranchAssignment_5_1");
					put(grammarAccess.getVersionDefAccess().getAllowCommitBranchAssignment_6_1(), "rule__VersionDef__AllowCommitBranchAssignment_6_1");
					put(grammarAccess.getVersionDefAccess().getBaselineBranchGuidAssignment_7_1(), "rule__VersionDef__BaselineBranchGuidAssignment_7_1");
					put(grammarAccess.getVersionDefAccess().getParallelVersionAssignment_8_1(), "rule__VersionDef__ParallelVersionAssignment_8_1");
