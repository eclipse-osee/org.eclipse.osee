...
public class LookupUpdates implements IRegistrarListener {
	...
	private final LookupViewer viewer;
	private final ReggieCache reggieCache;
	private final Map<ServiceID, IRenderer> handlerMap;
	private final Map<ServiceID, ServiceRegistrar> filteredReggieMap;
	private final Collection<ServiceRegistrar> unfilteredList;
