...
const routes: Routes = [
	{ path: '', component: MessagingComponent },
	{
		...
		loadChildren: () =>
			import(
				'./message-element-interface/message-element-interface.module'
			).then((m) => m.MessageElementInterfaceModule),
	},
	{
		path: ':branchType/:branchId/:connection/messages',
		title: connections?.pageTitle || 'OSEE',
		loadChildren: () =>
			import('./message-interface/message-interface.module').then(
				(m) => m.MessageInterfaceModule
			),
	},
	{
		path: 'types',
		...
		loadChildren: () =>
			import('./types-interface/types-interface.module').then(
				(m) => m.TypesInterfaceModule
			),
	},
	{
		path: 'connections',
		title: connections?.pageTitle || 'OSEE',
		loadChildren: () =>
			import('./connection-view/connection-view.module').then(
				(m) => m.ConnectionViewModule
			),
	},
	{
		path: 'typeSearch',
		...
		loadChildren: () =>
			import('./type-element-search/type-element-search.module').then(
				(m) => m.TypeElementSearchModule
			),
	},
	{
	...
	},
	{
		...
		loadChildren: () =>
			import('./messaging-help/messaging-help.module').then(
				(m) => m.MessagingHelpModule
			),
	},
	{
		path: 'structureNames',
		...
		loadChildren: () =>
			import('./structure-names/structure-names.module').then(
				(m) => m.StructureNamesModule
			),
	},
	{
