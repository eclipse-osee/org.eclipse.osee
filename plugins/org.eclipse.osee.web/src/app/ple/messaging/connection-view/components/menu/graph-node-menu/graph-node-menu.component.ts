...
export class GraphNodeMenuComponent implements OnInit {
  ...
  removeNodeAndConnection(value: nodeData|nodeDataWithChanges,sources:OseeEdge<connection | connectionWithChanges>[],targets:OseeEdge<connection | connectionWithChanges>[]) {
