...
describe('DiffReportService', () => {
  ...
  it('should get the branch info', () => {
    scheduler.run(() => {
      ...
      scheduler.expectObservable(service.branchInfo).toBe(expectedMarble, expectedObservable);
    })
  })
  ...
  it('should get the parent branch info', () => {
    scheduler.run(() => {
      let expectedObservable = { a: testBranchInfo };
      let expectedMarble = '(a|)';
      scheduler.expectObservable(service.parentBranchInfo).toBe(expectedMarble, expectedObservable);
    })
  })
  ...
  it('should get the branch summary', () => {
    scheduler.run(() => {
      ...
      let expectedMarble = '(a|)';
      scheduler.expectObservable(service.branchSummary).toBe(expectedMarble, expectedObservable);
    })
  })
  ...
  it('should get difference report', () => {
    scheduler.run(() => {
      ...
      let expectedMarble = '(a|)';
      scheduler.expectObservable(service.diffReport).toBe(expectedMarble, expectedObservable);
    })
  })
  ...
  it('should get the node differences', () => {
    scheduler.run(() => {
      ...
      let expectedMarble = '(a|)';
      scheduler.expectObservable(service.nodes).toBe(expectedMarble, expectedObservable);
    })
  })
  ...
  it('should get the connection differences', () => {
    scheduler.run(() => {
      ...
      let expectedMarble = '(a|)';
      scheduler.expectObservable(service.connections).toBe(expectedMarble, expectedObservable);
    })
  })
  ...
  it('should get the submessage differences', () => {
    scheduler.run(() => {
      ...
      let expectedMarble = '(a|)';
      scheduler.expectObservable(service.submessages).toBe(expectedMarble, expectedObservable);
    })
  })
  ...
  it('should get the element differences', () => {
    scheduler.run(() => {
      ...
      let expectedMarble = '(a|)';
      scheduler.expectObservable(service.elements).toBe(expectedMarble, expectedObservable);
    })
  })
  ...
  it('should get the structure differences including elements', () => {
    scheduler.run(() => {
      ...
      let expectedMarble = '(a|)';
      scheduler.expectObservable(service.structuresWithElements).toBe(expectedMarble, expectedObservable);
    })
  })
