...
describe('AffectedArtifactService', () => {
  ...
  it('should query affected EnumSets', () => {
    ...
    const req = httpTestingController.expectOne(apiURL+'/mim/branch/'+branchId+'/affected/enums/'+otherId);
  ...
  it('should query affected Platform Types', () => {
    ...
    const req = httpTestingController.expectOne(apiURL+'/mim/branch/'+branchId+'/affected/enumsets/'+otherId);
    expect(req.request.method).toEqual('GET');
    req.flush({});
    httpTestingController.verify();
  })
  ...
  it('should query affected Elements', () => {
    ...
    const req = httpTestingController.expectOne(apiURL+'/mim/branch/'+branchId+'/affected/types/'+otherId);
    expect(req.request.method).toEqual('GET');
    req.flush({});
    httpTestingController.verify();
  })
  ...
  it('should query affected Structures', () => {
    ...
    const req = httpTestingController.expectOne(apiURL+'/mim/branch/'+branchId+'/affected/elements/'+otherId);
    expect(req.request.method).toEqual('GET');
    req.flush({});
    httpTestingController.verify();
  })
  ...
  it('should query affected SubMessages', () => {
    ...
    const req = httpTestingController.expectOne(apiURL+'/mim/branch/'+branchId+'/affected/structures/'+otherId);
    expect(req.request.method).toEqual('GET');
    req.flush({});
    httpTestingController.verify();
  })
  ...
  it('should query affected Messages', () => {
    ...
    const req = httpTestingController.expectOne(apiURL+'/mim/branch/'+branchId+'/affected/submessages/'+otherId);
    expect(req.request.method).toEqual('GET');
    req.flush({});
    httpTestingController.verify();
  })
