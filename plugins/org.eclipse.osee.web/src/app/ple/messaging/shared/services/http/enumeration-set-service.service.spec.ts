...
describe('EnumerationSetServiceService', () => {
	...
	it('should create an enum set', () => {
		scheduler.run(() => {
			...
			scheduler
				.expectObservable(service.createEnumSet('10', {}, []))
	...
	it('should create an enum', () => {
		scheduler.run(() => {
			...
			const expectedMarble = '(a|)';
			scheduler
				.expectObservable(service.createEnum('10', {}, []))
				.toBe(expectedMarble, expectedFilterValues);
		});
	});
	...
	it('should change an enum set', () => {
		scheduler.run(() => {
			...
			const expectedMarble = '(a|)';
			scheduler
				.expectObservable(service.changeEnumSet('10', {}))
				.toBe(expectedMarble, expectedFilterValues);
		});
	});
	...
	it('should create EnumSet To PlatformType Relation', () => {
		scheduler.run(() => {
			...
			scheduler
				.expectObservable(
					service.createEnumSetToPlatformTypeRelation('10')
				)
				.toBe(expectedMarble, expectedFilterValues);
		});
	});
