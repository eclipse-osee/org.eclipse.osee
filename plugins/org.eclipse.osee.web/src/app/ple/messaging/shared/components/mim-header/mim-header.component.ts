...
@Component({
  selector: 'app-mim-header',
  templateUrl: './mim-header.component.html',
  styleUrls: ['./mim-header.component.sass'],
})
export class MimHeaderComponent implements OnInit {
  route = combineLatest([
              ...
              switchMap((detail) =>
                iif(
                        ...
                        iif(
                          ...
                          iif(
                            ...
                            this._structureService.structure.pipe(
                              switchMap((structure) =>
                                of([
                                  { displayName: type, routerLink: '/ple/messaging/' +
                                  'connections' +
                                  '/' +
                                  type },
                                  {
                                  ...
                                  {
                                    displayName: connectionDetails.name,
                                    routerLink:
                                      '/ple/messaging/' +
                                      type +
                                      '/' +
                            ...
                            of([
                              ...
                              {
                                displayName: submessageToStructureBreadCrumbs,
                                routerLink:
                                  '/ple/messaging/' +
                                  type +
                                  '/' +
                  ...
                  of([
                    ...
                    '/' +
                    type },
                    { displayName: detail.name, routerLink: type + '/' + id },
                  ])
                )
              )
            ),
