    ...
    features: [
      {
        ...
        configurations: [
          ...
          { id: '201326', name: '', value: 'A2543', values: [ 'A2543' ] }
        ],
      },
      {
        id: '758071644',
        ...
        configurations: [
          ...
          { id: '201326', name: '', value: 'Included', values: [ 'Included' ] }
        ],
      },
      {
        id: '130553732',
      ...
      },
      {
        ...
        configurations: [
          ...
          { id: '201326', name: '', value: 'SPKR_A', values: [ 'SPKR_A' ] }
        ],
      },
      {
        id: "201342",
      ...
      },
      {
        ...
        configurations: [
          { id: '200045', name: 'Product A', value: 'Included', values: ['Included'] },
          { id: '200046', name: 'Product B', value: 'Included', values: ['Included'] },
          { id: '200047', name: 'Product C', value: 'Included', values: ['Included'] },
          { id: '200048', name: 'Product D', value: 'Included', values: ['Included'] },
          { id: '201325', name: 'added view', value: 'Included', values: ['Included'] },
          { id: '201334', name: 'modified product app', value: 'Included', values: ['Included'] },
          { id: '201343', name: 'newconfig', value: 'Included', values: ['Included'] },
          { id: '201326', name: '', value: 'Included', values: ['Included'] },
          { id: '736857919', name: 'abGroup', value: 'Included', values: [ 'Included' ] },
          {
            id: "201322",
            name: "deleted group",
            value: 'Included',
          ...
          { id: '201321', name: 'test', value: 'Included', values: [ 'Included' ] }
        ],
    ...
    describe('diff tests', () => {
      ...
      it('should set difference', () => {
        ...
        scheduler.run(({ expectObservable }) => {
          expectObservable(service.differences).toBe('a',{a:[changeReportMock[0]]})
        })
      })
