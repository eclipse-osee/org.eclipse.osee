...
import {
	action,
	TransitionActionDialogData,
} from '../../types/pl-config-actions';

@Component({
	selector: 'osee-plconfig-transition-action-to-review-dialog',
...
export class TransitionActionToReviewDialogComponent {
	...
	constructor(
		...
		private userService: PlConfigUserService
	) {
