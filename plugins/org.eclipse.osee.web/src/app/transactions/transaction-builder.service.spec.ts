...
describe('TransactionBuilderService', () => {
  ...
  describe('Modifying artifacts', () => {
    ...
    it('should create a modification to an artifact without branch, or txComment', () => {
      expect(
        service.modifyArtifact(artifact1, undefined, undefined, undefined)
      ).toEqual(blankTransaction);
    });
    it('should create only 1 artifact', () => {
      expect(service.modifyArtifacts([artifact1], '10', 'Comment')).toEqual(
        testTransaction
      );
    });
  });
  ...
  describe('Deleting artifacts', () => {
    ...
    it('should delete multiple artifacts', () => {
      expect(service.deleteArtifacts(['12345','456'],'10','Comment')).toEqual({branch:'10',txComment:'Comment',deleteArtifacts:['12345','456']})
    })
  });

  it('should add a relation', () => {
    expect(service.addRelation('hello', '9', '7', '8', 'blah', undefined, '10', 'Comment')).toEqual({ branch: '10', txComment: 'Comment', addRelations: [{ typeName: 'hello', typeId: '9', aArtId: '7', bArtId: '8', rationale: 'blah' }] })
  });
  ...
  it('should add a relation and delete an artifact', () => {
    ...
    expect(service.addRelation('hello', '9', '7', '8', 'blah', prevTransaction, '10', 'Comment')).toEqual({ branch: '10', txComment: 'Comment',deleteArtifacts:['12345'], addRelations: [{ typeName: 'hello', typeId: '9', aArtId: '7', bArtId: '8', rationale: 'blah' }] })
  })

  it('should delete a relation', () => {
    expect(service.deleteRelation('hello', '9', '7', '8', 'blah', undefined, '10', 'Comment')).toEqual({ branch: '10', txComment: 'Comment', deleteRelations: [{ typeName: 'hello', typeId: '9', aArtId: '7', bArtId: '8', rationale: 'blah' }] })
  });
  ...
  it('should delete a relation and delete an artifact', () => {
    ...
    expect(service.deleteRelation('hello', '9', '7', '8', 'blah', prevTransaction, '10', 'Comment')).toEqual({ branch: '10', txComment: 'Comment',deleteArtifacts:['12345'], deleteRelations: [{ typeName: 'hello', typeId: '9', aArtId: '7', bArtId: '8', rationale: 'blah' }] })
  })
});
