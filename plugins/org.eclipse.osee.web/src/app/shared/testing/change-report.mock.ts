...
export const changeReportMock: changeInstance[] = [
	...
	},
	{
		...
		baselineVersion: {
			...
			value: '<OrderList><Order relType="Interface Message SubMessage Content" side="SIDE_B" orderType="AAT0xogoMjMBhARkBZQA" list="ABCkGXcC9BtOVW8ceggA,AAkKSN_MmEVt8yIw4sQA,ABEYW415xCGFe1Wi1NwA,ABIN5ZrPVFEVTDcmr9gA"/></OrderList>',
			uri: '',
			valid: true,
			applicabilityToken: {
				id: '1',
		...
		firstNonCurrentChange: {
			...
			gammaId: '20618',
			modType: ModificationType.MODIFIED,
			value: '<OrderList><Order relType="Interface Message SubMessage Content" side="SIDE_B" orderType="AAT0xogoMjMBhARkBZQA" list="ABCkGXcC9BtOVW8ceggA,AAkKSN_MmEVt8yIw4sQA"/></OrderList>',
			uri: '',
			valid: true,
			applicabilityToken: {
				id: '1',
		...
		currentVersion: {
			...
			gammaId: '20636',
			modType: ModificationType.MODIFIED,
			value: '<OrderList><Order relType="Interface Message SubMessage Content" side="SIDE_B" orderType="AAT0xogoMjMBhARkBZQA" list="ABCkGXcC9BtOVW8ceggA,AAkKSN_MmEVt8yIw4sQA,ABI4Dl_6DDaQ4SDceEQA"/></OrderList>',
			uri: '',
			valid: true,
			applicabilityToken: {
				id: '1',
	...
	},
	{
		...
		baselineVersion: {
			...
			gammaId: '20597',
			modType: ModificationType.MODIFIED,
			value: '<OrderList><Order relType="Interface Message SubMessage Content" side="SIDE_B" orderType="AAT0xogoMjMBhARkBZQA" list="AAkKSN_MmEVt8yIw4sQA,ABIJ5OzfJC_6z3a8cjQA"/></OrderList>',
			uri: '',
			valid: true,
			applicabilityToken: {
				id: '1',
		...
		currentVersion: {
			...
			gammaId: '20631',
			modType: ModificationType.MODIFIED,
			value: '<OrderList><Order relType="Interface Message SubMessage Content" side="SIDE_B" orderType="AAT0xogoMjMBhARkBZQA" list="AAkKSN_MmEVt8yIw4sQA,ABIJ5OzfJC_6z3a8cjQA,ABI4Dl_6DDaQ4SDceEQA"/></OrderList>',
			uri: '',
			valid: true,
			applicabilityToken: {
				id: '1',
