...
describe('PLConfig - Changing Applicabilities', () => {
    ...
    it('should change Product K- Custom Feature', () => {
        cy.changeApplicability('CUSTOM_FEATURE', false, 'Product K', 'Excluded', 'Included');
    })
    it('should change Product F- Custom Feature', () => {
        cy.changeApplicability('CUSTOM_FEATURE', false, 'Product F', 'Excluded', 'Included');
    })
    it('should change Product E - Custom Feature 2', () => {
        cy.changeApplicability('CUSTOM_FEATURE2', true, 'Product E', ['VALUE_3'], ['VALUE_3','VALUE_2']);
    })
    it('should change Product C - Custom Feature 2', () => {
        cy.changeApplicability('CUSTOM_FEATURE2', true, 'Product L', ['VALUE_3'], ['VALUE_2']);
    })
    it('should change Product F - Custom Feature 2', () => {
        cy.changeApplicability('CUSTOM_FEATURE2', true, 'Product F', ['VALUE_3'], ['VALUE_3','VALUE_2']);
    })
    it('should change Product A - Custom Feature 2', () => {
        cy.changeApplicability('CUSTOM_FEATURE2', true, 'Product A', ['VALUE_3'], ['VALUE_2']);
    })
})