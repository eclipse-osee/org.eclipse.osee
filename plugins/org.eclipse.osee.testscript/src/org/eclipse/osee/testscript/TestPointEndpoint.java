...
@Path("point")
@Swagger
public interface TestPointEndpoint {
   @GET()
   @Produces(MediaType.APPLICATION_JSON)
   /**
    * @return all rates matching criteria
    */
   Collection<TestPointToken> getAllTestPointTypes(@QueryParam("filter") String filter,
   ...
   @Produces(MediaType.APPLICATION_JSON)
   /**
    * @return all Test Points types matching criteria
    */
    ...
    */
   TestPointToken getTestPointType(@PathParam("id") ArtifactId testPointTypeId);
