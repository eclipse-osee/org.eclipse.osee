...
CREATE INDEX OSEE_ATTRIBUTE_ATT_IDX ON OSEE_ATTRIBUTE (ATTR_TYPE_ID);
...
CREATE INDEX OSEE_ATTRIBUTE_G_IDX ON OSEE_ATTRIBUTE (GAMMA_ID);
CREATE INDEX OSEE_ATTRIBUTE_AT_IDX ON OSEE_ATTRIBUTE (ATTR_ID);
...
INSERT INTO OSEE_TXS (TX_CURRENT, MOD_TYPE, BRANCH_ID, TRANSACTION_ID, GAMMA_ID) VALUES (1,1,1,2,1);
