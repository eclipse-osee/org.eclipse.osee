...
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaAllBranches;
...
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaBranchAncestorOf;
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaBranchArchived;
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaBranchCategory;
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaBranchChildOf;
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaBranchIds;
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaBranchName;
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaBranchOrderByName;
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaBranchPermission;
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaBranchState;
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaBranchType;
...
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaMergeBranchFor;
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaNotRelatedTo;
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaOrderByBranchId;
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaPagination;
import org.eclipse.osee.orcs.search.ds.criteria.CriteriaRelatedRecursive;
...
public final class SqlHandlerFactoryUtil {
   ...
   private static void addBranchHandlers(Map<Class<? extends Criteria>, Class<? extends SqlHandler<?>>> handleMap) {
      ...
      handleMap.put(CriteriaBranchPermission.class, BranchPermissionSqlHandler.class);
   }
