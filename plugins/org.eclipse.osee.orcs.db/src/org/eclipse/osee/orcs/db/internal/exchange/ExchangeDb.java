...
public final class ExchangeDb {
   ...
   List<AbstractExportItem> createTaskList() throws OseeCoreException {
      ...
      addExportItem(ExportItem.OSEE_BRANCH_DATA, BRANCH_TABLE_QUERY);
      addExportItem(ExportItem.OSEE_TX_DETAILS_DATA, TX_DETAILS_TABLE_QUERY);
      addExportItem(ExportItem.OSEE_TXS_DATA, TXS_TABLE_QUERY);
      addExportItem(ExportItem.OSEE_TXS_ARCHIVED_DATA, TXS_ARCHIVE_TABLE_QUERY);
      addExportItem(ExportItem.OSEE_ARTIFACT_DATA, ARTIFACT_TABLE_QUERY);
      addExportItem(ExportItem.OSEE_ATTRIBUTE_DATA, ATTRIBUTE_TABLE_QUERY);
      addExportItem(ExportItem.OSEE_RELATION_LINK_DATA, RELATION_LINK_TABLE_QUERY);
      addExportItem(ExportItem.OSEE_MERGE_DATA, MERGE_TABLE_QUERY);
      addExportItem(ExportItem.OSEE_CONFLICT_DATA, CONFLICT_TABLE_QUERY);
      addExportItem(ExportItem.OSEE_BRANCH_ACL_DATA, BRANCH_ACL_QUERY);
      addExportItem(ExportItem.OSEE_ARTIFACT_ACL_DATA, ARTIFACT_ACL_QUERY);
      return items;
   }
