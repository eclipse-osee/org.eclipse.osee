...
public final class IndexBranchesDatabaseCallable extends AbstractDatastoreCallable<Integer> {
   ...
   private static final String FIND_MISSING =
      FIND_ALL_TAGGABLE_ATTRIBUTES + " AND att.gamma_id NOT IN (SELECT gamma_id FROM osee_search_tags_hash)";

   private static final String COUNT_MISSING =
      FIND_ALL_TAGGABLE_ATTRIBUTES_REPLACE + " AND att.gamma_id NOT IN (SELECT gamma_id FROM osee_search_tags_hash)";
   ...
   private static final String FIND_MISSING_BY_BRANCH =
      FIND_TAGGABLE_ATTRIBUTES_BY_BRANCH + " AND att.gamma_id NOT IN (SELECT gamma_id FROM osee_search_tags_hash)";

   private static final String COUNT_MISSING_BY_BRANCH =
      COUNT_TAGGABLE_ATTRIBUTES_BY_BRANCH + " AND att.gamma_id NOT IN (SELECT gamma_id FROM osee_search_tags_hash)";
