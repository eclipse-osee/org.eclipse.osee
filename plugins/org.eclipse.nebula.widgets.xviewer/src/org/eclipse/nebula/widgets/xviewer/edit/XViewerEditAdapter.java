...
public class XViewerEditAdapter {
   ...
   void setInput(Control c) {
      ...
      if (fitInCell) {
         ...
         if (orientationStyle == SWT.RIGHT_TO_LEFT || orientationStyle == SWT.RIGHT) {
   ...
   /**
    * controls the positioning of the input control in the case the CellEditDescriptor Control does not take up the
    * whole cell space. Default value assumes right placement.
    *
    * @param style
    */
