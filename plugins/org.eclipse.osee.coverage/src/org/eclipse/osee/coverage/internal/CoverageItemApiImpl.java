 ...
 */
public class CoverageItemApiImpl implements CoverageItemApi {
   private ArtifactAccessor<CoverageItemToken> accessor;
   private final List<AttributeTypeId> attributes;
   public CoverageItemApiImpl(OrcsApi orcsApi) {
      this.setAccessor(new CoverageItemAccessor(orcsApi));
      attributes = new LinkedList<AttributeTypeId>();
      attributes.add(CoreAttributeTypes.Name);
   }

   private void setAccessor(ArtifactAccessor<CoverageItemToken> scriptDefTypeAccessor) {
      this.accessor = scriptDefTypeAccessor;
   }

   @Override
   public CoverageItemToken get(BranchId branch, ArtifactId scriptDefTypeId) {
      try {
         return this.accessor.get(branch, scriptDefTypeId);
      } catch (Exception ex) {
         return new CoverageItemToken(ex);
      }
   }

   @Override
   public Collection<CoverageItemToken> getAll(BranchId branch) {
      return this.getAll(branch, ArtifactId.SENTINEL);
   }

   @Override
   public Collection<CoverageItemToken> getAll(BranchId branch, ArtifactId viewId) {
   ...
   @Override
   public Collection<CoverageItemToken> getAll(BranchId branch, AttributeTypeId orderByAttribute) {
      return this.getAll(branch, ArtifactId.SENTINEL, orderByAttribute);
   }

   @Override
   public Collection<CoverageItemToken> getAll(BranchId branch, ArtifactId viewId, AttributeTypeId orderByAttribute) {
      return this.getAll(branch, viewId, new LinkedList<>(), 0L, 0L, orderByAttribute);
   }

   @Override
   public Collection<CoverageItemToken> getAll(BranchId branch, ArtifactId viewId, List<FollowRelation> followRelations,
      AttributeTypeId orderByAttribute) {
      return this.getAll(branch, viewId, followRelations, 0L, 0L, orderByAttribute);
   }

   @Override
   public Collection<CoverageItemToken> getAll(BranchId branch, long pageNum, long pageSize) {
      return this.getAll(branch, ArtifactId.SENTINEL, new LinkedList<>(), pageNum, pageSize, AttributeTypeId.SENTINEL);
   }

   @Override
   public Collection<CoverageItemToken> getAll(BranchId branch, ArtifactId viewId, long pageNum, long pageSize) {
   ...
   public Collection<CoverageItemToken> getAll(BranchId branch, ArtifactId viewId, List<FollowRelation> followRelations,
      ...
      try {
         ...
         return new LinkedList<CoverageItemToken>();
      }
   }

   @Override
   public Collection<CoverageItemToken> getAll(BranchId branch, Collection<FollowRelation> followRelations,
   ...
   @Override
   public Collection<CoverageItemToken> getAllByFilter(BranchId branch, String filter) {
   ...
   @Override
   public Collection<CoverageItemToken> getAllByFilter(BranchId branch, ArtifactId viewId, String filter) {
   ...
   @Override
   public Collection<CoverageItemToken> getAllByFilter(BranchId branch, String filter, long pageNum, long pageSize) {
      return this.getAllByFilter(branch, ArtifactId.SENTINEL, filter, pageNum, pageSize);
   }

   @Override
   public Collection<CoverageItemToken> getAllByFilter(BranchId branch, ArtifactId viewId, String filter, long pageNum,
      long pageSize) {
   ...
   public Collection<CoverageItemToken> getAllByFilter(BranchId branch, String filter,
      ...
      try {
         ...
         Collection<CoverageItemToken> failedList = new LinkedList<>();
         failedList.add(new CoverageItemToken(ex));
         return failedList;
      }
   }
