...
@Path("def")
@Swagger
public interface PartitionDefEndpoint {
   @GET()
   @Produces(MediaType.APPLICATION_JSON)
   Collection<PartitionDefToken> getAllPartitionDefs(@QueryParam("filter") String filter,
   ...
   @Path("{id}")
   @Produces(MediaType.APPLICATION_JSON)
   PartitionDefToken getPartitionDef(@PathParam("id") ArtifactId partitionDefId);
