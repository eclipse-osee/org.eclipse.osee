...
@Path("item")
@Swagger
public interface CoverageItemEndpoint {
   @GET()
   @Produces(MediaType.APPLICATION_JSON)
   Collection<CoverageItemToken> getAllCoverageItems(@QueryParam("filter") String filter,
   ...
   @Path("{id}")
   @Produces(MediaType.APPLICATION_JSON)
   CoverageItemToken getCoverageItem(@PathParam("id") ArtifactId coverageItemId);
