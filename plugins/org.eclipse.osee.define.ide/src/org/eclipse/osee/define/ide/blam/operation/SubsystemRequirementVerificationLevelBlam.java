...
public class SubsystemRequirementVerificationLevelBlam extends AbstractBlam {
   ...
   private class SubsystemRequirement {
      ...
      private void adjustVerificationLevel() {
         ...
         req.persist(SubsystemRequirementVerificationLevelBlam.this.transaction);
      }

      public void report() {
         SubsystemRequirementVerificationLevelBlam.this.addReportRow(req.getName(), subsystem, paragraphNumber,
