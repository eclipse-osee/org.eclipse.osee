...
public class PublishWithSpecifiedTemplateBlam extends AbstractBlam {
   ...
   public void runOperation(VariableMap variableMap, IProgressMonitor monitor) throws Exception {
      ...
      var primaryPublishingTemplateSafeName = variableMap.getString(PublishWithSpecifiedTemplateBlam.PRIMARY_TEMPLATE);

      //@formatter:off
      if(    Strings.isInvalidOrBlank(primaryPublishingTemplateSafeName)
          || PublishWithSpecifiedTemplateBlam.NOT_SELECTED.equals( primaryPublishingTemplateSafeName ) ) {
      ...
      var secondaryPublishingTemplateSafeName = variableMap.getString(PublishWithSpecifiedTemplateBlam.SECONDARY_TEMPLATE);

      //@formatter:off
      var secondaryPublishingTemplate =
         (    Strings.isValidAndNonBlank( secondaryPublishingTemplateSafeName )
           && !PublishWithSpecifiedTemplateBlam.NOT_SELECTED.equals( secondaryPublishingTemplateSafeName ) )
      ...
      List<Artifact> artifacts = variableMap.getArtifacts(PublishWithSpecifiedTemplateBlam.ARTIFACTS);
   ...
   public void widgetCreated(XWidget xWidget, FormToolkit toolkit, Artifact art, XWidgetSwtRenderer swtXWidgetRenderer,
      ...
      if (xWidget.getLabel().equals(RendererOption.WAS_BRANCH.getKey())) {
         ...
         final XComboWidget parentCombo = (XComboWidget) xWidget;
         ...
         childWidget = (XComboWidget) xWidget;
         childWidget.setEnabled(false);
      } else if (xWidget.getLabel().equals(ARTIFACTS)) {
         artifactsWidget = (XListDropViewerWidget) xWidget;
         artifactsWidget.setEditable(true);
         ...
         dataRightsWidget = (XComboWidget) xWidget;
         dataRightsWidget.setEnabled(false);
      }
   }
