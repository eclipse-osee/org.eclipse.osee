...
public class RemoveTraceMarksFromTraceUnitsBlam extends AbstractBlam {
   ...
   public String getXWidgetsXml() {
      ...
      sb.append("<XWidget xwidgetType=\"XFileSelectionDialog\" displayName=\"Select File\" />");
      sb.append("<XWidget xwidgetType=\"XTextWithFileSelDialogWidget\" displayName=\"Select Folder\" />");
      sb.append("<XWidget xwidgetType=\"XLabel\" displayName=\"Select Trace Types:\"/>");
      //      for (TraceHandler handler : getTraceHandlers()) {
      //         sb.append(getOperationsCheckBoxes(handler.getName()));
      //      }
      sb.append(
   ...
   public List<XWidgetData> getXWidgetItems() {
      createWidgetBuilder();
      wb.andWidget("Select File Or Folder (file can have a list of folders separated by newlines)",
         WidgetId.XLabelWidget);
      wb.andWidget(WidgetId.XTextWithFileSelDialogWidget);
      wb.andWidget(WidgetId.XTextWithDirSelDialogWidget);
      // TBD add persist
      ...
      wb.andBranchSelWidget("Requirements Branch").andToolTip("Select a requirements branch.");
