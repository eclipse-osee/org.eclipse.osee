...
public class AddTraceMarksToTraceUnitsBlam extends AbstractBlam {

   private static final Pattern commentPattern =
      Pattern.compile("/\\*\\s*\\*\\s*SCRIPT TRACEABILITY.*?\\*/", Pattern.DOTALL);
   private static final String DESC = "Select File Or Folder (file can have a list of folders separated by newlines)";
   ...
   public List<XWidgetData> getXWidgetItems() {
      createWidgetBuilder();
      wb.andWidget(DESC, WidgetId.XLabelWidget);
