...
public class PublishSubsystemToDesignTraceabilityBlam extends AbstractBlam {
   ...
   private XListDropViewerWidget viewerWidget;
   ...
   public List<XWidgetData> getXWidgetItems() {
      createWidgetBuilder();
      wb.andWidget("Subsystem Root Artifacts", WidgetId.XListDropViewerWidget);
   ...
   public void widgetCreated(XWidget xWidget, FormToolkit toolkit, Artifact art, XWidgetSwtRenderer swtXWidgetRenderer,
      ...
      if (xWidget.getLabel().equals(SUBSYSTEM_ROOT_ARTIFACTS)) {
         viewerWidget = (XListDropViewerWidget) xWidget;
