...
public class SubsystemToLowLevelReqTraceReportBlam extends AbstractBlam {
   ...
   private XListDropViewerWidget lowerLevel;
   ...
   public SubsystemToLowLevelReqTraceReportBlam() {
   ...
   public List<XWidgetData> getXWidgetItems() {
      createWidgetBuilder();
      wb.andWidget(LOW_LEVEL_REQUIREMENTS, WidgetId.XListDropViewerWidget);
      wb.andWidget("Allocation Components", WidgetId.XListDropViewerWidget);
      wb.andArtifactTypeWidget("Low Level Requirement Type(s)").andMultiSelect();
   ...
   public void widgetCreated(XWidget xWidget, FormToolkit toolkit, Artifact art, XWidgetSwtRenderer swtXWidgetRenderer,
      ...
      if (xWidget.getLabel().equals(LOW_LEVEL_REQUIREMENTS)) {
         lowerLevel = (XListDropViewerWidget) xWidget;
