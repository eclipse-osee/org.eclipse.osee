 ...
 */
public class BranchExportServlet extends HttpServlet {

   private static final long serialVersionUID = 2770977978546862559L;
   ...
   protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      try {
         ...
         OseeLog.log(Activator.class, Level.SEVERE, String.format(
               "Failed to respond to a branch export servlet request [%s]", req.toString()), ex);
