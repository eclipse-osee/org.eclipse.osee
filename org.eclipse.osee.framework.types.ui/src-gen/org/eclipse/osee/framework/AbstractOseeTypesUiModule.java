...
import org.eclipse.osee.framework.OseeTypesRuntimeModule;

/**
 * Manual modifications go to {org.eclipse.osee.framework.OseeTypesUiModule}
 */
public abstract class AbstractOseeTypesUiModule extends OseeTypesRuntimeModule {
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.HIGHLIGHTING)).to(org.eclipse.osee.framework.parser.antlr.internal.InternalOseeTypesLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return org.eclipse.osee.framework.labeling.OseeTypesLabelProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.transformer.ISemanticModelTransformer> bindISemanticModelTransformer() {
		return org.eclipse.osee.framework.outline.OseeTypesTransformer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.actions.IContentOutlineNodeAdapterFactory> bindIContentOutlineNodeAdapterFactory() {
		return org.eclipse.osee.framework.outline.OseeTypesOutlineNodeAdapterFactory.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.core.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return org.eclipse.osee.framework.contentassist.OseeTypesProposalProvider.class;
	}
	...
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.osee.framework.contentassist.antlr.internal.InternalOseeTypesLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(org.eclipse.osee.framework.contentassist.antlr.internal.InternalOseeTypesLexer.class));
	}

	// contributed by de.itemis.xtext.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.common.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.CONTENT_ASSIST)).to(org.eclipse.osee.framework.contentassist.antlr.internal.InternalOseeTypesLexer.class);
	}
