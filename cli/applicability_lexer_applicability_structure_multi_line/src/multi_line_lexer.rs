    ...
    fn default_multi_line_comment_with_complex_feature_tag_with_default_multi_line_comment_with_complex_not_configuration_tag()
     {
        ...
        let result: ResultType<&str> = Ok((
            ...
            vec![
                ...
                LexerToken::Configuration(((50, 1), (64, 1))),
    ...
    fn default_multi_line_comment_with_configuration_group_switch() {
        ...
        let result: ResultType<&str> = Ok((
            ...
            vec![
                ...
                LexerToken::ConfigurationGroupSwitch(((0, 1), (39, 1))),
 ...
 */",
        ...
        let result: ResultType<&str> = Ok((
            ...
            vec![
                ...
                LexerToken::Feature(((0, 1), (27, 4))),
                LexerToken::StartBrace(((27, 4), (28, 4))),
                LexerToken::Tag(
                    unsafe { LocatedSpan::new_from_raw_offset(28, 4, "ABCD", ()) },
                    ((28, 4), (32, 4)),
                ),
                LexerToken::EndBrace(((32, 4), (33, 4))),
                LexerToken::Text(
                    unsafe { LocatedSpan::new_from_raw_offset(33, 4, "\n    More text here", ()) },
                    ((33, 4), (52, 5)),
                ),
                LexerToken::EndFeature(((52, 5), (64, 6))),
                LexerToken::Text(
                    unsafe { LocatedSpan::new_from_raw_offset(64, 6, "\n    Other text", ()) },
                    ((64, 6), (79, 7)),
                ),
                LexerToken::Feature(((79, 7), (87, 8))),
                LexerToken::StartBrace(((87, 8), (88, 8))),
                LexerToken::Tag(
                    unsafe { LocatedSpan::new_from_raw_offset(88, 8, "ABCD=Included", ()) },
                    ((88, 8), (101, 8)),
                ),
                LexerToken::EndBrace(((101, 8), (102, 8))),
                LexerToken::Text(
                    unsafe { LocatedSpan::new_from_raw_offset(102, 8, "\n    text2", ()) },
                    ((102, 8), (112, 9)),
                ),
                LexerToken::EndFeature(((112, 9), (151, 14))),
                LexerToken::Text(
                    unsafe {
                        LocatedSpan::new_from_raw_offset(
                            124,
