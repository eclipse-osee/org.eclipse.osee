...
pub trait ConfigGroupBaseMultiLine {
    fn get_config_group_base<I, E>(&self) -> impl Parser<I, Output = Vec<LexerToken<I>>, Error = E>
    where
        I: Input
        ...
        I::Item: AsChar,
        E: ParseError<I>;
    fn get_config_group_base_multi_line<I, E>(
        &self,
...
impl<T> ConfigGroupBaseMultiLine for T
where
    T: LexConfigurationGroupBase + LexSpace + LexTab + TagMultiLine,
{
    fn get_config_group_base<I, E>(&self) -> impl Parser<I, Output = Vec<LexerToken<I>>, Error = E>
    where
        I: Input
        ...
        E: ParseError<I>,
    {
        ...
        self.lex_config_group_base_multi_line()
            .and(many0(self.lex_space().or(self.lex_tab())))
            .and(tag)
            .map(|((f, mut spaces), t)| {
                spaces.insert(0, f);
