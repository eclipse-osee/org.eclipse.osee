...
pub fn lex_config_not_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
...
pub fn lex_config_switch_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
...
pub fn lex_config_case_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
...
pub fn lex_config_else_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
...
pub fn lex_end_config_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
