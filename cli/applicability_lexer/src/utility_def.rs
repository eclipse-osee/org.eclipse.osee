 ...
 */
pub fn lex_space_def<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_unix_new_line_def<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_carriage_return_def<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_start_brace_def<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_end_brace_def<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_start_paren_def<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_end_paren_def<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_not_def<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_and_def<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_or_def<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_start_comment_single_line<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_end_comment_single_line<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_start_comment_multi_line<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_end_comment_multi_line<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 * This function will be responsible for parsing a end comment (multi line)
 */
pub fn lex_multi_line_comment_character<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_start_single_line_comment<I>(inner: impl Parser<I>) -> impl Parser<I> {
 ...
 */
pub fn lex_eof<I>(inner: impl Parser<I>) -> impl Parser<I> {
