...
pub fn lex_feature_not_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
...
pub fn lex_feature_switch_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
...
pub fn lex_feature_case_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
...
pub fn lex_feature_else_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
...
pub fn lex_end_feature_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
