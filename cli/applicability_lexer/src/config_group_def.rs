...
pub fn lex_config_group_def<I, O, E>(
...
pub fn lex_config_group_not_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
...
pub fn lex_config_group_switch_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
...
pub fn lex_config_group_case_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
...
pub fn lex_config_group_else_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
...
pub fn lex_end_config_group_def<I, O, E>(
    inner: impl Parser<I, O, E>,
) -> impl FnMut(I) -> Result<(I, LexerToken), Err<E>>
where
    E: ParseError<I>,
