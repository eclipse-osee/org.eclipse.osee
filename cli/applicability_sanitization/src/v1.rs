...
//     fn sanitize(
//         &self,
//         features: Vec<ApplicabilityTag<&str>>,
//         config_name: &str,
//         substitutes: &[Substitution<&str>],
//         parent_group: Option<&str>,
//         child_configurations: Option<&[&str]>,
//     ) -> ApplicabilityParserSyntaxTag<&str>;
// }
// impl SanitizeApplicability for ApplicabilityParserSyntaxTag<&str> {
//     fn sanitize(
//         &self,
//         features: Vec<ApplicabilityTag<&str>>,
//         config_name: &str,
...
//                 t.iter()
//                     .cloned()
//                     .map(|tag| tag.get_substitution_value(substitutes))
//                     .collect::<Vec<String>>()
//                     .join(""),
//             ),
...
// impl SanitizeApplicability for ApplicabilitySyntaxTag<&str> {
//     ///
...
// impl SanitizeApplicability for ApplicabilitySyntaxTagNot<&str> {
//     ///
