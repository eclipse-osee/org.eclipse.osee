...
use super::{
    applic_else::process_config_else, base::process_config, switch::process_config_switch,
};

pub fn process_config_not<I, Iter>(
        ...
        && !matches!(transformer.current_token, LexerToken::EndConfiguration(_))
    {
        ...
        match &current_token {
            ...
            LexerToken::ConfigurationElse(position) => {
                ...
                let successful_node = process_config_else(transformer, position, tokens)?;
