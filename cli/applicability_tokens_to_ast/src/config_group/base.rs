        ...
        )
    {
        ...
        match &current_token {
            ...
            LexerToken::Feature(position) => {
                let successful_node = process_feature(transformer, position)?;
                container.add_expr_to_latest_tag(successful_node);
            }
            LexerToken::FeatureNot(position) => {
                let successful_node = process_feature_not(transformer, position)?;
                container.add_expr_to_latest_tag(successful_node);
            }
            LexerToken::FeatureSwitch(position) => {
                let successful_node = process_feature_switch(transformer, position)?;
                container.add_expr_to_latest_tag(successful_node);
            }
            ...
            LexerToken::Configuration(position) => {
                let successful_node = process_config(transformer, position)?;
                container.add_expr_to_latest_tag(successful_node);
            }
            LexerToken::ConfigurationNot(position) => {
                let successful_node = process_config_not(transformer, position)?;
                container.add_expr_to_latest_tag(successful_node);
            }
            LexerToken::ConfigurationSwitch(position) => {
                let successful_node = process_config_switch(transformer, position)?;
                container.add_expr_to_latest_tag(successful_node);
            }
            ...
            LexerToken::ConfigurationGroup(position) => {
                let successful_node = process_config_group(transformer, position)?;
                container.add_expr_to_latest_tag(successful_node);
            }
            LexerToken::ConfigurationGroupNot(position) => {
                let successful_node = process_config_group_not(transformer, position)?;
                container.add_expr_to_latest_tag(successful_node);
            }
            LexerToken::ConfigurationGroupSwitch(position) => {
                let successful_node = process_config_group_switch(transformer, position)?;
                container.add_expr_to_latest_tag(successful_node);
            }
            ...
            LexerToken::ConfigurationGroupElse(position) => {
                ...
                let successful_node = process_config_group_else(transformer, position, tokens)?;
            ...
            LexerToken::Substitution(position) => {
                let successful_node = process_substitution(transformer, position)?;
                container.add_expr_to_latest_tag(successful_node);
            }
            LexerToken::Space(_) => {
                //discard
...
mod tests {
    ...
    fn test_configuration_group_block() {
        let input = vec![
            LexerToken::ConfigurationGroup(((0, 1, 0), (7, 1, 0))),
            ...
            LexerToken::ConfigurationGroup(((32, 1, 0), (39, 1, 0))),
            ...
            LexerToken::EndConfigurationGroup(((65, 1, 0), (76, 1, 0))),
            LexerToken::ConfigurationGroupElse(((76, 1, 0), (88, 1, 0))),
            LexerToken::Text("Some other text here", ((88, 1, 0), (108, 1, 0))),
            LexerToken::EndConfigurationGroup(((108, 1, 0), (119, 1, 0))),
        ];
        let mut sm = StateMachine::new(input.into_iter());
        let result = process_config_group(&mut sm, &((0, 0, 0), (0, 0, 0)));
        assert_eq!(
            result,
    ...
    fn test_configuration_group_block_with_embedded_switch() {
        let input = vec![
            ...
            LexerToken::EndBrace(((41, 1, 0), (42, 1, 0))),
            LexerToken::Text("Nested text here", ((49, 1, 0), (65, 1, 0))),
            LexerToken::ConfigurationGroupSwitch(((65, 1, 0), (79, 1, 0))),
            LexerToken::ConfigurationGroupCase(((79, 1, 0), (91, 1, 0))),
            ...
            LexerToken::ConfigurationGroupCase(((104, 1, 0), (116, 1, 0))),
            ...
            LexerToken::EndConfigurationGroup(((128, 1, 0), (139, 1, 0))),
            LexerToken::ConfigurationGroupElse(((139, 1, 0), (151, 1, 0))),
            LexerToken::Text("Some other text here", ((151, 1, 0), (171, 1, 0))),
            LexerToken::EndConfigurationGroup(((171, 1, 0), (182, 1, 0))),
        ];
        let mut sm = StateMachine::new(input.into_iter());
        let result = process_config_group(&mut sm, &((0, 0, 0), (0, 0, 0)));
    ...
    fn test_configuration_group_block_with_arbitrary_spaces_between_configuration_group_and_brace()
    {
        let input = vec![
            ...
            LexerToken::ConfigurationGroup(((34, 1, 0), (41, 1, 0))),
            ...
            LexerToken::EndConfigurationGroup(((67, 1, 0), (78, 1, 0))),
            LexerToken::ConfigurationGroupElse(((78, 1, 0), (90, 1, 0))),
            LexerToken::Text("Some other text here", ((90, 1, 0), (110, 1, 0))),
            LexerToken::EndConfigurationGroup(((110, 1, 0), (121, 1, 0))),
        ];
        let mut sm = StateMachine::new(input.into_iter());
        let result = process_config_group(&mut sm, &((0, 0, 0), (0, 0, 0)));
        assert_eq!(
