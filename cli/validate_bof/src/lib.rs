 ...
 **********************************************************************/
use applicability_parser_config::applic_config::{
    ApplicabilityConfigElement, ApplicabilityConfigElementConfig,
    ApplicabilityConfigElementConfigGroup, ApplicabilityConfigElementLegacy,
};
...
pub fn validate(
    ...
    bill_of_features: &ApplicabilityConfigElement,
...
fn validate_config_group(
    ple_model: &[FeatureDefinition],
    bill_of_features: &ApplicabilityConfigElementConfigGroup,
) -> Result<(), BillOfFeaturesValidationError> {
...
fn validate_config(
    ple_model: &[FeatureDefinition],
    bill_of_features: &ApplicabilityConfigElementConfig,
) -> Result<(), BillOfFeaturesValidationError> {
    let features = &bill_of_features.features;
    let feature_tags: Vec<_> = features.iter().map(|feature| feature.tag.clone()).collect();
    let ple_model_feature_names: Vec<_> = ple_model.iter().map(|x| x.name.clone()).collect();
...
fn validate_legacy(
    ple_model: &[FeatureDefinition],
    bill_of_features: &ApplicabilityConfigElementLegacy,
) -> Result<(), BillOfFeaturesValidationError> {
    let features = &bill_of_features.features;
    let feature_tags: Vec<_> = features.iter().map(|feature| feature.tag.clone()).collect();
    let ple_model_feature_names: Vec<_> = ple_model.iter().map(|x| x.name.clone()).collect();
...
mod tests {
    ...
    fn test_validate_missing_tag_from_model() {
        ...
        let bill_of_features =
            ApplicabilityConfigElement::Config(ApplicabilityConfigElementConfig {
    ...
    fn test_validate_missing_value_from_model() {
        ...
        let bill_of_features =
            ApplicabilityConfigElement::ConfigGroup(ApplicabilityConfigElementConfigGroup {
                name: "PRODUCT_A".to_string(),
                group: None,
                configs: vec![],
    ...
    fn test_validate_missing_tag_from_bof() {
        ...
        let bill_of_features =
            ApplicabilityConfigElement::LegacyConfig(ApplicabilityConfigElementLegacy {
