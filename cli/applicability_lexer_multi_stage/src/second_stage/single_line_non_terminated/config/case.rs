...
pub trait ConfigCaseSingleLineNonTerminated {
    fn config_case_non_terminated<I, E>(
        &self,
...
impl<T> ConfigCaseSingleLineNonTerminated for T
where
    T: TagNonTerminated + LexConfigurationCase + LexSpace + LexTab,
{
    fn config_case_non_terminated<I, E>(
        &self,
    ) -> impl Parser<I, Output = Vec<LexerToken<I>>, Error = E>
