...
import org.eclipse.osee.framework.core.internal.fields.AliasesField;
import org.eclipse.osee.framework.core.internal.fields.AssociatedArtifactField;
import org.eclipse.osee.framework.core.internal.fields.ChildBranchesField;
import org.eclipse.osee.framework.jdk.core.util.Strings;

/**
 * @author Roberto E. Escobar
 */
public class BranchImpl extends Branch implements Comparable<Branch>, IAdaptable {

   private static final int SHORT_NAME_LIMIT = 25;

   public BranchImpl(String guid, String name, BranchType branchType, BranchState branchState, boolean isArchived) {
      super(guid, name);
      initializeFields();
   ...
   protected void initializeFields() {
      ...
      addField(BranchField.BRANCH_ASSOCIATED_ARTIFACT_FIELD_KEY, new AssociatedArtifactField());
      addField(BranchField.BRANCH_ALIASES_FIELD_KEY, new AliasesField());
      addField(BranchField.BRANCH_CHILDREN, new ChildBranchesField());
   }
