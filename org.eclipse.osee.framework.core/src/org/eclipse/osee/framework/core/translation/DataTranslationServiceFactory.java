...
public class DataTranslationServiceFactory {
	...
	public IDataTranslationService createService(IOseeCachingServiceProvider cachingService,
			IOseeModelFactoryServiceProvider factoryProvider) throws OseeCoreException {
