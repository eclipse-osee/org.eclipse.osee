...
public class ArtifactTypeFactory implements IOseeTypeFactory {
   ...
   public ArtifactType createOrUpdate(AbstractOseeCache<ArtifactType> cache, String guid, boolean isAbstract, String name) throws OseeCoreException {
   ...
   public ArtifactType createOrUpdate(AbstractOseeCache<ArtifactType> cache, int uniqueId, ModificationType modificationType, String guid, boolean isAbstract, String name) throws OseeCoreException {
