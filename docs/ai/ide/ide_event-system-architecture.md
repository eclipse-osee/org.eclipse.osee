---
summary: "OSEE event system architecture: ActiveMQ/JMS publish-subscribe for real-time sync across IDE clients, event types, handlers, listeners, sender identity/echo prevention, and the legacy vs new (topic) event paths"
tags: [ide, events, activemq, jms, messaging, skynet]
fileMatch: "**/OseeEventManager*,**/EventTransport*,**/*EventHandler*,**/FrameworkEventUtil*,**/FrameworkRelayMessagingListener*"
---
