---
summary: "Build Impact Table (BIT) architecture: XViewer-based ATS Workflow Editor tab showing builds/programs impacted by a Change Request, its data model, columns, loading flow, and configurable build sort order"
tags: [ide, ats, bit, xviewer, workflow, build-impact]
fileMatch: "**/editor/tab/bit/**,**/workflow/cr/bit/**"
---
