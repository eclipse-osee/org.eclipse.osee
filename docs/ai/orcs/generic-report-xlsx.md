...
fileMatch: "**/writers/PublishTemplateReportXlsx*,**/writers/MarkdownExcelCellRenderer*,**/MarkdownTableRenderer*"
---
...
MarkdownExcelCellRenderer
        ...
        ├── Table nodes ──────────────► MarkdownTableRenderer → PNG → POI picture
...
### `MarkdownTableRenderer` (framework.core)
...
| Markdown table    | `TableBlock` AST node         | Render to image via `MarkdownTableRenderer`      |
