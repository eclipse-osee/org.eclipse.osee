...
Do **not** run `npx ng build`, `ng build`, or any build/compile commands unless the user explicitly requests it. You may ask the user if they would like you to run a build, but never run one on your own initiative.
