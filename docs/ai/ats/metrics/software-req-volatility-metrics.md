---
summary: "ATS metrics report: REST endpoint, batch query patterns, Excel XML output"
tags: [ats, metrics, rest, performance, excel]
fileMatch: "**/SoftwareReqVolatility*"
---
...
- `DemoArtifactToken.SAW_Bld_1` as the target version
- `WorkaroundForGraphViewForBld1_TeamWf` (DemoReqTeamWorkflow in Completed state) as the qualifying workflow
