---
summary: "Requirements-time ICD signal checking feature: SCD/ACD/SD data model, 7-phase pipeline, SigDbApi abstraction, REST endpoint, and client-server flow"
tags: [ats, reqts, icd, signal-checker, publishing, rest]
fileMatch: "**/reqts/icd/**"
---
