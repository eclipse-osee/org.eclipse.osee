...
/**
 * Abstract prototype of a base model. Has a size (width and height), a location (x and y position) and a list of
 * incoming and outgoing connections. Use subclasses to instantiate a specific model.
 */
public abstract class BaseModel extends ModelElement {
