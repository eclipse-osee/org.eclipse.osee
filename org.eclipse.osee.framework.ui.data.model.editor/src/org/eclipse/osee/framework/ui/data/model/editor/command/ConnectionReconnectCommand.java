 ...
 * </ol>
 * 
 * @see org.eclipse.gef.ModelEditPart.shapes.parts.ShapeEditPart#createEditPolicies() for an example of the above
 *      procedure.
 * @see org.eclipse.gef.editpolicies.GraphicalNodeEditPolicy
 * @see #setNewSource(BaseModel)
 * @see #setNewTarget(BaseModel)
...
public class ConnectionReconnectCommand extends Command {
   ...
   private BaseModel newSource;
   /** The new target endpoint. */
   private BaseModel newTarget;
   /** The original source endpoint. */
   private final BaseModel oldSource;
   /** The original target endpoint. */
   private final BaseModel oldTarget;
    ...
    */
   public void setNewSource(BaseModel connectionSource) {
    ...
    */
   public void setNewTarget(BaseModel connectionTarget) {
