...
![Create Action Button](../../../../assets/images/mim/create-action-button.png)

![Create Action Dialog](../../../../assets/images/mim/create-action-dialog.png)
...
![User Menu](../../../../assets/images/mim/user-menu.png)
![User Settings](../../../../assets/images/mim/user-settings.png)
...
If the product line branch doesn't already have the [Transport Type](/org.eclipse.osee/mim/datamodel#transport-type) for your ICD, you will need to create one on the Transport Types page.
...
![Create node and connection menu](../../../../assets/images/mim/create-node-connection-menu.png)

Select `Create New Node` to open the dialog and fill out the fields.

![Create Node Dialog](../../../../assets/images/mim/create-node-dialog.png)
...
![Create Connection Dialog](../../../../assets/images/mim/create-connection-dialog.png)

## Create a Message

Click on the Connection's label that is connecting the nodes to navigate to the connection's message table.

![Connection on the working branch](../../../../assets/images/mim/connection-a-b.png)
...
![Create Message Dialog](../../../../assets/images/mim/create-message-dialog.png)
...
![Add Submessage To button](../../../../assets/images/mim/add-submessage-to.png)
...
![Create Submessage Dialog](../../../../assets/images/mim/create-submessage-dialog-1.png)
![Create Submessage Dialog](../../../../assets/images/mim/create-submessage-dialog-2.png)

Now you will see the submessage in the table.

![Message and Submessage Table](../../../../assets/images/mim/message-submessage-table.png)
...
![Create Structure Dialog](../../../../assets/images/mim/create-structure-dialog.png)
...
> ![Structure Table with autogenerated spares](../../../../assets/images/mim/structure-table-no-elements.png)
...
![Create Element Dialog](../../../../assets/images/mim/create-element-dialog.png)
...
![Create Platform Type Dialog](../../../../assets/images/mim/create-platform-type-dialog.png)
...
![Element table that is not byte aligned](../../../../assets/images/mim/element-table-with-spare.png)
...
![Element table that is byte aligned](../../../../assets/images/mim/element-table-complete.png)
...
![Action State Button](../../../../assets/images/mim/transition-action.png)
![Commit Branch Button](../../../../assets/images/mim/commit-branch-button.png)

Once the branch is committed, the page will automatically navigate to the Product Line branch.

![Connection on the product line](../../../../assets/images/mim/pl-connection.png)
