        ...
        starlight({
            ...
            sidebar: [
                ...
                },
                {
                    ...
                    items: [
                        {
                            label: "Zenith Overview",
                            slug: "zenith/zenith-overview",
                        },
                        {
                            label: "Configuration",
                            slug: "zenith/configuration",
                        },
                        {
                            label: "Importing Test Results",
                            slug: "zenith/import",
                        },
                    ],
                },
                ...
                },
                {
                    ...
                    items: [
                        {
                            label: "Applicability Syntax",
                            slug: "ple/applicability-syntax",
                        },
                    ],
                },
            ],
