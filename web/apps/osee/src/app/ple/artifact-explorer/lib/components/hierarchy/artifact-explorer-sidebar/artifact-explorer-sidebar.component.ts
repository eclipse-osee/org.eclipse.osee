...
@Component({
	selector: 'osee-artifact-explorer-sidebar',
	imports: [
		AsyncPipe,
		BranchPickerComponent,
	...
	templateUrl: './artifact-explorer-sidebar.component.html',
	styles: [
		`
			osee-artifact-explorer-sidebar {
...
export class ArtifactExplorerSidebarComponent {
