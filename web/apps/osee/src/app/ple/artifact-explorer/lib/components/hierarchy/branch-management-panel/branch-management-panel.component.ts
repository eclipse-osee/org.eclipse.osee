...
@Component({
	...
	template: `
		<div class="tw-flex tw-flex-wrap tw-items-center tw-gap-1 tw-p-3">
			@if (branchId() !== '' && branchId() !== '570') {
				...
				<span class="tw-text-sm tw-italic tw-opacity-50"
					>Select a branch to see management options.</span
				>
			}
		</div>
	`,
