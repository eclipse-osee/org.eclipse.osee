...
describe('GraphLinkEditMenuComponent', () => {
	let component: GraphLinkEditMenuComponent;
	let fixture: ComponentFixture<GraphLinkEditMenuComponent>;

	beforeEach(async () => {
		await TestBed.configureTestingModule({
			imports: [GraphLinkEditMenuComponent],
			providers: [
				{ provide: CurrentGraphService, useValue: graphServiceMock },
			],
		}).compileComponents();

		fixture = TestBed.createComponent(GraphLinkEditMenuComponent);
