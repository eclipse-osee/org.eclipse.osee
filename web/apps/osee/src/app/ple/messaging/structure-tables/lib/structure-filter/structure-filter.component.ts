...
import { StructuresUiService } from '@osee/messaging/shared/services';
...
@Component({
	...
	template: `<mat-form-field
		...
		<mat-label class="tw-px-4">Filter Structure Information</mat-label>
		<input
			matInput
			type="text"
			[(ngModel)]="filter"
		...
		<!-- <mat-hint
			>Enter text to filter Structure Table. Only full text matches will
			show results.
		</mat-hint> -->
	</mat-form-field>`,
...
export class StructureFilterComponent {
	private structureService = inject(StructuresUiService);
	protected filter = this.structureService.filter;
}

export default StructureFilterComponent;
