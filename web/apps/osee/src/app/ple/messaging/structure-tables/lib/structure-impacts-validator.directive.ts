...
@Directive({
	selector: '[oseeStructureImpactsValidator]',
	standalone: true,
	providers: [
		{
			provide: NG_ASYNC_VALIDATORS,
			useExisting: StructureImpactsValidatorDirective,
			multi: true,
		},
	],
})
export class StructureImpactsValidatorDirective implements AsyncValidator {
	...
	validate(
		...
		return this.structureService
			.validateStructure(this.artifactId())
			.pipe(
				map((v) =>
					v === false
