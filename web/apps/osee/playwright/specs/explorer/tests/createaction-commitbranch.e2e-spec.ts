...
test('test', async ({ page }) => {
  ...
  await page.getByRole('tab', { name: 'Change Report - SAW_Bld_1' }).getByRole('button').click();

  //Create an action: create a branch
  await page.getByRole('button', { name: 'Create Action' }).click();
  await page.getByRole('textbox', { name: 'Title' }).click();
  await page.getByRole('textbox', { name: 'Title' }).fill('Test Create Action');
  ...
  await page.getByRole('combobox', { name: 'Change Type' }).locator('svg').click();
  await page.getByText('Improvement').click();
  await page.getByRole('combobox', { name: 'Targeted Version' }).locator('path').click();
  await page.getByText('SAW Product Line').click();
  await page.getByRole('button', { name: 'Create Action' }).click();
  await page.getByText('Analyzeexpand_more').click();
  await page.getByRole('menuitem', { name: 'Transition to Cancelled' }).click();
  await page.getByText('Cancelledexpand_more').click();
  await page.getByRole('menuitem', { name: 'Transition to Implement' }).click();
  await page.getByRole('button', { name: 'Create Branch' }).click();
  await page.getByRole('tab', { name: 'TW1 - Test Create Action' }).getByRole('button').click();
  ...
  await page.getByRole('option', { name: 'TW1 - Test Create Action' }).locator('span').click();
  ...
  await page.getByRole('textbox', { name: 'Enter a Name:' }).fill('Add New Software Req');
  ...
  await page.locator('osee-attributes-editor div').filter({ hasText: 'IDAL: arrow_drop_down' }).locator('mat-icon').click();
  await page.getByRole('option', { name: 'A' }).click();
  await page.locator('#mat-input-15').click();
  await page.locator('#mat-input-15').fill('test');
  await page.getByRole('textbox', { name: 'Start typing Markdown text...' }).click();
  await page.getByRole('textbox', { name: 'Start typing Markdown text...' }).fill('line one');
  await page.locator('osee-attributes-editor div').filter({ hasText: 'Qualification Method: arrow_drop_down' }).locator('mat-icon').click();
  await page.getByText('Test', { exact: true }).click();
  await page.locator('osee-attributes-editor div').filter({ hasText: 'Subsystem: arrow_drop_down' }).locator('mat-icon').click();
  await page.getByText('Chassis').click();
  await page.locator('osee-attributes-editor div').filter({ hasText: 'Partition: arrow_drop_down' }).locator('mat-icon').click();
  ...
  await page.getByRole('button', { name: 'Add New Software Req' }).dblclick();
  await page.getByRole('textbox', { name: 'Start typing Markdown text...' }).click();
  await page.getByRole('textbox', { name: 'Start typing Markdown text...' }).fill('line one, line two');
  await page.getByRole('button').filter({ hasText: 'save' }).click();
  await page.getByRole('tab', { name: 'Add New Software Req' }).getByRole('button').click();

  //Open Team Workflow to Commit the branch
  await page.locator('osee-artifact-hierarchy-panel').getByRole('button').filter({ hasText: 'assignment' }).click();
  ...
  await page.getByText('Select a Branch').click();
  await page.getByText('SAW Product Line').click();
  await page.locator('#cdk-drop-list-2 div').filter({ hasText: 'chevron_right folder Software Requirements - Markdown' }).getByRole('button').first().click();
  await page.getByRole('button', { name: 'Add New Software Req' }).dblclick();
});